import { L as gt, V as dt, aa as Ye, r as ct, bw as ft, f as We, bx as pt, n as R, U as mt, a7 as St, B as vt, R as Ct, bB as wt, c as ee, bC as Rt, S as Be, ad as be, a6 as E, bD as je, bE as ht, aE as _t, bc as yt, ac as Ft, bF as $t, k as V, x as M, m as W, w as we, z as H, ap as K, T as z, M as B, N as Y, e as b, a4 as ae, A as re, y as Te, a2 as Ue, l as ie, P as xt, a8 as Pt, Y as Vt } from "#entry";
import { u as Mt } from "./D_PvN5q6.js";
function N(e, o) {
  return typeof e == "function" ? e(o) : e;
}
function G(e, o) {
  return (t) => {
    o.setState((n) => ({ ...n, [e]: N(t, n[e]) }));
  };
}
function pe(e) {
...
function ge(e, o, t, n) {
  ...
  const g = (d, s) => {
    ...
    d.forEach((y) => {
      const _ = [...m].reverse()[0], x = y.column.depth === f.depth;
      let P, O = false;
      if (x && y.column.parent ? P = y.column.parent : (P = y.column, O = true), _ && (_ == null ? void 0 : _.column) === P) _.subHeaders.push(y);
      else {
        const I = Ne(t, P, { id: [n, s, P.id, y == null ? void 0 : y.id].filter(Boolean).join("_"), isPlaceholder: O, placeholderId: O ? `${m.filter((q) => q.column === P).length}` : void 0, depth: s, index: m.length });
        I.subHeaders.push(y), m.push(I);
      }
      f.headers.push(y), y.headerGroup = f;
    }), a.push(f), s > 0 && g(m, s - 1);
  }, c = o.map((d, s) => Ne(t, d, { depth: l, index: s }));
  g(c, l - 1), a.reverse();
  const p = (d) => d.filter((f) => f.column.getIsVisible()).map((f) => {
    let m = 0, y = 0, _ = [0];
    f.subHeaders && f.subHeaders.length ? (_ = [], p(f.subHeaders).forEach((P) => {
      let { colSpan: O, rowSpan: I } = P;
      m += O, _.push(I);
    })) : m = 1;
    const x = Math.min(..._);
    return y = y + x, f.colSpan = m, f.rowSpan = y, { colSpan: m, rowSpan: y };
  });
...
const Ae = (e, o, t, n, r, i, l) => {
  let u = { id: o, index: n, original: t, depth: r, parentId: l, _valuesCache: {}, _uniqueValuesCache: {}, getValue: (a) => {
    ...
    return a.reverse();
  }, getAllCells: v(() => [e.getAllLeafColumns()], (a) => a.map((g) => Dt(e, u, g, g.id)), C(e.options, "debugRows")), _getAllCellsByColumnId: v(() => [u.getAllCells()], (a) => a.reduce((g, c) => (g[c.column.id] = c, g), {}), C(e.options, "debugRows")) };
...
const j = { includesString: Ze, includesStringSensitive: Je, equalsString: Qe, arrIncludes: et, arrIncludesAll: tt, arrIncludesSome: nt, equals: ot, weakEquals: rt, inNumberRange: Ee };
function L(e) {
  return e == null || e === "";
}
const Ht = { getDefaultColumnDef: () => ({ filterFn: "auto" }), getInitialState: (e) => ({ columnFilters: [], ...e }), getDefaultOptions: (e) => ({ onColumnFiltersChange: G("columnFilters", e), filterFromLeafRows: false, maxLeafRowFilterDepth: 100 }), createColumn: (e, o) => {
  e.getAutoFilterFn = () => {
    ...
    o.setColumnFilters((n) => {
      const r = e.getFilterFn(), i = n == null ? void 0 : n.find((c) => c.id === e.id), l = N(t, i ? i.value : void 0);
      if (Xe(r, l, e)) {
        var u;
  ...
  e.setColumnFilters = (o) => {
    const t = e.getAllLeafColumns(), n = (r) => {
      var i;
      return (i = N(o, r)) == null ? void 0 : i.filter((l) => {
        const u = t.find((a) => a.id === l.id);
        if (u) {
          const a = u.getFilterFn();
          if (Xe(a, l.value, u)) return false;
        }
        return true;
      });
    };
...
}, jt = (e, o) => Array.from(new Set(o.map((t) => t.getValue(e))).values()), Tt = (e, o) => new Set(o.map((t) => t.getValue(e))).size, Ut = (e, o) => o.length, Re = { sum: Gt, min: Lt, max: qt, extent: kt, mean: Bt, median: bt, unique: jt, uniqueCount: Tt, count: Ut }, Nt = { getDefaultColumnDef: () => ({ aggregatedCell: (e) => {
  var o, t;
...
const Kt = { getInitialState: (e) => ({ columnOrder: [], ...e }), getDefaultOptions: (e) => ({ onColumnOrderChange: G("columnOrder", e) }), createColumn: (e, o) => {
...
const de = { size: 150, minSize: 20, maxSize: Number.MAX_SAFE_INTEGER }, _e = () => ({ startOffset: null, startSize: null, deltaOffset: null, deltaPercentage: null, isResizingColumn: false, columnSizingStart: [] }), Zt = { getDefaultColumnDef: () => de, getInitialState: (e) => ({ columnSizing: {}, columnSizingInfo: _e(), ...e }), getDefaultOptions: (e) => ({ columnResizeMode: "onEnd", columnResizeDirection: "ltr", onColumnSizingChange: G("columnSizing", e), onColumnSizingInfoChange: G("columnSizingInfo", e) }), createColumn: (e, o) => {
  ...
  e.getSize = () => {
    ...
    return (i) => {
      if (!n || !r || (i.persist == null || i.persist(), ye(i) && i.touches && i.touches.length > 1)) return;
      const l = e.getSize(), u = e ? e.getLeafHeaders().map((_) => [_.column.id, _.column.getSize()]) : [[n.id, n.getSize()]], a = ye(i) ? Math.round(i.touches[0].clientX) : i.clientX, g = {}, c = (_, x) => {
        typeof x == "number" && (o.setColumnSizingInfo((P) => {
          var O, I;
          const q = o.options.columnResizeDirection === "rtl" ? -1 : 1, Z = (x - ((O = P == null ? void 0 : P.startOffset) != null ? O : 0)) * q, J = Math.max(Z / ((I = P == null ? void 0 : P.startSize) != null ? I : 0), -0.999999);
          return P.columnSizingStart.forEach((te) => {
            let [ne, Q] = te;
            g[ne] = Math.round(Math.max(Q + Q * J, 0) * 100) / 100;
          }), { ...P, deltaOffset: Z, deltaPercentage: J };
      ...
      }, s = Wt(t), f = { moveHandler: (_) => p(_.clientX), upHandler: (_) => {
      ...
      } }, y = Jt() ? { passive: false } : false;
      ye(i) ? (s == null ? void 0 : s.addEventListener("touchmove", m.moveHandler, y), s == null ? void 0 : s.addEventListener("touchend", m.upHandler, y)) : (s == null ? void 0 : s.addEventListener("mousemove", f.moveHandler, y), s == null ? void 0 : s.addEventListener("mouseup", f.upHandler, y)), o.setColumnSizingInfo((_) => ({ ..._, startOffset: a, startSize: l, deltaOffset: 0, deltaPercentage: 0, columnSizingStart: u, isResizingColumn: n.id }));
    };
  };
}, createTable: (e) => {
...
const Qt = { getInitialState: (e) => ({ columnVisibility: {}, ...e }), getDefaultOptions: (e) => ({ onColumnVisibilityChange: G("columnVisibility", e) }), createColumn: (e, o) => {
...
const en = { createTable: (e) => {
...
} }, Me = 0, Ie = 10, Fe = () => ({ pageIndex: Me, pageSize: Ie }), on = { getInitialState: (e) => ({ ...e, pagination: { ...Fe(), ...e == null ? void 0 : e.pagination } }), getDefaultOptions: (e) => ({ onPaginationChange: G("pagination", e) }), createTable: (e) => {
  let o = false, t = false;
  e._autoResetPageIndex = () => {
    ...
    e.setPagination((r) => {
      const i = Math.max(1, N(n, r.pageSize)), l = r.pageSize * r.pageIndex, u = Math.floor(l / i);
      return { ...r, pageIndex: u, pageSize: i };
    });
  }, e.setPageCount = (n) => e.setPagination((r) => {
    var i;
    let l = N(n, (i = e.options.pageCount) != null ? i : -1);
...
const Oe = /([0-9]+)/gm, sn = (e, o, t) => it(X(e.getValue(t)).toLowerCase(), X(o.getValue(t)).toLowerCase()), un = (e, o, t) => it(X(e.getValue(t)), X(o.getValue(t))), an = (e, o, t) => Ge(X(e.getValue(t)).toLowerCase(), X(o.getValue(t)).toLowerCase()), gn = (e, o, t) => Ge(X(e.getValue(t)), X(o.getValue(t))), dn = (e, o, t) => {
...
const le = { alphanumeric: sn, alphanumericCaseSensitive: un, text: an, textCaseSensitive: gn, datetime: dn, basic: cn }, fn = { getInitialState: (e) => ({ sorting: [], ...e }), getDefaultColumnDef: () => ({ sortingFn: "auto", sortUndefined: 1 }), getDefaultOptions: (e) => ({ onSortingChange: G("sorting", e), isMultiSortEvent: (o) => o.shiftKey }), createColumn: (e, o) => {
  e.getAutoSortingFn = () => {
    ...
    for (const r of t) {
      ...
      if (typeof i == "string" && (n = true, i.split(Oe).length > 1)) return le.alphanumeric;
    }
...
} }, pn = [At, Qt, Kt, Yt, Et, Ht, en, tn, fn, Nt, nn, on, rn, ln, Zt];
function mn(e) {
  var o, t;
  ...
  const p = { _features: n, options: { ...i, ...e }, initialState: a, _queue: (d) => {
    ...
    const s = function(f, m, y) {
      return y === void 0 && (y = 0), f.map((_) => {
        const x = Ot(r, _, y, m), P = _;
        return x.columns = P.columns ? s(P.columns, x, y + 1) : [], x;
      });
    };
    return s(d);
  ...
  return (e) => v(() => [e.getPreFilteredRowModel(), e.getState().columnFilters, e.getState().globalFilter], (o, t, n) => {
    ...
    for (let d = 0; d < o.flatRows.length; d++) {
      ...
      if (s.columnFilters = {}, r.length) for (let f = 0; f < r.length; f++) {
        g = r[f];
        const m = g.id;
        s.columnFilters[m] = g.filterFn(s, m, g.resolvedValue, (y) => {
          s.columnFiltersMeta[m] = y;
        });
      }
      if (i.length) {
        for (let f = 0; f < i.length; f++) {
          c = i[f];
          const m = c.id;
          if (c.filterFn(s, m, c.resolvedValue, (y) => {
            s.columnFiltersMeta[m] = y;
          })) {
    ...
    const u = (a) => {
      ...
      return g.sort((c, p) => {
        for (let s = 0; s < i.length; s += 1) {
          var d;
          const f = i[s], m = l[f.id], y = m.sortUndefined, _ = (d = f == null ? void 0 : f.desc) != null ? d : false;
          let x = 0;
          if (y) {
            const P = c.getValue(f.id), O = p.getValue(f.id), I = P === void 0, q = O === void 0;
            if (I || q) {
...
const Fn = /* @__PURE__ */ Symbol("merge-proxy"), $n = { get(e, o, t) {
  return o === Fn ? t : e.get(o);
}, has(e, o) {
  return e.has(o);
...
const Ve = We({ props: ["render", "props"], setup: (e) => () => typeof e.render == "function" || typeof e.render == "object" ? pt(e.render, e.props) : e.render });
function Ke(e) {
...
const Pn = { slots: { root: "relative overflow-auto", base: "min-w-full", caption: "sr-only", thead: "relative", tbody: "isolate [&>tr]:data-[selectable=true]:hover:bg-elevated/50 [&>tr]:data-[selectable=true]:focus-visible:outline-primary", tfoot: "relative", tr: "data-[selected=true]:bg-elevated/50", th: "px-4 py-3.5 text-sm text-highlighted text-left rtl:text-right font-semibold [&:has([role=checkbox])]:pe-0", td: "p-4 text-sm text-muted whitespace-nowrap [&:has([role=checkbox])]:pe-0", separator: "absolute z-1 left-0 w-full h-px bg-(--ui-border-accented)", empty: "py-6 text-center text-sm text-muted", loading: "py-6 text-center" }, variants: { virtualize: { false: { base: "overflow-clip", tbody: "divide-y divide-default" } }, pinned: { true: { th: "sticky bg-default/75 z-1", td: "sticky bg-default/75 z-1" } }, sticky: { true: { thead: "sticky top-0 inset-x-0 bg-default/75 backdrop-blur z-1", tfoot: "sticky bottom-0 inset-x-0 bg-default/75 backdrop-blur z-1" }, header: { thead: "sticky top-0 inset-x-0 bg-default/75 backdrop-blur z-1" }, footer: { tfoot: "sticky bottom-0 inset-x-0 bg-default/75 backdrop-blur z-1" } }, loading: { true: { thead: "after:absolute after:z-1 after:h-px" } }, loadingAnimation: { carousel: "", "carousel-inverse": "", swing: "", elastic: "" }, loadingColor: { primary: "", secondary: "", success: "", info: "", warning: "", error: "", neutral: "" } }, compoundVariants: [{ loading: true, loadingColor: "primary", class: { thead: "after:bg-primary" } }, { loading: true, loadingColor: "secondary", class: { thead: "after:bg-secondary" } }, { loading: true, loadingColor: "success", class: { thead: "after:bg-success" } }, { loading: true, loadingColor: "info", class: { thead: "after:bg-info" } }, { loading: true, loadingColor: "warning", class: { thead: "after:bg-warning" } }, { loading: true, loadingColor: "error", class: { thead: "after:bg-error" } }, { loading: true, loadingColor: "neutral", class: { thead: "after:bg-neutral" } }, { loading: true, loadingColor: "neutral", class: { thead: "after:bg-inverted" } }, { loading: true, loadingAnimation: "carousel", class: { thead: "after:animate-[carousel_2s_ease-in-out_infinite] rtl:after:animate-[carousel-rtl_2s_ease-in-out_infinite]" } }, { loading: true, loadingAnimation: "carousel-inverse", class: { thead: "after:animate-[carousel-inverse_2s_ease-in-out_infinite] rtl:after:animate-[carousel-inverse-rtl_2s_ease-in-out_infinite]" } }, { loading: true, loadingAnimation: "swing", class: { thead: "after:animate-[swing_2s_ease-in-out_infinite]" } }, { loading: true, loadingAnimation: "elastic", class: { thead: "after:animate-[elastic_2s_ease-in-out_infinite]" } }], defaultVariants: { loadingColor: "primary", loadingAnimation: "carousel" } }, Vn = ["data-selected", "data-selectable", "data-expanded", "role", "tabindex", "onClick", "onPointerenter", "onContextmenu"], Mn = ["data-pinned", "colspan", "rowspan"], In = ["colspan"], zn = ["data-pinned", "scope", "colspan", "rowspan"], Dn = { key: 1 }, On = ["colspan"], An = { key: 2 }, En = ["colspan"], Hn = ["data-pinned", "colspan", "rowspan"], Gn = Object.assign({ inheritAttrs: false }, { __name: "UTable", props: Pt({ as: { type: null, required: false }, data: { type: Array, required: false }, columns: { type: Array, required: false }, caption: { type: String, required: false }, meta: { type: Object, required: false }, virtualize: { type: [Boolean, Object], required: false, default: false }, empty: { type: String, required: false }, sticky: { type: [Boolean, String], required: false }, loading: { type: Boolean, required: false }, loadingColor: { type: null, required: false }, loadingAnimation: { type: null, required: false }, watchOptions: { type: Object, required: false, default: () => ({ deep: true }) }, globalFilterOptions: { type: Object, required: false }, columnFiltersOptions: { type: Object, required: false }, columnPinningOptions: { type: Object, required: false }, columnSizingOptions: { type: Object, required: false }, visibilityOptions: { type: Object, required: false }, sortingOptions: { type: Object, required: false }, groupingOptions: { type: Object, required: false }, expandedOptions: { type: Object, required: false }, rowSelectionOptions: { type: Object, required: false }, rowPinningOptions: { type: Object, required: false }, paginationOptions: { type: Object, required: false }, facetedOptions: { type: Object, required: false }, onSelect: { type: Function, required: false }, onHover: { type: Function, required: false }, onContextmenu: { type: [Function, Array], required: false }, class: { type: null, required: false }, ui: { type: Object, required: false }, state: { type: Object, required: false }, onStateChange: { type: Function, required: false }, renderFallbackValue: { type: null, required: false }, _features: { type: Array, required: false }, autoResetAll: { type: Boolean, required: false }, debugAll: { type: Boolean, required: false }, debugCells: { type: Boolean, required: false }, debugColumns: { type: Boolean, required: false }, debugHeaders: { type: Boolean, required: false }, debugRows: { type: Boolean, required: false }, debugTable: { type: Boolean, required: false }, defaultColumn: { type: Object, required: false }, getRowId: { type: Function, required: false }, getSubRows: { type: Function, required: false }, initialState: { type: Object, required: false }, mergeOptions: { type: Function, required: false } }, { globalFilter: { type: String }, globalFilterModifiers: {}, columnFilters: { type: Array }, columnFiltersModifiers: {}, columnOrder: { type: Array }, columnOrderModifiers: {}, columnVisibility: { type: Object }, columnVisibilityModifiers: {}, columnPinning: { type: Object }, columnPinningModifiers: {}, columnSizing: { type: Object }, columnSizingModifiers: {}, columnSizingInfo: { type: Object }, columnSizingInfoModifiers: {}, rowSelection: { type: Object }, rowSelectionModifiers: {}, rowPinning: { type: Object }, rowPinningModifiers: {}, sorting: { type: Array }, sortingModifiers: {}, grouping: { type: Array }, groupingModifiers: {}, expanded: { type: [Boolean, Object] }, expandedModifiers: {}, pagination: { type: Object }, paginationModifiers: {} }), emits: ["update:globalFilter", "update:columnFilters", "update:columnOrder", "update:columnVisibility", "update:columnPinning", "update:columnSizing", "update:columnSizingInfo", "update:rowSelection", "update:rowPinning", "update:sorting", "update:grouping", "update:expanded", "update:pagination"], setup(e, { expose: o }) {
  ...
  function c(S) {
    return S.map(($) => {
      ...
      return "columns" in w && w.columns && (w.columns = c(w.columns)), w.cell || (w.cell = ({ getValue: h }) => {
        const F = h();
        return F === "" || F === null || F === void 0 ? "\xA0" : String(F);
      }), w;
    });
  }
  const p = ee(() => {
  ...
  }), [d, s] = be(), [f, m] = be({ props: { row: { type: Object, required: true }, style: { type: Object, required: false } } }), y = ee(() => {
    function S($) {
      for (const w of $) if ("footer" in w || "columns" in w && S(w.columns)) return true;
      return false;
    }
    return S(g.value);
  }), _ = E(e, "globalFilter"), x = E(e, "columnFilters"), P = E(e, "columnOrder"), O = E(e, "columnVisibility"), I = E(e, "columnPinning"), q = E(e, "columnSizing"), Z = E(e, "columnSizingInfo"), J = E(e, "rowSelection"), te = E(e, "rowPinning"), ne = E(e, "sorting"), Q = E(e, "grouping"), me = E(e, "expanded"), Se = E(e, "pagination"), ve = je("rootRef"), Le = je("tableRef"), lt = ht(_t(t, "_features", "autoResetAll", "debugAll", "debugCells", "debugColumns", "debugHeaders", "debugRows", "debugTable", "defaultColumn", "getRowId", "getSubRows", "initialState", "mergeOptions", "renderFallbackValue")), T = xn({ ...lt.value, get data() {
    return u.value;
  }, get columns() {
    return g.value;
  }, meta: a.value, getCoreRowModel: Sn(), ...t.globalFilterOptions || {}, ..._.value !== void 0 && { onGlobalFilterChange: (S) => A(S, _) }, ...t.columnFiltersOptions || {}, getFilteredRowModel: _n(), ...x.value !== void 0 && { onColumnFiltersChange: (S) => A(S, x) }, ...P.value !== void 0 && { onColumnOrderChange: (S) => A(S, P) }, ...t.visibilityOptions || {}, ...O.value !== void 0 && { onColumnVisibilityChange: (S) => A(S, O) }, ...t.columnPinningOptions || {}, ...I.value !== void 0 && { onColumnPinningChange: (S) => A(S, I) }, ...t.columnSizingOptions || {}, ...q.value !== void 0 && { onColumnSizingChange: (S) => A(S, q) }, ...Z.value !== void 0 && { onColumnSizingInfoChange: (S) => A(S, Z) }, ...t.rowSelectionOptions || {}, ...J.value !== void 0 && { onRowSelectionChange: (S) => A(S, J) }, ...t.rowPinningOptions || {}, ...te.value !== void 0 && { onRowPinningChange: (S) => A(S, te) }, ...t.sortingOptions || {}, getSortedRowModel: yn(), ...ne.value !== void 0 && { onSortingChange: (S) => A(S, ne) }, ...t.groupingOptions || {}, ...Q.value !== void 0 && { onGroupingChange: (S) => A(S, Q) }, ...t.expandedOptions || {}, getExpandedRowModel: vn(), ...me.value !== void 0 && { onExpandedChange: (S) => A(S, me) }, ...t.paginationOptions || {}, ...Se.value !== void 0 && { onPaginationChange: (S) => A(S, Se) }, ...t.facetedOptions || {}, state: { get globalFilter() {
    return _.value;
  }, get columnFilters() {
    return x.value;
  }, get columnOrder() {
    ...
    return Se.value;
  } } }), oe = ee(() => T.getRowModel().rows), qe = yt(() => Ft(typeof t.virtualize == "boolean" ? {} : t.virtualize, { estimateSize: 65, overscan: 12 })), U = !!t.virtualize && $t({ ...qe.value, get count() {
    ...
    if (!U) return 0;
    const S = U.value.getVirtualItems();
  ...
  return Ye(() => t.data, () => {
    ...
    var _a2;
    return V(), M(B, null, [W(R(f), null, { default: we(({ row: w, style: h }) => {
      var _a3, _b, _c, _d, _e2, _f, _g;
      return [H("tr", { "data-selected": w.getIsSelected(), "data-selectable": !!t.onSelect || !!t.onHover || !!t.onContextmenu, "data-expanded": w.getIsExpanded(), role: t.onSelect ? "button" : void 0, tabindex: t.onSelect ? 0 : void 0, "data-slot": "tr", class: z(p.value.tr({ class: [(_a3 = R(l)) == null ? void 0 : _a3.tr, k((_c = (_b = R(T).options.meta) == null ? void 0 : _b.class) == null ? void 0 : _c.tr, w)] })), style: K([k((_e2 = (_d = R(T).options.meta) == null ? void 0 : _d.style) == null ? void 0 : _e2.tr, w), h]), onClick: (F) => ut(F, w), onPointerenter: (F) => ke(F, w), onPointerleave: $[0] || ($[0] = (F) => ke(F, null)), onContextmenu: (F) => at(F, w) }, [(V(true), M(B, null, Y(w.getVisibleCells(), (F) => {
        var _a4, _b2, _c2, _d2, _e3, _f2, _g2, _h, _i;
        return V(), M("td", { key: F.id, "data-pinned": F.column.getIsPinned(), colspan: k((_b2 = (_a4 = F.column.columnDef.meta) == null ? void 0 : _a4.colspan) == null ? void 0 : _b2.td, F), rowspan: k((_d2 = (_c2 = F.column.columnDef.meta) == null ? void 0 : _c2.rowspan) == null ? void 0 : _d2.td, F), "data-slot": "td", class: z(p.value.td({ class: [(_e3 = R(l)) == null ? void 0 : _e3.td, k((_g2 = (_f2 = F.column.columnDef.meta) == null ? void 0 : _f2.class) == null ? void 0 : _g2.td, F)], pinned: !!F.column.getIsPinned() })), style: K([Ce(F.column), k((_i = (_h = F.column.columnDef.meta) == null ? void 0 : _h.style) == null ? void 0 : _i.td, F)]) }, [b(S.$slots, `${F.column.id}-cell`, ae({ ref_for: true }, F.getContext()), () => [W(R(Ve), { render: F.column.columnDef.cell, props: F.getContext() }, null, 8, ["render", "props"])])], 14, Mn);
      ...
      return [H("table", { ref_key: "tableRef", ref: Le, "data-slot": "base", class: z(p.value.base({ class: [(_a3 = R(l)) == null ? void 0 : _a3.base] })) }, [e.caption || n.caption ? (V(), M("caption", { key: 0, "data-slot": "caption", class: z(p.value.caption({ class: [(_b = R(l)) == null ? void 0 : _b.caption] })) }, [b(S.$slots, "caption", {}, () => [Te(Ue(e.caption), 1)])], 2)) : re("", true), H("thead", { "data-slot": "thead", class: z(p.value.thead({ class: [(_c = R(l)) == null ? void 0 : _c.thead] })) }, [(V(true), M(B, null, Y(R(T).getHeaderGroups(), (w) => {
        ...
        return V(), M("tr", { key: w.id, "data-slot": "tr", class: z(p.value.tr({ class: [(_a4 = R(l)) == null ? void 0 : _a4.tr] })) }, [(V(true), M(B, null, Y(w.headers, (h) => {
          ...
          return V(), M("th", { key: h.id, "data-pinned": h.column.getIsPinned(), scope: h.colSpan > 1 ? "colgroup" : "col", colspan: h.colSpan > 1 ? h.colSpan : void 0, rowspan: h.rowSpan > 1 ? h.rowSpan : void 0, "data-slot": "th", class: z(p.value.th({ class: [(_a5 = R(l)) == null ? void 0 : _a5.th, k((_c2 = (_b2 = h.column.columnDef.meta) == null ? void 0 : _b2.class) == null ? void 0 : _c2.th, h)], pinned: !!h.column.getIsPinned() })), style: K([Ce(h.column), k((_e3 = (_d2 = h.column.columnDef.meta) == null ? void 0 : _d2.style) == null ? void 0 : _e3.th, h)]) }, [b(S.$slots, `${h.id}-header`, ae({ ref_for: true }, h.getContext()), () => [h.isPlaceholder ? re("", true) : (V(), ie(R(Ve), { key: 0, render: h.column.columnDef.header, props: h.getContext() }, null, 8, ["render", "props"]))])], 14, zn);
        }), 128))], 2);
      }), 128)), H("tr", { "data-slot": "separator", class: z(p.value.separator({ class: [(_d = R(l)) == null ? void 0 : _d.separator] })) }, null, 2)], 2), H("tbody", { "data-slot": "tbody", class: z(p.value.tbody({ class: [(_e2 = R(l)) == null ? void 0 : _e2.tbody] })) }, [b(S.$slots, "body-top"), oe.value.length ? (V(), M(B, { key: 0 }, [R(U) ? (V(true), M(B, { key: 0 }, Y(R(U).getVirtualItems(), (w, h) => {
        var _a4;
        return V(), ie(R(m), { key: (_a4 = oe.value[w.index]) == null ? void 0 : _a4.id, row: oe.value[w.index], style: K({ height: `${w.size}px`, transform: `translateY(${w.start - h * w.size}px)` }) }, null, 8, ["row", "style"]);
      }), 128)) : (V(true), M(B, { key: 1 }, Y(oe.value, (w) => (V(), ie(R(m), { key: w.id, row: w }, null, 8, ["row"]))), 128))], 64)) : e.loading && n.loading ? (V(), M("tr", Dn, [H("td", { colspan: R(T).getAllLeafColumns().length, "data-slot": "loading", class: z(p.value.loading({ class: (_f = R(l)) == null ? void 0 : _f.loading })) }, [b(S.$slots, "loading")], 10, On)])) : (V(), M("tr", An, [H("td", { colspan: R(T).getAllLeafColumns().length, "data-slot": "empty", class: z(p.value.empty({ class: (_g = R(l)) == null ? void 0 : _g.empty })) }, [b(S.$slots, "empty", {}, () => [Te(Ue(e.empty || R(r)("table.noData")), 1)])], 10, En)])), b(S.$slots, "body-bottom")], 2), y.value ? (V(), M("tfoot", { key: 1, "data-slot": "tfoot", class: z(p.value.tfoot({ class: [(_h = R(l)) == null ? void 0 : _h.tfoot] })), style: K(R(U) ? { transform: `translateY(${R(U).getTotalSize() - st.value}px)` } : void 0) }, [H("tr", { "data-slot": "separator", class: z(p.value.separator({ class: [(_i = R(l)) == null ? void 0 : _i.separator] })) }, null, 2), (V(true), M(B, null, Y(R(T).getFooterGroups(), (w) => {
        var _a4;
        return V(), M("tr", { key: w.id, "data-slot": "tr", class: z(p.value.tr({ class: [(_a4 = R(l)) == null ? void 0 : _a4.tr] })) }, [(V(true), M(B, null, Y(w.headers, (h) => {
          var _a5, _b2, _c2, _d2, _e3;
          return V(), M("th", { key: h.id, "data-pinned": h.column.getIsPinned(), colspan: h.colSpan > 1 ? h.colSpan : void 0, rowspan: h.rowSpan > 1 ? h.rowSpan : void 0, "data-slot": "th", class: z(p.value.th({ class: [(_a5 = R(l)) == null ? void 0 : _a5.th, k((_c2 = (_b2 = h.column.columnDef.meta) == null ? void 0 : _b2.class) == null ? void 0 : _c2.th, h)], pinned: !!h.column.getIsPinned() })), style: K([Ce(h.column), k((_e3 = (_d2 = h.column.columnDef.meta) == null ? void 0 : _d2.style) == null ? void 0 : _e3.th, h)]) }, [b(S.$slots, `${h.id}-footer`, ae({ ref_for: true }, h.getContext()), () => [h.isPlaceholder ? re("", true) : (V(), ie(R(Ve), { key: 0, render: h.column.columnDef.footer, props: h.getContext() }, null, 8, ["render", "props"]))])], 14, Hn);
        }), 128))], 2);
      }), 128))], 6)) : re("", true)], 2)];
    }), _: 3 }), W(R(xt), ae({ ref_key: "rootRef", ref: ve, as: e.as }, S.$attrs, { "data-slot": "root", class: p.value.root({ class: [(_a2 = R(l)) == null ? void 0 : _a2.root, t.class] }) }), { default: we(() => [R(U) ? (V(), M("div", { key: 0, style: K({ height: `${R(U).getTotalSize()}px` }) }, [W(R(s))], 4)) : (V(), ie(R(s), { key: 1 }))]), _: 1 }, 16, ["as", "class"])], 64);
  };
} }), Ln = { class: "space-y-8" }, qn = We({ __name: "RpcOpenServers", async setup(e) {
  let o, t;
  const { data: n } = ([o, t] = Vt(() => Mt("/api/rpc-servers", { key: "rpc-servers", default: () => ({ mainnet: [], testnet: [] }) }, "$ZVdbUqjmoF")), o = await o, t(), o), r = [{ accessorKey: "name", header: "Server" }, { accessorKey: "endpoint", header: "URL" }, { accessorKey: "maintainer", header: "Maintainer" }];
  return (i, l) => {
    const u = Gn;
    return V(), M("div", Ln, [H("section", null, [l[0] || (l[0] = H("h2", null, "Mainnet", -1)), W(u, { data: R(n).mainnet, columns: r, class: "overflow-hidden rounded-[1.25rem]" }, null, 8, ["data"])]), H("section", null, [l[1] || (l[1] = H("h2", null, "Testnet", -1)), W(u, { data: R(n).testnet, columns: r, class: "overflow-hidden rounded-[1.25rem]" }, null, 8, ["data"])])]);
  };
} }), bn = Object.assign(qn, { __name: "RpcOpenServers" });
export {
  bn as default
};
