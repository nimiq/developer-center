...
import C from "./BxRcZ8qo.js";
import { getTokenStyleObject as w, createHighlighterCore as R } from "./Cp9leU2x.js";
import { f, r as T, bw as y, bx as d, aM as A, aa as P, N as L, D as l, by as O, Y as U, c as _, k, l as E, w as I, n as c, bz as q, bA as D } from "#entry";
import { c as V } from "./UYQwraN4.js";
import "./B3lh_D4v.js";
import "./6GRe1c0h.js";
import "./iik6CYzq.js";
let X;
...
`,
  ...
  function j(t) {
    return G(t) ? t : (p.has(t) || p.set(t, z()), p.get(t));
  }
  const $ = f({
  ...
  X = f({
    ...
    async setup(t) {
      let e, r;
      const a = O(), s = ([e, r] = U(() => H()), e = await e, r(), e), n = t, o = _(() => n.code.trim().replace(/`+$/, "")), i = _(() => {
        switch (n.language) {
          case "vue":
            return "vue";
          case "javascript":
