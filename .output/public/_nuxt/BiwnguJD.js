import { f as on, bG as _, c2 as tn, c as j, a_ as rn, aX as an, ah as un, b0 as sn, a$ as U, b1 as cn, c3 as D, c4 as pn, b2 as dn, c5 as gn } from "#entry";
...
let hn = 0;
const u = C(), m = C(), T = C(), l = C(), p = C(), S = C(), y = C();
function C() {
  return 2 ** ++hn;
}
const R = Object.freeze(Object.defineProperty({ __proto__: null, boolean: u, booleanish: m, commaOrSpaceSeparated: y, commaSeparated: S, number: l, overloadedBoolean: T, spaceSeparated: p }, Symbol.toStringTag, { value: "Module" })), M = Object.keys(R);
class B extends h {
  constructor(e, o, t, r) {
    let a = -1;
...
} }), bn = /[A-Z]/g, F = /-[a-z]/g, Cn = /^data[-\w.:]+$/i;
function Sn(n, e) {
  const o = L(e);
  let t = e, r = h;
  if (o in n.normal) return n.property[n.normal[o]];
  if (o.length > 4 && o.slice(0, 4) === "data" && Cn.test(e)) {
    if (e.charAt(4) === "-") {
...
const E = "default", Z = /^@|^v-on:/, G = /^:|^v-bind:/, On = /^v-model/, Mn = ["select", "textarea", "input"], Ln = /* @__PURE__ */ new Set(["math", "svg"]), J = /* @__PURE__ */ new Set(), Tn = Object.fromEntries(["p", "a", "blockquote", "code", "pre", "code", "em", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "img", "ul", "ol", "li", "strong", "table", "thead", "tbody", "td", "th", "tr", "script"].map((n) => [n, `prose-${n}`])), Rn = ["script", "base"], En = on({ name: "MDCRenderer", props: { body: { type: Object, required: true }, data: { type: Object, default: () => ({}) }, class: { type: [String, Object], default: void 0 }, tag: { type: [String, Boolean], default: void 0 }, prose: { type: Boolean, default: void 0 }, components: { type: Object, default: () => ({}) }, unwrap: { type: [Boolean, String], default: false } }, async setup(n) {
...
function Bn(n, e) {
  ...
  return Object.keys(t).reduce(function(r, a) {
    ...
    if (G.test(a)) return jn(a, s, r, e);
    const { attribute: f } = Sn(wn, a);
...
function jn(n, e, o, t) {
  return n = n.replace(G, ""), o[n] = O(e, t), o;
}
const A = (n) => {
  if (typeof n == "string") {
    if (z(n)) return n;
...
function z(n) {
  return (typeof n == "string" ? J.has(n) : false) || mn.has(n);
}
