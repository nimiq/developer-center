const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./8G-HYffv.js","./DaWZu8wl.js","./BYNxcJcd.js","./entry.jj7id34R.css","./D0o_tKqw.js","./6GRe1c0h.js","./iik6CYzq.js","./UYQwraN4.js","./Cp9leU2x.js"])))=>i.map(i=>d[i]);
...
import { n as Fn, T as nl, f as rl, i as il, a as ul, b as sl, u as al } from "./iik6CYzq.js";
import { f as fi, n as tu, a as Yn, s as sn, h as ol } from "./6GRe1c0h.js";
import { g as cl } from "./DaWZu8wl.js";
let bi, W, eo, pm, sE, AA, bp, K, bA, cA, aE, pn, Gn, rt;
let __tla = Promise.all([
  ...
  function Vt(e) {
    return !e || typeof e != "object" ? "" : "position" in e || "type" in e ? iu(e.position) : "start" in e || "end" in e ? iu(e) : "line" in e || "column" in e ? zr(e) : "";
  }
  function zr(e) {
  ...
  class yl {
    constructor(t) {
      ...
      t ? Yr(t) ? n = {
        path: t
      } : typeof t == "string" || kl(t) ? n = {
        value: t
      } : n = t : n = {}, this.cwd = "cwd" in n ? "" : Al.cwd(), this.data = {}, this.history = [], this.messages = [], this.value, this.map, this.result, this.stored;
      let r = -1;
      for (; ++r < lr.length; ) {
        const u = lr[r];
      ...
      let i;
      for (i in n) lr.includes(i) || (this[i] = n[i]);
    }
    get basename() {
      return typeof this.path == "string" ? Oe.basename(this.path) : void 0;
    }
    set basename(t) {
      hr(t, "basename"), fr(t, "basename"), this.path = Oe.join(this.dirname || "", t);
    }
    get dirname() {
      return typeof this.path == "string" ? Oe.dirname(this.path) : void 0;
    }
    set dirname(t) {
      su(this.basename, "dirname"), this.path = Oe.join(t || "", this.basename);
    }
    get extname() {
      return typeof this.path == "string" ? Oe.extname(this.path) : void 0;
    }
    set extname(t) {
      if (fr(t, "extname"), su(this.dirname, "extname"), t) {
    ...
    set path(t) {
      Yr(t) && (t = _l(t)), hr(t, "path"), this.path !== t && this.history.push(t);
    }
    get stem() {
      return typeof this.path == "string" ? Oe.basename(this.path, this.extname) : void 0;
    }
    set stem(t) {
      hr(t, "stem"), fr(t, "stem"), this.path = Oe.join(this.dirname || "", t + (this.extname || ""));
    }
    fail(t, n, r) {
  ...
  class hi extends Il {
    constructor() {
      super("copy"), this.Compiler = void 0, this.Parser = void 0, this.attachers = [], this.compiler = void 0, this.freezeIndex = -1, this.frozen = void 0, this.namespace = {}, this.parser = void 0, this.transformers = hl();
    }
    copy() {
      const t = new hi();
      let n = -1;
      ...
      return t.data(cr(true, {}, this.namespace)), t;
    }
    data(t, n) {
      return typeof t == "string" ? arguments.length === 2 ? (mr("data", this.frozen), this.namespace[t] = n, this) : Nl.call(this.namespace, t) && this.namespace[t] || void 0 : t ? (mr("data", this.frozen), this.namespace = t, this) : this.namespace;
    }
    freeze() {
    ...
    process(t, n) {
      const r = this;
      return this.freeze(), pr("process", this.parser || this.Parser), dr("process", this.compiler || this.Compiler), n ? i(void 0, n) : new Promise(i);
      function i(u, s) {
        const a = gn(t), o = r.parse(a);
        r.run(o, a, function(h, f, d) {
          if (h || !f || !d) return l(h);
          const p = f, E = r.stringify(p, d);
          xl(E) ? d.value = E : d.result = E, l(h, d);
        });
        function l(h, f) {
    ...
    processSync(t) {
      let n = false, r;
      return this.freeze(), pr("processSync", this.parser || this.Parser), dr("processSync", this.compiler || this.Compiler), this.process(t, i), ou("processSync", "process", n), r;
      function i(u, s) {
        n = true, nu(u), r = s;
      }
    }
    ...
    runSync(t, n) {
      let r = false, i;
      return this.run(t, n, u), ou("runSync", "run", r), i;
      function u(s, a) {
        nu(s), i = a, r = true;
      }
    }
    stringify(t, n) {
      ...
      return dr("stringify", i), au(t), i(t, r);
    }
    use(t, ...n) {
      const r = this.attachers, i = this.namespace;
      if (mr("use", this.frozen), t != null) if (typeof t == "function") o(t, n);
      ...
      function s(l) {
        ...
        a(l.plugins), l.settings && (i.settings = cr(true, i.settings, l.settings));
      }
      function a(l) {
        let h = -1;
  ...
  const Fl = {};
  function qn(e, t) {
    const n = Fl, r = typeof n.includeImageAlt == "boolean" ? n.includeImageAlt : true, i = typeof n.includeHtml == "boolean" ? n.includeHtml : true;
    return vs(e, r, i);
  }
  function vs(e, t, n) {
    if (Ol(e)) {
      ...
      if ("children" in e) return cu(e.children, t, n);
    }
  ...
  function cu(e, t, n) {
    const r = [];
    let i = -1;
    for (; ++i < e.length; ) r[i] = vs(e[i], t, n);
    return r.join("");
  }
  function Ol(e) {
    return !!(e && typeof e == "object");
  }
  const lu = document.createElement("i");
  function nn(e) {
    const t = "&" + e + ";";
    lu.innerHTML = t;
    const n = lu.textContent;
  ...
  function wl(e, t) {
    let n;
    for (n in t) {
      const i = (fu.call(e, n) ? e[n] : void 0) || (e[n] = {}), u = t[n];
      let s;
      if (u) for (s in u) {
        fu.call(i, s) || (i[s] = []);
        const a = u[s];
        Rl(i[s], Array.isArray(a) ? a : a ? [
          a
        ] : []);
      }
    }
  ...
  const de = Qe(/[A-Za-z]/), he = Qe(/[\dA-Za-z]/), Bl = Qe(/[#-'*+\--9=?A-Z^-~]/);
  function On(e) {
    return e !== null && (e < 32 || e === 127);
  }
  const qr = Qe(/\d/), Pl = Qe(/[\dA-Fa-f]/), Ml = Qe(/[!-/:-@[-`{-~]/);
  K = function(e) {
    return e !== null && e < -2;
  };
  function ne(e) {
  ...
  const $n = Qe(new RegExp("\\p{P}|\\p{S}", "u")), at = Qe(/\s/);
  function Qe(e) {
    return t;
    function t(n) {
  ...
  function zl(e) {
    ...
    function o(S) {
      if (r++, t.containerState._closeFlow) {
        ...
        return _e(t.events, v + 1, 0, t.events.slice(B)), t.events.length = Y, l(S);
      }
      return a(S);
    }
    function l(S) {
      ...
      return t.containerState = {}, e.check(hu, h, f)(S);
    }
    function h(S) {
      return i && x(), C(r), d(S);
    }
    ...
    function d(S) {
      return t.containerState = {}, e.attempt(hu, p, E)(S);
    }
    function p(S) {
      return r++, n.push([
        t.currentConstruct,
    ...
    function D(S, B) {
      ...
      if (B && v.push(null), S.previous = u, u && (u.next = S), u = S, i.defineSkip(S.start), i.write(v), t.parser.lazy[S.start.line]) {
        ...
        _e(t.events, w + 1, 0, t.events.slice(Y)), t.events.length = k;
      }
    }
    function C(S) {
      let B = n.length;
    ...
    for (; ++n < e.length; ) if (e[n][0] === "enter" && e[n][1].type === "attentionSequence" && e[n][1]._close) {
      for (r = n; r--; ) if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
        ...
        pu(f, -o), pu(d, o), s = {
          ...
          ...a.end
        }, l = [], e[r][1].end.offset - e[r][1].start.offset && (l = De(l, [
          [
            "enter",
            e[r][1],
            t
        ...
        ]), l = De(l, jn(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t)), l = De(l, [
          [
            "exit",
            u,
            t
        ...
        ]), e[n][1].end.offset - e[n][1].start.offset ? (h = 2, l = De(l, [
          [
            "enter",
            e[n][1],
            t
        ...
        ])) : h = 0, _e(e, r - 1, n - r + 3, l), n = r + l.length - h - 2;
        break;
      }
    }
  ...
  function Vl(e, t, n) {
    ...
    function l(p) {
      return p === 64 ? (e.consume(p), h) : Bl(p) ? (e.consume(p), l) : n(p);
    }
    function h(p) {
      return he(p) ? f(p) : n(p);
    }
  ...
  function Xl(e, t, n) {
    ...
    function i(u) {
      return Ml(u) ? (e.enter("characterEscapeValue"), e.consume(u), e.exit("characterEscapeValue"), e.exit("characterEscape"), t) : n(u);
    }
  }
  const js = {
  ...
  function Jl(e, t, n) {
    ...
    function l(f) {
      return f === 88 || f === 120 ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(f), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), u = 6, s = Pl, h) : (e.enter("characterReferenceValue"), u = 7, s = qr, h(f));
    }
    function h(f) {
      if (f === 59 && i) {
  ...
  function Zl(e, t, n) {
    ...
    function f(k) {
      return k === null || K(k) ? (e.exit("codeFencedFence"), r.interrupt ? t(k) : e.check(du, m, B)(k)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", {
        contentType: "string"
      }), d(k));
    }
    function d(k) {
    ...
    function x(k) {
      return k === null || K(k) ? e.check(du, m, B)(k) : (e.enter("codeFlowValue"), S(k));
    }
    function S(k) {
  ...
  function nf(e, t, n) {
    ...
    function s(l) {
      return l === null ? o(l) : K(l) ? e.attempt(tf, s, o)(l) : (e.enter("codeFlowValue"), a(l));
    }
    function a(l) {
  ...
  function Vs(e) {
    ...
    for (; ++n < h.length; ) {
      ...
      if (r[0] === "enter") r[1].contentType && (Object.assign(t, lf(h, n)), n = t[n], l = true);
    ...
    return _e(e, 0, Number.POSITIVE_INFINITY, h.slice(0)), !l;
  }
  function lf(e, t) {
  ...
  function df(e, t) {
    ...
    function i(a) {
      return a === null ? u(a) : K(a) ? e.check(hf, s, u)(a) : (e.consume(a), i);
    }
    function u(a) {
  ...
  function bf(e, t, n) {
    ...
    function s(p) {
      return Ws.call(r, e, a, n, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(p);
    }
    function a(p) {
    ...
    function l(p) {
      return Ks(e, h, n, "definitionDestination", "definitionDestinationLiteral", "definitionDestinationLiteralMarker", "definitionDestinationRaw", "definitionDestinationString")(p);
    }
    function h(p) {
      return e.attempt(gf, f, f)(p);
    }
    function f(p) {
  ...
  function Tf(e, t, n) {
    ...
    function i(a) {
      return Gs(e, u, n, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(a);
    }
    function u(a) {
  ...
  function Lf(e, t, n) {
    ...
    function D(A) {
      if (A === null || A === 47 || A === 62 || ne(A)) {
        ...
        return !oe && !u && mu.includes(Je) ? (i = 1, r.interrupt ? t(A) : z(A)) : kf.includes(s.toLowerCase()) ? (i = 6, oe ? (e.consume(A), C) : r.interrupt ? t(A) : z(A)) : (i = 7, r.interrupt && !r.parser.lazy[r.now().line] ? n(A) : u ? x(A) : S(A));
      }
    ...
    function z(A) {
      return A === 45 && i === 2 ? (e.consume(A), L) : A === 60 && i === 1 ? (e.consume(A), O) : A === 62 && i === 4 ? (e.consume(A), ie) : A === 63 && i === 3 ? (e.consume(A), _) : A === 93 && i === 5 ? (e.consume(A), y) : K(A) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(Nf, le, V)(A)) : A === null || K(A) ? (e.exit("htmlFlowData"), V(A)) : (e.consume(A), z);
    }
    function V(A) {
      return e.check(Sf, X, le)(A);
    }
    function X(A) {
    ...
    function j(A) {
      if (A === 62) {
        ...
        return mu.includes(oe) ? (e.consume(A), ie) : z(A);
      }
  ...
  function Hf(e, t) {
    ...
    ], a = De(a, e.slice(u + 1, u + r + 3)), a = De(a, [
      [
        "enter",
        h,
        t
      ]
    ]), a = De(a, jn(t.parser.constructs.insideSpan.null, e.slice(u + r + 4, s - 3), t)), a = De(a, [
      [
        "exit",
        h,
        t
  ...
  function vf(e, t, n) {
    ...
    function o(d) {
      return d === 40 ? e.attempt(Bf, h, s ? h : f)(d) : d === 91 ? e.attempt(Pf, h, s ? l : f)(d) : s ? h(d) : f(d);
    }
    function l(d) {
      return e.attempt(Mf, h, f)(d);
    }
    function h(d) {
      return t(d);
    }
  ...
  function zf(e, t, n) {
    ...
    function u(f) {
      return f === 41 ? h(f) : Ks(e, s, a, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(f);
    }
    function s(f) {
    ...
    function o(f) {
      return f === 34 || f === 39 || f === 40 ? Gs(e, l, n, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(f) : h(f);
    }
    function l(f) {
  ...
  function Yf(e, t, n) {
    ...
    return i;
    function i(a) {
      return Ws.call(r, e, u, s, "reference", "referenceMarker", "referenceString")(a);
    }
    function u(a) {
  ...
  function Jf(e, t, n) {
    ...
    function a(p) {
      ...
      if (E === "listUnordered" ? !r.containerState.marker || p === r.containerState.marker : qr(p)) {
    ...
    function o(p) {
      return qr(p) && ++s < 10 ? (e.consume(p), o) : (!r.interrupt || s < 2) && (r.containerState.marker ? p === r.containerState.marker : p === 41 || p === 46) ? (e.exit("listItemValue"), l(p)) : n(p);
    }
    function l(p) {
      return e.enter("listItemMarker"), e.consume(p), e.exit("listItemMarker"), r.containerState.marker = r.containerState.marker || p, e.check(on, r.interrupt ? n : h, e.attempt(Qf, d, f));
    }
    function h(p) {
  ...
  function Zf(e, t, n) {
    ...
    function u(a) {
      return r.containerState.furtherBlankLines || !Q(a) ? (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, s(a)) : (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, e.attempt(Xf, t, s)(a));
    }
    function s(a) {
      return r.containerState._closeFlow = true, r.interrupt = void 0, W(e, e.attempt(Te, t, n), "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(a);
    }
  }
  function eh(e, t, n) {
    const r = this;
  ...
  function sh(e) {
    const t = this, n = e.attempt(on, r, e.attempt(this.parser.constructs.flowInitial, i, W(e, e.attempt(this.parser.constructs.flow, i, e.attempt(ff, i)), "linePrefix")));
    return n;
    function r(u) {
      if (u === null) {
        e.consume(u);
  ...
  const ah = {
    resolveAll: Xs()
  }, oh = Qs("string"), ch = Qs("text");
  function Qs(e) {
    return {
      resolveAll: Xs(e === "text" ? lh : void 0),
      tokenize: t
    };
    function t(n) {
  ...
  function Ch(e, t, n) {
    ...
    function f(M) {
      return s = De(s, M), D(), s[s.length - 1] !== null ? [] : (w(t, 0), l.events = jn(u, l.events, l), l.events);
    }
    function d(M, z) {
      return Dh(p(M), z);
    }
    ...
    function w(M, z) {
      M.resolveAll && !u.includes(M) && u.push(M), M.resolve && _e(l.events, z, l.events.length - z, M.resolve(l.events.slice(z), l)), M.resolveTo && (l.events = M.resolveTo(l.events, l));
    }
    function $() {
...
`;
  ...
  function Ih() {
    ...
    function i(u, s, a) {
      ...
      for (u = t + (typeof u == "string" ? u.toString() : new TextDecoder(s || void 0).decode(u)), f = 0, t = "", n && (u.charCodeAt(0) === 65279 && f++, n = void 0); f < u.length; ) {
        if (gu.lastIndex = f, l = gu.exec(u), d = l && l.index !== void 0 ? l.index : u.length, p = u.charCodeAt(d), !l) {
          t = u.slice(f);
          break;
        }
  ...
  function Js(e) {
    return e.replace(Nh, Sh);
  }
  function Sh(e, t, n) {
    if (t) return t;
    if (n.charCodeAt(0) === 35) {
      const i = n.charCodeAt(1), u = i === 120 || i === 88;
      return Ys(n.slice(u ? 2 : 1), u ? 16 : 10);
    }
    return nn(n) || e;
  }
  const Zs = {}.hasOwnProperty;
  function xh(e, t, n) {
    return typeof t != "string" && (n = t, t = void 0), Lh(n)(kh(yh(n).document().write(Ih()(e, t, true))));
  }
  function Lh(e) {
    const t = {
      transforms: [],
      ...
      enter: {
        ...
        emphasis: u(Ic),
        hardBreakEscape: u(ji),
        hardBreakTrailing: u(ji),
        htmlFlow: u(Vi, s),
        htmlFlowData: $,
        htmlText: u(Vi, s),
        htmlTextData: $,
    ...
    function i(P, q, J) {
      ...
      for (; ++re <= J; ) {
        ...
        switch (Ce[1].type) {
          ...
          case "listOrdered":
          case "blockQuote": {
            Ce[0] === "enter" ? ue++ : ue--, wt = void 0;
            break;
          }
          case "lineEndingBlank": {
            Ce[0] === "enter" && (Ze && !wt && !ue && !Ot && (Ot = re), wt = void 0);
            break;
          }
          case "linePrefix":
          case "listItemValue":
        ...
        if (!ue && Ce[0] === "enter" && Ce[1].type === "listItemPrefix" || ue === -1 && Ce[0] === "exit" && (Ce[1].type === "listUnordered" || Ce[1].type === "listOrdered")) {
          if (Ze) {
            let ft = re;
            for (Pe = void 0; ft--; ) {
              const Me = P[ft];
            ...
            Ot && (!Pe || Ot < Pe) && (Ze._spread = true), Ze.end = Object.assign({}, Pe ? P[Pe][1].start : Ce[1].end), P.splice(Pe || re, 0, [
              "exit",
              Ze,
              Ce[2]
            ]), re++, J++;
    ...
    function l(P, q) {
      ...
      if (re) re[0].type !== P.type && (q ? q.call(this, P, re[0]) : (re[1] || bu).call(this, P, re[0]));
    ...
    function $(P) {
      ...
      let re = J[J.length - 1];
      (!re || re.type !== "text") && (re = Fc(), re.position = {
        start: $e(P.start),
        end: void 0
    ...
    function j(P) {
      ...
      J.label = Js(q), J.identifier = Se(q).toLowerCase();
    }
    function y() {
    ...
    function Ee(P) {
      ...
      let re;
      J ? (re = Ys(q, J === "characterReferenceMarkerNumeric" ? 10 : 16), this.data.characterReferenceType = void 0) : re = nn(q);
  ...
  function ea(e, t) {
    ...
    for (; ++n < t.length; ) {
      const r = t[n];
      Array.isArray(r) ? ea(e, r) : Fh(e, r);
    }
  }
  function Fh(e, t) {
    let n;
    for (n in t) if (Zs.call(t, n)) switch (n) {
      case "canContainEols": {
        const r = t[n];
        r && e[n].push(...r);
        break;
...
` : "", r = {}, i = t.lang ? t.lang.split(/\s+/) : [];
  ...
  function Vh(e, t, n) {
    const r = e.all(t), i = n ? Kh(n) : na(t), u = {}, s = [];
...
`
  ...
  function Jh(e, t) {
    ...
    if (n.length > 0) {
      ...
      }, a = ze(t.children[1]), o = Vn(t.children[t.children.length - 1]);
      a && o && (s.position = {
        start: a,
        end: o
      }), i.push(s);
  ...
  function t0(e) {
    ...
    let r = n.exec(t), i = 0;
    const u = [];
    for (; r; ) u.push(Cu(t.slice(i, r.index), i > 0, true), r[0]), i = r.index + r[0].length, r = n.exec(t);
    return u.push(Cu(t.slice(i), i > 0, false)), u.join("");
  }
  function Cu(e, t, n) {
    let r = 0, i = e.length;
    if (t) {
      let u = e.codePointAt(r);
      for (; u === Tu || u === Au; ) r++, u = e.codePointAt(r);
    }
    if (n) {
      let u = e.codePointAt(i - 1);
      for (; u === Tu || u === Au; ) i--, u = e.codePointAt(i - 1);
    }
  ...
  const ua = -1, Kn = 0, Kt = 1, wn = 2, di = 3, mi = 4, Ei = 5, gi = 6, sa = 7, aa = 8, _u = typeof self == "object" ? self : globalThis, u0 = (e, t) => {
    const n = (i, u) => (e.set(u, i), i), r = (i) => {
      ...
      return n(new _u[u](s), i);
    };
    return r;
  }, Du = (e) => u0(/* @__PURE__ */ new Map(), e)(0), ht = "", { toString: s0 } = {}, { keys: a0 } = Object, Bt = (e) => {
    const t = typeof e;
    if (t !== "object" || !e) return [
      Kn,
      t
    ];
    const n = s0.call(e).slice(8, -1);
    switch (n) {
      case "Array":
        return [
          Kt,
  ...
  }, Tn = ([e, t]) => e === Kn && (t === "function" || t === "symbol"), o0 = (e, t, n, r) => {
    const i = (s, a) => {
      const o = r.push(s) - 1;
      return n.set(a, o), o;
    }, u = (s) => {
      ...
      switch (a) {
        ...
        case wn: {
          ...
          for (const d of a0(s)) (e || !Tn(Bt(s[d]))) && h.push([
            u(d),
            u(s[d])
          ]);
          return f;
    ...
    const r = [];
    return o0(!(t || n), !!t, /* @__PURE__ */ new Map(), r)(e), r;
  }, xe = typeof structuredClone == "function" ? (e, t) => t && ("json" in t || "lossy" in t) ? Du(yu(e, t)) : structuredClone(e) : (e, t) => Du(yu(e, t));
  function c0(e, t) {
    const n = [
      {
        type: "text",
  ...
  function f0(e) {
    const t = typeof e.options.clobberPrefix == "string" ? e.options.clobberPrefix : "user-content-", n = e.options.footnoteBackContent || c0, r = e.options.footnoteBackLabel || l0, i = e.options.footnoteLabel || "Footnotes", u = e.options.footnoteLabelTagName || "h2", s = e.options.footnoteLabelProperties || {
      className: [
        "sr-only"
      ]
    }, a = [];
...
`
  ...
  const yt = (function(e) {
    ...
    if (typeof e == "object") return Array.isArray(e) ? h0(e) : p0(e);
    if (typeof e == "string") return d0(e);
  ...
  function Wn(e) {
    return t;
    function t(n, r, i) {
      return !!(E0(n) && e.call(this, n, typeof r == "number" ? r : void 0, i || void 0));
    }
  }
  function m0() {
    return true;
  ...
  Gn = function(e, t, n, r) {
    ...
    function a(o, l, h) {
      ...
      function d() {
        let p = oa, E, m, D;
        if ((!t || u(o, l, h[h.length - 1] || void 0)) && (p = b0(n(o, h)), p[0] === Rn)) return p;
        if ("children" in o && o.children) {
          const C = o;
          if (C.children && p[0] !== bi) for (m = (r ? C.children.length : -1) + s, D = h.concat(C); m > -1 && m < C.children.length; ) {
  ...
  function Bn(e, t, n, r) {
    let i, u, s;
    typeof t == "function" && typeof n != "function" ? (u = void 0, s = t, i = n) : (u = t, s = n, i = r), Gn(e, u, a, i);
    function a(o, l) {
      const h = l[l.length - 1], f = h ? h.children.indexOf(o) : void 0;
      return s(o, f, h);
    }
  }
  const Vr = {}.hasOwnProperty, T0 = {};
  function A0(e, t) {
    const n = t || T0, r = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), s = {
      ...i0,
      ...n.handlers
    }, a = {
      all: l,
    ...
    function o(h, f) {
      ...
      if (Vr.call(a.handlers, d) && p) return p(a, h, f);
      ...
      return (a.options.unknownHandler || D0)(a, h, f);
    }
    function l(h) {
      const f = [];
      if ("children" in h) {
        ...
        for (; ++p < d.length; ) {
          const E = a.one(d[p], h);
          if (E) {
            if (p && d[p - 1].type === "break" && (!Array.isArray(E) && E.type === "text" && (E.value = ku(E.value)), !Array.isArray(E) && E.type === "element")) {
              const m = E.children[0];
              m && m.type === "text" && (m.value = ku(m.value));
            }
  ...
  function D0(e, t) {
    const n = t.data || {}, r = "value" in t && !(Vr.call(n, "hProperties") || Vr.call(n, "hChildren")) ? {
      type: "text",
      value: t.value
    } : {
      type: "element",
...
`
  ...
  function Iu(e, t) {
    const n = A0(e, t), r = n.one(e, void 0), i = f0(n), u = Array.isArray(r) ? {
      type: "root",
      children: r
    } : r || {
      type: "root",
...
`
  ...
  const kt = {
    ...
    resolve(e, t) {
      return Rs(e) || t("Expected a mapping for this tag"), e;
    },
    ...
    resolve(e, t) {
      return Bs(e) || t("Expected a sequence for this tag"), e;
    },
    ...
    test: /^(?:~|[Nn]ull|NULL)?$/,
    resolve: () => new ae(null),
    stringify: ({ source: e }, t) => typeof e == "string" && Xn.test.test(e) ? e : t.options.nullStr
  }, Ti = {
  ...
  const ca = {
    ...
    stringify: Le
  }, Jn = (e) => typeof e == "bigint" || Number.isInteger(e), Ai = (e, t, n, { intAsBigInt: r }) => r ? BigInt(e) : parseInt(e.substring(t), n);
  function ha(e, t, n) {
    const { value: r } = e;
    return Jn(r) && r >= 0 ? n + r.toString(t) : Le(e);
  }
  const pa = {
    identify: (e) => Jn(e) && e >= 0,
    default: true,
    ...
    format: "OCT",
    test: /^0o[0-7]+$/,
    resolve: (e, t, n) => Ai(e, 2, 8, n),
    stringify: (e) => ha(e, 8, "0o")
  }, da = {
    identify: Jn,
    default: true,
    tag: "tag:yaml.org,2002:int",
    test: /^[-+]?[0-9]+$/,
    resolve: (e, t, n) => Ai(e, 0, 10, n),
    stringify: Le
  }, ma = {
    identify: (e) => Jn(e) && e >= 0,
    default: true,
    ...
    format: "HEX",
    test: /^0x[0-9a-fA-F]+$/,
    resolve: (e, t, n) => Ai(e, 2, 16, n),
    stringify: (e) => ha(e, 16, "0x")
  }, I0 = [
    kt,
    It,
    Qn,
  ...
  const An = ({ value: e }) => JSON.stringify(e), N0 = [
    {
      identify: (e) => typeof e == "string",
      default: true,
      tag: "tag:yaml.org,2002:str",
    ...
    },
    {
      ...
      stringify: ({ value: e }) => Nu(e) ? e.toString() : JSON.stringify(e)
    },
    {
      identify: (e) => typeof e == "number",
      default: true,
...
` : " ");
  ...
  function Ea({ value: e, source: t }, n) {
    return t && (e ? ga : ba).test.test(t) ? t : e ? n.options.trueStr : n.options.falseStr;
  }
  const ga = {
    identify: (e) => e === true,
    default: true,
  ...
  function Zn(e, t, n, { intAsBigInt: r }) {
    const i = e[0];
  ...
  const w0 = {
    ...
    format: "BIN",
    test: /^[-+]?0b[0-1_]+$/,
    resolve: (e, t, n) => Zn(e, 2, 2, n),
    stringify: (e) => _i(e, 2, "0b")
  }, R0 = {
    identify: cn,
    default: true,
    tag: "tag:yaml.org,2002:int",
    format: "OCT",
    test: /^[-+]?0[0-7_]+$/,
    resolve: (e, t, n) => Zn(e, 1, 8, n),
    stringify: (e) => _i(e, 8, "0")
  }, B0 = {
    identify: cn,
    default: true,
    tag: "tag:yaml.org,2002:int",
    test: /^[-+]?[0-9][0-9_]*$/,
    resolve: (e, t, n) => Zn(e, 0, 10, n),
    stringify: Le
  }, P0 = {
    identify: cn,
    default: true,
    ...
    format: "HEX",
    test: /^[-+]?0x[0-9a-fA-F_]+$/,
    resolve: (e, t, n) => Zn(e, 2, 16, n),
    stringify: (e) => _i(e, 16, "0x")
  };
  function Di(e, t) {
  ...
  const Aa = {
    ...
    resolve: (e, t, { intAsBigInt: n }) => Di(e, n),
    stringify: Ta
  }, Ca = {
    identify: (e) => typeof e == "number",
    default: true,
    ...
    "tag:yaml.org,2002:binary": Ci,
    "tag:yaml.org,2002:merge": bt,
    "tag:yaml.org,2002:omap": si,
    "tag:yaml.org,2002:pairs": ai,
    "tag:yaml.org,2002:set": oi,
    "tag:yaml.org,2002:timestamp": er
  };
  function br(e, t, n) {
    const r = xu.get(t);
    ...
    if (!i) if (Array.isArray(e)) i = [];
      ...
      const u = Array.from(xu.keys()).filter((s) => s !== "yaml11").map((s) => JSON.stringify(s)).join(", ");
    ...
    return n && (i = i.concat(bt)), i.reduce((u, s) => {
      const a = typeof s == "string" ? Lu[s] : s;
      if (!a) {
        const o = JSON.stringify(s), l = Object.keys(Lu).map((h) => JSON.stringify(h)).join(", ");
        throw new Error(`Unknown custom tag ${o}; use one of ${l}`);
      }
      return u.includes(a) || u.push(a), u;
    }, []);
  }
  const U0 = (e, t) => e.key < t.key ? -1 : e.key > t.key ? 1 : 0;
  class yi {
    constructor({ compat: t, customTags: n, merge: r, resolveKnownTags: i, schema: u, sortMapEntries: s, toStringDefaults: a }) {
      this.compat = Array.isArray(t) ? br(t, "compat") : t ? br(null, t) : null, this.name = typeof u == "string" && u || "core", this.knownTags = i ? M0 : {}, this.tags = br(n, this.name, r), this.toStringOptions = a ?? null, Object.defineProperty(this, Rc, {
        value: kt
      }), Object.defineProperty(this, st, {
        value: Qn
      }), Object.defineProperty(this, Bc, {
        value: It
      }), this.sortMapEntries = typeof s == "function" ? s : s === true ? U0 : null;
    }
    clone() {
      const t = Object.create(yi.prototype, Object.getOwnPropertyDescriptors(this));
  ...
  function H0(e, t) {
    ...
    r && n.push("---");
    const i = Pc(e, t), { commentString: u } = i.options;
    if (e.commentBefore) {
    ...
    if (e.contents) {
      ...
      let l = Gi(e.contents, i, () => a = null, o);
      a && (l += Mc(l, "", u(a))), (l[0] === "|" || l[0] === ">") && n[n.length - 1] === "---" ? n[n.length - 1] = `--- ${l}` : n.push(l);
    } else n.push(Gi(e.contents, i));
...
`;
  ...
  class Nt {
    constructor(t, n, r) {
      this.commentBefore = null, this.comment = null, this.errors = [], this.warnings = [], Object.defineProperty(this, Qi, {
        value: Xi
      });
      let i = null;
    ...
    createAlias(t, n) {
      if (!t.anchor) {
        const r = Uc(this);
        t.anchor = !n || r.has(n) ? Hc(n || "a", r) : n;
      }
      return new Ms(t.anchor);
    }
    createNode(t, n, r) {
      let i;
      ...
      const { aliasDuplicateObjects: u, anchorPrefix: s, flow: a, keepUndefined: o, onTagObj: l, tag: h } = r ?? {}, { onAnchor: f, setAnchors: d, sourceObjects: p } = qc(this, s || "a"), E = {
    ...
    set(t, n) {
      this.contents == null ? this.contents = Ji(this.schema, [
        t
      ], n) : pt(this.contents) && this.contents.set(t, n);
    }
    setIn(t, n) {
      En(t) ? this.contents = n : this.contents == null ? this.contents = Ji(this.schema, Array.from(t), n) : pt(this.contents) && this.contents.setIn(t, n);
    }
    setSchema(t, n = {}) {
      ...
      else if (r) this.schema = new yi(Object.assign(r, n));
...
`)) return true;
  ...
  const Ou = "All mapping items must start at the same column";
  function z0({ composeNode: e, composeEmptyNode: t }, n, r, i, u) {
    ...
    for (const h of r.items) {
      ...
      if (D) {
        if (d && (d.type === "block-seq" ? i(o, "BLOCK_AS_IMPLICIT_KEY", "A block sequence may not be used as an implicit map key") : "indent" in d && d.indent !== r.indent && i(o, "BAD_INDENT", Ou)), !m.anchor && !m.tag && !p) {
...
` + m.comment : a.comment = m.comment);
      ...
      } else ((_a2 = m.found) == null ? void 0 : _a2.indent) !== r.indent && i(o, "BAD_INDENT", Ou);
      n.atKey = true;
      const C = m.end, x = d ? e(n, d, m, i) : t(n, C, f, null, m, i);
      n.schema.compat && Kr(r.indent, d, i), n.atKey = false, Da(n, a.items, x) && i(C, "DUPLICATE_KEY", "Map keys must be unique");
      const S = _t(p ?? [], {
      ...
      if (o = S.end, S.found) {
        ...
        n.schema.compat && Kr(r.indent, E, i), o = B.range[2];
        const v = new tn(x, B);
...
` + S.comment : x.comment = S.comment);
  ...
  function Y0({ composeNode: e, composeEmptyNode: t }, n, r, i, u) {
    ...
    for (const { start: h, value: f } of r.items) {
      ...
      n.schema.compat && Kr(r.indent, f, i), o = p.range[2], a.items.push(p);
    }
    return a.range = [
      r.offset,
      o,
  ...
  const Tr = "Block collections are not allowed within flow collections", Ar = (e) => e && (e.type === "block-map" || e.type === "block-seq");
  function q0({ composeNode: e, composeEmptyNode: t }, n, r, i, u) {
    var _a2;
...
` + k.comment : l.comment = k.comment), f = k.end;
      ...
      if (D === 0) k.comma && i(k.comma, "UNEXPECTED_TOKEN", `Unexpected , in ${a}`);
        ...
        if (Y) {
          ...
          Us(w) && (w = w.value ?? w.key), w.comment ? w.comment += `
` + Y : w.comment = Y, k.comment = k.comment.substring(Y.length + 1);
        }
      }
      if (!s && !B && !k.found) {
        const Y = v ? e(n, v, k, i) : t(n, k.end, B, null, k, i);
        l.items.push(Y), f = Y.range[2], Ar(v) && i(Y.range, "BLOCK_IN_FLOW", Tr);
      } else {
        n.atKey = true;
        const Y = k.end, w = S ? e(n, S, k, i) : t(n, Y, x, null, k, i);
        Ar(S) && i(w.range, "BLOCK_IN_FLOW", Tr), n.atKey = false;
        const $ = _t(B ?? [], {
          flow: a,
          indicator: "map-value-ind",
          next: v,
        ...
        I ? Ar(v) && i(I.range, "BLOCK_IN_FLOW", Tr) : $.comment && (w.comment ? w.comment += `
` + $.comment : w.comment = $.comment);
        const M = new tn(w, I);
        if (n.options.keepSourceTokens && (M.srcToken = C), s) {
          const z = l;
          Da(n, z.items, w) && i(Y, "DUPLICATE_KEY", "Map keys must be unique"), z.items.push(M);
        } else {
...
` + D.comment : l.comment = D.comment), l.range = [
  ...
  function Cr(e, t, n, r, i, u) {
    const s = n.type === "block-map" ? z0(e, t, n, r, u) : n.type === "block-seq" ? Y0(e, t, n, r, u) : q0(e, t, n, r, u), a = s.constructor;
  ...
  function $0(e, t, n, r, i) {
    ...
    if (!u || !s || s === "!" || s === ut.tagName && a === "map" || s === Tt.tagName && a === "seq") return Cr(e, t, n, i, s);
    ...
    if (!o) {
      ...
      else return d ? i(u, "BAD_COLLECTION_TYPE", `${d.tag} used for ${a} collection, but expects ${d.collection ?? "scalar"}`, true) : i(u, "TAG_RESOLVE_FAILED", `Unresolved tag: ${s}`, true), Cr(e, t, n, i, s);
    }
    const l = Cr(e, t, n, i, s, o), h = ((_a2 = o.resolve) == null ? void 0 : _a2.call(o, l, (d) => i(u, "TAG_RESOLVE_FAILED", d), t.options)) ?? l, f = ci(h) ? h : new ae(h);
    return f.range = l.range, f.tag = s, (o == null ? void 0 : o.format) && (f.format = o.format), f;
  }
  function j0(e, t, n) {
    const r = t.offset, i = V0(t, e.options.strict, n);
    if (!i) return {
      value: "",
      type: null,
      comment: "",
    ...
    const u = i.mode === ">" ? ae.BLOCK_FOLDED : ae.BLOCK_LITERAL, s = t.source ? K0(t.source) : [];
    let a = s.length;
...
`;
  ...
  function V0({ offset: e, props: t }, n, r) {
  ...
  function W0(e, t, n) {
    ...
    switch (i) {
      case "scalar":
        ...
        break;
      case "single-quoted-scalar":
        a = ae.QUOTE_SINGLE, o = Q0(u, l);
        break;
      case "double-quoted-scalar":
        a = ae.QUOTE_DOUBLE, o = X0(u, l);
        break;
      default:
  ...
  function G0(e, t) {
    ...
    return n && t(0, "BAD_SCALAR_START", `Plain value cannot start with ${n}`), ya(e);
  }
  function Q0(e, t) {
    return (e[e.length - 1] !== "'" || e.length === 1) && t(e.length, "MISSING_CHAR", "Missing closing 'quote"), ya(e.slice(1, -1)).replace(/''/g, "'");
  }
  function ya(e) {
    let t, n;
    try {
...
`,
  ...
  function ka(e, t, n, r) {
    const { value: i, type: u, comment: s, range: a } = t.type === "block-scalar" ? j0(e, t, r) : W0(t, e.options.strict, r), o = n ? e.directives.tagName(n.source, (f) => r(n, "TAG_RESOLVE_FAILED", f)) : null;
    let l;
    e.options.stringKeys && e.atKey ? l = e.schema[st] : o ? l = tp(e.schema, i, o, n, r) : t.type === "scalar" ? l = np(e, i, t, r) : l = e.schema[st];
    let h;
    try {
  ...
  function np({ atKey: e, directives: t, schema: n }, r, i, u) {
  ...
  function Ia(e, t, n, r) {
    ...
    switch (t.type) {
      case "alias":
        l = up(e, t, r), (a || o) && r(t, "ALIAS_PROPS", "An alias node must not specify any properties");
        break;
      case "scalar":
      case "single-quoted-scalar":
      case "double-quoted-scalar":
      case "block-scalar":
        l = ka(e, t, o, r), a && (l.anchor = a.source.substring(1));
        break;
      case "block-map":
      case "block-seq":
      case "flow-collection":
        l = $0(ip, e, t, n, r), a && (l.anchor = a.source.substring(1));
        break;
      default: {
        const f = t.type === "error" ? t.message : `Unsupported token (type: ${t.type})`;
        r(t, "UNEXPECTED_TOKEN", f), l = ki(e, t.offset, void 0, null, n, r), h = false;
      }
    }
  ...
  function ki(e, t, n, r, { spaceBefore: i, comment: u, anchor: s, tag: a, end: o }, l) {
    const h = {
      type: "scalar",
      offset: rp(t, n, r),
      indent: -1,
  ...
  function up({ options: e }, { offset: t, source: n, end: r }, i) {
    const u = new Ms(n.substring(1));
  ...
  function sp(e, t, { offset: n, start: r, value: i, end: u }, s) {
    ...
    h.found && (o.directives.docStart = true, i && (i.type === "block-map" || i.type === "block-seq") && !h.hasNewline && s(h.end, "MISSING_CHAR", "Block collection cannot start on same line with directives-end marker")), o.contents = i ? Ia(l, i, h, s) : ki(l, h.end, r, null, h, s);
  ...
  class ap {
    constructor(t = {}) {
      this.doc = null, this.atDirectives = false, this.prelude = [], this.errors = [], this.warnings = [], this.onError = (n, r, i, u) => {
        const s = Pt(n);
        u ? this.warnings.push(new v0(s, r, i)) : this.errors.push(new Yt(s, r, i));
      }, this.directives = new In({
        version: t.version || "1.2"
      }), this.options = t;
    }
    decorate(t, n) {
      const { comment: r, afterEmptyLine: i } = wu(this.prelude);
      if (r) {
        const u = t.contents;
...
${s}` : r;
    ...
    streamInfo() {
      return {
        comment: wu(this.prelude).comment,
...
${n.comment}` : n.comment;
  ...
  function Bu(e) {
    if (e.start.type === "flow-seq-start") for (const t of e.items) t.sep && !t.value && !Ke(t.start, "explicit-key-ind") && !Ke(t.sep, "map-value-ind") && (t.key && (t.value = t.key), delete t.key, Na(t.value) ? t.value.end ? Array.prototype.push.apply(t.value.end, t.sep) : t.value.end = t.sep : Array.prototype.push.apply(t.start, t.sep), delete t.sep);
  }
  let cp = class {
    constructor(t) {
      this.atNewLine = true, this.atScalar = false, this.indent = 0, this.offset = 0, this.onKeyLine = false, this.stack = [], this.source = "", this.type = "", this.lexer = new $c(), this.onNewLine = t;
    }
    *parse(t, n = false) {
    ...
    *pop(t) {
      ...
      if (!n) yield {
        ...
        const r = this.peek(1);
        switch (n.type === "block-scalar" ? n.indent = "indent" in r ? r.indent : 0 : n.type === "flow-collection" && r.type === "document" && (n.indent = 0), n.type === "flow-collection" && Bu(n), r.type) {
          case "document":
            r.value = n;
            break;
          case "block-scalar":
        ...
        if ((r.type === "document" || r.type === "block-map" || r.type === "block-seq") && (n.type === "block-map" || n.type === "block-seq")) {
          ...
          i && !i.sep && !i.value && i.start.length > 0 && Ru(i.start) === -1 && (n.indent === 0 || i.start.every((u) => u.type !== "comment" || u.indent < n.indent)) && (r.type === "document" ? r.end = i.start : r.items.push({
            start: i.start
          }), n.items.splice(-1, 1));
        }
      }
    ...
    *document(t) {
      ...
      switch (this.type) {
        case "doc-start": {
          Ru(t.start) !== -1 ? (yield* this.pop(), yield* this.step()) : t.start.push(this.sourceToken);
          return;
        }
        case "anchor":
        case "tag":
      ...
      if (this.indent >= t.indent) {
        ...
        switch (this.type) {
          ...
          case "map-value-ind":
            ...
            else if (Na(n.key) && !Ke(n.sep, "newline")) {
...
`, n) + 1;
  ...
  function lp(e) {
    ...
    return {
      lineCounter: e.lineCounter || t && new op() || null,
      prettyErrors: t
    };
  }
  function fp(e, t = {}) {
    const { lineCounter: n, prettyErrors: r } = lp(t), i = new cp(n == null ? void 0 : n.addNewLine), u = new ap(t);
    let s = null;
    ...
    return r && n && (s.errors.forEach(Fu(e, n)), s.warnings.forEach(Fu(e, n))), s;
  }
  function hp(e, t, n) {
    let r = null;
    ...
    return Vc(e) && !r ? e.toString(n) : new Nt(e, r, n).toString(n);
  }
  function Sa(e) {
  ...
  function pp(e, t) {
    t = t || {};
    const n = t.delimiter || ".", r = t.maxDepth, i = t.transformKey || xa, u = {};
    function s(a, o, l) {
      l = l || 1, Object.keys(a).forEach(function(h) {
        const f = a[h], d = t.safe && Array.isArray(f), p = Object.prototype.toString.call(f), E = Sa(f), m = p === "[object Object]" || p === "[object Array]", D = o ? o + n + i(h) : i(h);
  ...
  function Ii(e, t) {
    t = t || {};
    const n = t.delimiter || ".", r = t.overwrite || false, i = t.transformKey || xa, u = {};
    if (Sa(e) || Object.prototype.toString.call(e) !== "[object Object]") return e;
    function a(h) {
      const f = Number(h);
    ...
    return e = Object.keys(e).reduce(function(h, f) {
      ...
      return !(d === "[object Object]" || d === "[object Array]") || l(e[f]) ? (h[f] = e[f], h) : o(f, h, pp(e[f], t));
  ...
  function La(e, t) {
    let n = -1, r;
    if (t.extensions) for (; ++n < t.extensions.length; ) La(e, t.extensions[n]);
    for (r in t) if (dp.call(t, r)) switch (r) {
      case "extensions":
        break;
      case "unsafe": {
        Pu(e[r], t[r]);
  ...
  function Ep(e, t, n, r) {
    ...
    u.move("> "), u.shift(2);
    const s = n.indentLines(n.containerFlow(e, u.current()), gp);
    return i(), s;
  }
  function gp(e, t, n) {
    return ">" + (n ? "" : " ") + e;
  ...
  function Fa(e, t) {
    return Mu(e, t.inConstruct, true) && !Mu(e, t.notInConstruct, false);
  }
  function Mu(e, t, n) {
...
` && Fa(n.stack, n.unsafe[i])) return /[ \t]/.test(r.before) ? "" : " ";
    return `\\
`;
  }
  bp = function(e, t) {
  ...
  function Ap(e, t, n, r) {
    const i = Tp(n), u = e.value || "", s = i === "`" ? "GraveAccent" : "Tilde";
    if (Wr(e, n)) {
      const f = n.enter("codeIndented"), d = n.indentLines(u, Cp);
      return f(), d;
    }
    const a = n.createTracker(r), o = i.repeat(Math.max(bp(u, i) + 1, 3)), l = n.enter("codeFenced");
    let h = a.move(o);
    if (e.lang) {
...
`)), h += a.move(o), l(), h;
  ...
  function _p(e, t, n, r) {
    const i = Ni(n), u = i === '"' ? "Quote" : "Apostrophe", s = n.enter("definition");
    let a = n.enter("label");
...
`,
  ...
  Oa.peek = yp;
  function Oa(e, t, n, r) {
    const i = Dp(n), u = n.enter("emphasis"), s = n.createTracker(r), a = s.move(i);
    let o = s.move(n.containerPhrasing(e, {
      after: i,
      before: a,
      ...s.current()
    }));
    const l = o.charCodeAt(0), h = Pn(r.before.charCodeAt(r.before.length - 1), l, i);
    h.inside && (o = Ge(l) + o.slice(1));
    const f = o.charCodeAt(o.length - 1), d = Pn(r.after.charCodeAt(0), f, i);
...
`,
  ...
  Ba.peek = Np;
  function Ba(e, t, n, r) {
    const i = Ni(n), u = i === '"' ? "Quote" : "Apostrophe", s = n.enter("image");
    let a = n.enter("label");
    const o = n.createTracker(r);
    let l = o.move("![");
  ...
  Ha.peek = Lp;
  function Ha(e, t, n, r) {
    const i = Ni(n), u = i === '"' ? "Quote" : "Apostrophe", s = n.createTracker(r);
    let a, o;
    if (Ua(e, n)) {
      const h = n.stack;
  ...
  function Rp(e, t, n, r) {
    ...
    let s = e.ordered ? wp(n) : Si(n);
    const a = e.ordered ? s === "." ? ")" : "." : Op(n);
    let o = t && n.bulletLastUsed ? s === n.bulletLastUsed : false;
    if (!e.ordered) {
      const h = e.children ? e.children[0] : void 0;
      if ((s === "*" || s === "-") && h && (!h.children || !h.children[0]) && n.stack[n.stack.length - 1] === "list" && n.stack[n.stack.length - 2] === "listItem" && n.stack[n.stack.length - 3] === "list" && n.stack[n.stack.length - 4] === "listItem" && n.indexStack[n.indexStack.length - 1] === 0 && n.indexStack[n.indexStack.length - 2] === 0 && n.indexStack[n.indexStack.length - 3] === 0 && (o = true), za(n) === s && h) {
        let f = -1;
  ...
  qa.peek = vp;
  function qa(e, t, n, r) {
    const i = Hp(n), u = n.enter("strong"), s = n.createTracker(r), a = s.move(i + i);
    let o = s.move(n.containerPhrasing(e, {
      after: i,
      before: a,
      ...s.current()
  ...
  function qp(e, t, n) {
    const r = (za(n) + (n.options.ruleSpaces ? " " : "")).repeat(Yp(n));
  ...
  function jp(e, t, n, r) {
    if (t.type === "code" && Wr(t, r) && (e.type === "list" || e.type === t.type && Wr(e, r))) return false;
    if ("spread" in n && typeof n.spread == "boolean") return e.type === "paragraph" && (e.type === t.type || t.type === "definition" || t.type === "heading" && wa(t, r)) ? void 0 : n.spread ? 1 : 0;
  }
  const et = [
    "autolink",
    "destinationLiteral",
...
-])`
  ...
  function Kp(e) {
    return e.label || !e.identifier ? e.label || "" : Js(e.identifier);
  }
  function Wp(e) {
    if (!e._compiled) {
      const t = (e.atBreak ? "[\\r\\n][\\t ]*" : "") + (e.before ? "(?:" + e.before + ")" : "");
...
`,
        ...u.current()
      }))), o.type !== "list" && (t.bulletLastUsed = void 0), a < i.length - 1 && s.push(u.move(Xp(o, i[a + 1], e, t)));
    }
    return r.pop(), s.join("");
  }
  function Xp(e, t, n, r) {
...
`;
  ...
  function Zp(e, t) {
    const n = [];
    let r = 0, i = 0, u;
    for (; u = Jp.exec(e); ) s(e.slice(r, u.index)), n.push(u[0]), r = u.index + u[0].length, i++;
  ...
  function ed(e, t, n) {
    ...
    for (a = -1; ++a < i.length; ) {
      const h = i[a];
      h < o || h >= l || h + 1 < l && i[a + 1] === h + 1 && s[h].after && !s[h + 1].before && !s[h + 1].after || i[a - 1] === h - 1 && s[h].before && !s[h - 1].before && !s[h - 1].after || (o !== h && u.push(Hu(r.slice(o, h), "\\")), o = h, /[!-/:-@[-`{-~]/.test(r.charAt(h)) && (!n.encode || !n.encode.includes(r.charAt(h))) ? u.push("\\") : (u.push(Ge(r.charCodeAt(h))), o++));
    }
    return u.push(Hu(r.slice(o, l), n.after)), u.join("");
  }
  function td(e, t) {
    return e - t;
  }
  ...
  function rd(e, t) {
    ...
    La(r, n), r.options.tightDefinitions && r.join.push(sd), r.handle = li("type", {
      invalid: id,
      unknown: ud,
      handlers: r.handlers
    });
...
`), i;
  ...
  function _r(e, t) {
    ...
    for (u--; ++u <= e.length; ) if (p === 10 && (f = (l ? l[s] : 0) || 1), p = e.charCodeAt(u), p === 38) {
      ...
      let k = "", Y = "", w = "";
      const $ = v === "named" ? zu : v === "decimal" ? $a : ld;
      for (B--; ++B <= e.length; ) {
        const V = e.charCodeAt(B);
        if (!$(V)) break;
        w += String.fromCharCode(V), v === "named" && Gc.includes(w) && (k = w, Y = nn(w));
      }
      ...
      if (!(!I && n.nonTerminated === false)) if (!w) v !== "named" && m(4, M);
        ...
        if (pd(V)) m(7, M), z = "\uFFFD";
        else if (V in vu) m(6, M), z = vu[V];
        else {
          let X = "";
          dd(V) && m(6, M), V > 65535 && (V -= 65536, X += String.fromCharCode(V >>> 10 | 55296), V = 56320 | V & 1023), z = X + String.fromCharCode(V);
        }
      }
      if (z) {
    ...
    function m(C, x) {
      let S;
      n.warning && (S = E(), S.column += x, S.offset += x, n.warning.call(n.warningContext || void 0, hd[C], S, C));
    }
    function D() {
  ...
  const Mn = "---", md = "```yaml [props]", Ed = `
`, gd = "\r";
  function ja(e, t) {
    if (!e || !Object.keys(e).length) return "";
    if ((t == null ? void 0 : t.preserveOrder) && e.__order__) {
      const n = new Nt();
      return n.contents = Qr(e.__order__), String(n).trim();
    }
    return Reflect.deleteProperty(e, "__order__"), e = Ii(e || {}, {}), [
...
`;
  ...
  function Ka(e, t) {
    let n = {};
    if (e.startsWith(Mn)) {
      const r = e.indexOf(Ed + Mn);
      if (r !== -1) {
        const i = e[r - 1] === gd, u = e.slice(4, r - (i ? 1 : 0));
        if (u) {
          const s = fp(u, t);
          n = s.toJSON(), (t == null ? void 0 : t.preserveOrder) && (n.__order__ = Gr(s.contents)), e = e.slice(r + 4 + (i ? 1 : 0));
        }
      }
    }
    return {
  ...
  function Qr(e) {
    if (e.type === "map") {
      const t = new ut();
      for (const [n, r] of e.value) t.items.push(new tn(new ae(n), Qr(r)));
      return t;
    }
    if (e.type === "seq") {
      const t = new Tt();
      for (const n of e.value) t.items.push(Qr(n));
      return t;
    }
  ...
  function Td(e, t, n = {}) {
    const r = t.indexStack, i = e.children || [], u = Un(n), s = [];
    let a = -1;
    for (r.push(-1); ++a < i.length; ) {
      const o = i[a];
      r[r.length - 1] = a, s.push(u.move(t.handle(o, e, t, {
...
`;
  ...
  function Cd(e, t, n) {
    ...
    for (; ++s < i.length; ) {
      ...
      u.length > 0 && (a === "\r" || a === `
`) && l.type === "html" && (u[u.length - 1] = u[u.length - 1].replace(/(\r?\n|\r)$/, " "), a = " ", o = Un(n), o.move(u.join(""))), u.push(o.move(t.handle(l, e, t, {
        ...o.current(),
        before: a,
        after: h
  ...
  const Id = (e = {}) => {
    const t = (p, E) => {
      if (!Wa.has(p.type)) return;
      const m = (C) => [
        "paragraph"
      ].includes(C) || Dd.has(C), D = p.children.filter((C) => !m(C.type));
      ...
      return `
` + (((_a2 = e == null ? void 0 : e.attributes) == null ? void 0 : _a2.yamlCodeBlock) ? bd(m).trim() : Va(m).trim());
    }, r = (p) => {
...
`))), s -= 1, C(), x;
    ...
    function o(p, E) {
      ...
      const D = E.enter("label"), C = E.enter(p.type + "Label"), x = Cd(m, E, {
        before: "[",
        after: "]"
      });
      return C(), D(), x ? "[" + x + "]" : "";
    ...
    function h(p, E) {
      var _a2, _b2;
      const m = _d(E), D = p.type === "textComponent" ? [
        m
      ] : [
        m,
        `
`,
      ...
      for (const $ of x) {
        const I = $[0];
        let M = $[1];
        if ($[1] != null) if (M = String($[1]), I === "id") B = Yu.test(M) ? "#" + M : w("id", M);
        else if (I === "class" || I === "className") {
          for (M = Array.isArray(x[I]) ? x[I].join(" ") : M, M = M.split(/[\t\n\r ]+/g).filter(Boolean), v = [], k = [], Y = -1; ++Y < M.length; ) (Yu.test(M[Y]) ? k : v).push(M[Y]);
    ...
    function f(p, E) {
      ...
      let D = p.type === "textComponent" ? Td(m, E) : Ad(m, E);
      return D.includes("&#x") && (D = yd(D)), D;
    }
    function d(p) {
...
`,
      ...
      handlers: {
        ...
        inlineCode: (p, E, m) => (m.compilePattern = m.compilePattern || qu, He.inlineCode(p, E, m) + h(p, m)),
    ...
    function M(O) {
      ...
      y[1] = (typeof y[1] == "string" ? y[1] : "") + _r(this.sliceSerialize(O));
    }
    function z(O) {
      this.data.componentAttributes.push([
  ...
  function Rd(e, t, n) {
    ...
    function i(o) {
      ...
      return r.previous === R.EOF && r._gfmTasklistFirstContentOfListItem ? e.check(Od, n, u)(o) : r.previous === R.openingSquareBracket ? n(o) : e.check(wd, n, u)(o);
    }
    function u(o) {
      return e.enter("textSpan"), e.attempt(Fd, s, n)(o);
    }
    function s(o) {
  ...
  function Bd(e, t, n) {
    return xi(e, t, n, "componentTextLabel", "componentTextLabelMarker", "componentTextLabelString");
  }
  const Pd = {
    tokenize: Rd
  };
  ...
  function Li(e, t, n, r, i, u, s, a, o, l, h, f, d, p, E) {
    let m, D, C = false;
    return x;
    function x(y) {
  ...
  function Kd(e, t, n) {
    ...
    function i(l) {
      ...
      if (!Qa.call(r, r.previous)) throw new Error("expected correct previous");
      return e.enter("componentText"), e.enter("componentTextMarker"), e.consume(l), e.exit("componentTextMarker"), Ga.call(r, e, u, n, "componentTextName");
    }
    function u(l) {
      return l === R.colon ? n(l) : l === R.openingSquareBracket ? e.attempt(ju, a, a)(l) : l === R.openingCurlyBracket ? e.attempt(Vu, s, s)(l) : o(l);
    }
    function s(l) {
      return l === R.openingSquareBracket ? e.attempt(ju, a, a)(l) : o(l);
    }
    function a(l) {
      return l === R.openingCurlyBracket ? e.attempt(Vu, o, o)(l) : o(l);
    }
    function o(l) {
  ...
  function Qd(e, t) {
    ...
    return !n || n[1].type !== t ? 0 : Ja(n[2].sliceStream(n[1]));
  }
  function Xr(e) {
    let t = 0, n = e.length - 1, r = e[n];
    for (; n >= 0 && r && r[1].type === "linePrefix" && r[0] === "exit"; ) t += Ja(r[2].sliceStream(r[1])), n -= 1, r = e[n];
    return t;
  }
  const Xd = (e) => {
    const t = {
  ...
  function em(e, t, n, r, i) {
    ...
    function s(f, d, p) {
      ...
      function x(B) {
        return Q(B) ? (f.enter("space"), C(B)) : (D === 0 && (D = Xr(E.events)), f.enter("componentContainerSectionSequence"), S(B));
      }
      function S(B) {
        return B === R.dash || Q(B) ? (f.consume(B), m++, S) : m < xd || D !== i || !K(B) ? p(B) : (f.exit("componentContainerSectionSequence"), W(f, d, "whitespace")(B));
      }
    }
    function a(f) {
  ...
  function nm(e, t, n) {
    const r = this, i = Xr(this.events);
    let u = 0, s;
    const a = [];
    let o = true, l = false, h = 0, f = false;
    const d = Xd("componentContainerSection");
    return p;
    function p(L) {
      if (L !== R.colon) throw new Error("expected `:`");
    ...
    function E(L, O, j) {
      ...
      return le;
      function le(oe) {
        return _ = Xr(r.events), ie = d.exit(L), L.enter("componentContainerSectionSequence"), A(oe);
      }
      function A(oe) {
        return oe === $u ? (L.consume(oe), y++, A) : y !== Ld || _ !== i || !de(oe) ? (ie(), j(oe)) : (L.exit("componentContainerSectionSequence"), W(L, O, "whitespace")(oe));
      }
    }
    function m(L) {
    ...
    function D(L) {
      return L === R.openingCurlyBracket ? e.check(Dr, (O) => (e.exit("componentContainerSectionTitle"), e.attempt(Dr, W(e, I, "linePrefix", 4), n)(O)), (O) => (e.consume(O), D))(L) : K(L) ? (e.exit("componentContainerSectionTitle"), W(e, I, "linePrefix", 4)(L)) : (e.consume(L), D);
    }
    function C(L) {
      return L === R.colon ? (e.consume(L), u++, C) : u < Sd ? n(L) : (e.exit("componentContainerSequence"), Ga.call(r, e, x, n, "componentContainerName")(L));
    }
    function x(L) {
      return L === R.openingSquareBracket ? e.attempt(tm, S, S)(L) : S(L);
    }
    function S(L) {
      return L === R.openingCurlyBracket ? e.attempt(Dr, B, B)(L) : B(L);
    }
    function B(L) {
    ...
    function k(L) {
      return L === null ? (e.exit("componentContainer"), t(L)) : o && (L === R.dash || Q(L)) ? (o = false, em(e, t, n, k, i)(L)) : (e.enter("componentContainerContent"), I(L));
    }
    function Y(L) {
      return L === null ? V(L) : L === R.backTick ? e.check(Jd, (O) => (f = !f, M(O)), M)(L) : f ? M(L) : !a.length && (L === $u || L === R.space) ? e.attempt({
        tokenize: E,
        partial: true
  ...
  function rm(e, t, n) {
    return xi(e, t, n, "componentContainerLabel", "componentContainerLabelMarker", "componentContainerLabelString", true);
  }
  function im(e, t, n) {
    return Li(e, t, n, "componentContainerAttributes", "componentContainerAttributesMarker", "componentContainerAttribute", "componentContainerAttributeId", "componentContainerAttributeClass", "componentContainerAttributeName", "componentContainerAttributeInitializerMarker", "componentContainerAttributeValueLiteral", "componentContainerAttributeValue", "componentContainerAttributeValueMarker", "componentContainerAttributeValueData", true);
  }
  const Za = {
    tokenize: nm,
    concrete: true
  ...
  function um(e, t, n) {
    ...
    function i(u) {
      if (Qd(r.events, "linePrefix") < 4) return n(u);
      switch (u) {
        case R.backTick:
          return jr.tokenize.call(r, e, t, n)(u);
        case R.colon:
          return Za.tokenize.call(r, e, t, n)(u);
        default:
          return n(u);
      }
    }
  ...
  function sm(e, t, n) {
    const r = this, i = Xa.tokenize.call(r, e, W(e, s, "linePrefix"), n);
...
---`;
  ...
  function Ku(e, t) {
    ...
    e.fmAttributes = lm(e, t), n.hName = en(e.name), n.hProperties = fm({
      ...e.attributes,
      ...e.fmAttributes
    });
  }
  function lm(e, t) {
    if (e.rawData) {
      const n = e.rawData.replace(/\s-+$/, ""), { data: r } = Ka(cm(n), t);
      return r;
    }
    return {};
  }
  ...
  pm = function(e, t, n) {
    const i = yt((n || {}).ignore || []), u = dm(t);
    let s = -1;
    for (; ++s < u.length; ) Gn(e, "text", a);
    function a(l, h) {
      let f = -1, d;
      for (; ++f < h.length; ) {
  ...
  function gm() {
    return {
      ...
      exit: {
        literalAutolink: Dm,
        literalAutolinkEmail: _m,
        literalAutolinkHttp: Am,
        literalAutolinkWww: Cm
      }
    };
  }
  function bm() {
  ...
  function km(e, t, n, r, i) {
    let u = "";
    if (!to(i) || (/^w/i.test(t) && (n = t + n, t = "", u = "http://"), !Nm(n))) return false;
    const s = Sm(n + r);
    if (!s[0]) return false;
    const a = {
      type: "link",
  ...
  function Im(e, t, n, r) {
    return !to(r, true) || /[-\d_]$/.test(n) ? false : {
      type: "link",
      title: null,
      url: "mailto:" + t + "@" + n,
      children: [
  ...
  function to(e, t) {
    ...
    return (e.index === 0 || at(n) || $n(n)) && (!t || n !== 47);
  }
  no.peek = Mm;
  function xm() {
    this.buffer();
...
` : " ") + u.indentLines(u.containerFlow(r, a.current()), t ? ro : vm))), l(), o;
    }
  }
  function vm(e, t, n) {
    return t === 0 ? e : ro(e, t, n);
  }
  function ro(e, t, n) {
    return (n ? "" : "    ") + e;
  }
  ...
  function Wm(e, t) {
    const n = t || {}, r = (n.align || []).concat(), i = n.stringLength || Km, u = [], s = [], a = [], o = [];
    let l = 0, h = -1;
    for (; ++h < e.length; ) {
      const m = [], D = [];
      let C = -1;
    ...
    let f = -1;
    if (typeof r == "object" && "length" in r) for (; ++f < l; ) u[f] = Gu(r[f]);
    else {
      const m = Gu(r);
      for (; ++f < l; ) u[f] = m;
    }
...
`);
  ...
  function e1(e) {
    let t = this.resume();
    this.data.inTable && (t = t.replace(/\\([\\|])/g, t1));
...
`));
  ...
  function r1() {
    return {
      exit: {
        taskListCheckValueChecked: Xu,
        taskListCheckValueUnchecked: Xu,
        paragraph: u1
      }
    };
  }
  ...
  function h1(e, t, n) {
    ...
    return s;
    function s(f) {
      return !Jr(f) || !ho.call(r, r.previous) || Fi(r.events) ? n(f) : (e.enter("literalAutolink"), e.enter("literalAutolinkEmail"), a(f));
    }
    function a(f) {
      return Jr(f) ? (e.consume(f), a) : f === 64 ? (e.consume(f), o) : n(f);
    }
    function o(f) {
      return f === 46 ? e.check(l1, h, l)(f) : f === 45 || f === 95 || he(f) ? (u = true, e.consume(f), o) : h(f);
    }
    function l(f) {
  ...
  function p1(e, t, n) {
    ...
    return i;
    function i(s) {
      return s !== 87 && s !== 119 || !lo.call(r, r.previous) || Fi(r.events) ? n(s) : (e.enter("literalAutolink"), e.enter("literalAutolinkWww"), e.check(c1, e.attempt(uo, e.attempt(so, u), n), n)(s));
    }
    function u(s) {
  ...
  function d1(e, t, n) {
    ...
    return s;
    function s(f) {
      return (f === 72 || f === 104) && fo.call(r, r.previous) && !Fi(r.events) ? (e.enter("literalAutolink"), e.enter("literalAutolinkHttp"), i += String.fromCodePoint(f), e.consume(f), a) : n(f);
    }
    function a(f) {
    ...
    function l(f) {
      return f === null || On(f) || ne(f) || at(f) || $n(f) ? n(f) : e.attempt(uo, e.attempt(so, h), n)(f);
    }
    function h(f) {
  ...
  function E1(e, t, n) {
    ...
    return s;
    function s(l) {
      return l === 46 || l === 95 ? e.check(ao, o, a)(l) : l === null || ne(l) || at(l) || l !== 45 && $n(l) ? o(l) : (u = true, e.consume(l), s);
    }
    function a(l) {
  ...
  function g1(e, t) {
    ...
    return i;
    function i(s) {
      return s === 40 ? (n++, e.consume(s), i) : s === 41 && r < n ? u(s) : s === 33 || s === 34 || s === 38 || s === 39 || s === 41 || s === 42 || s === 44 || s === 46 || s === 58 || s === 59 || s === 60 || s === 63 || s === 93 || s === 95 || s === 126 ? e.check(ao, t, u)(s) : s === null || ne(s) || at(s) ? t(s) : (e.consume(s), i);
    }
    function u(s) {
  ...
  function I1(e, t, n) {
    return e.check(on, t, e.attempt(A1, t, n));
  }
  function N1(e) {
    ...
    function i(s, a) {
      ...
      for (; ++o < s.length; ) if (s[o][0] === "enter" && s[o][1].type === "strikethroughSequenceTemporary" && s[o][1]._close) {
        ...
        for (; l--; ) if (s[l][0] === "exit" && s[l][1].type === "strikethroughSequenceTemporary" && s[l][1]._open && s[o][1].end.offset - s[o][1].start.offset === s[l][1].end.offset - s[l][1].start.offset) {
          ...
          p && _e(d, d.length, 0, jn(p, s.slice(l + 1, o), a)), _e(d, d.length, 0, [
            [
              "exit",
              f,
              a
          ...
          ]), _e(s, l - 1, o - l + 3, d), o = l + d.length - 2;
          break;
        }
      }
  ...
  function B1(e, t) {
    ...
    for (; ++n < e.length; ) {
      const p = e[n], E = p[1];
      p[0] === "enter" ? E.type === "tableHead" ? (a = false, o !== 0 && (Ju(d, t, o, l, h), h = void 0, o = 0), l = {
        type: "table",
    ...
    for (o !== 0 && Ju(d, t, o, l, h), d.consume(t.events), n = -1; ++n < t.events.length; ) {
      const p = t.events[n];
      p[0] === "enter" && p[1].type === "table" && (p[1]._align = O1(t.events, n));
    }
    return e;
  }
  ...
  const z1 = {};
  function po(e) {
    const t = this, n = e || z1, r = t.data(), i = r.micromarkExtensions || (r.micromarkExtensions = []), u = r.fromMarkdownExtensions || (r.fromMarkdownExtensions = []), s = r.toMarkdownExtensions || (r.toMarkdownExtensions = []);
    i.push(v1(n)), u.push(a1()), s.push(o1(n));
  }
  const tr = (function(e, t, n, r, i) {
    const u = Ie(t);
    return mo(e) ? u.call(i, e, n, r) : false;
  }), Ie = (function(e) {
    if (e == null) return $1;
    if (typeof e == "string") return q1(e);
    if (typeof e == "object") return Y1(e);
    if (typeof e == "function") return Oi(e);
  ...
  function Oi(e) {
    return t;
    function t(n, r, i) {
      return !!(mo(n) && e.call(this, n, typeof r == "number" ? r : void 0, i || void 0));
    }
  }
  function $1(e) {
  ...
  const j1 = /^[a-zA-Z][a-zA-Z\d+\-.]*?:/, V1 = /^[a-zA-Z]:\\/;
  function K1(e) {
    if (typeof e != "string") throw new TypeError(`Expected a \`string\`, got \`${typeof e}\``);
    return V1.test(e) ? false : j1.test(e);
  }
  function ke(e, t, n, r) {
    let i, u, s;
    typeof t == "function" && typeof n != "function" ? (u = void 0, s = t, i = n) : (u = t, s = n, i = r), Gn(e, u, a, i);
  ...
  function X1(e) {
    const t = e || Q1, n = t.protocols || W1, r = Ie(t.test);
    return function(i) {
      ke(i, "element", function(u, s, a) {
        if (u.tagName === "a" && typeof u.properties.href == "string" && r(u, s, a)) {
          const o = u.properties.href;
          if (K1(o) ? n.includes(o.slice(0, o.indexOf(":"))) : o.startsWith("//")) {
            const l = Mt(t.content, u), h = l && !Array.isArray(l) ? [
              l
            ] : l, f = Mt(t.rel, u) || G1, d = typeof f == "string" ? Hr(f) : f, p = Mt(t.target, u), E = Mt(t.properties, u);
    ...
    return function(e) {
      ...
      function i() {
        ...
        for (const [a, o] of t) u.set(a, [
          ...
          return h[1] - l[1] || Eo(String(l[0]), String(h[0]), 0);
        }).map(function(l) {
          return l[0];
        }));
        let s = -1;
    ...
    return function(e) {
      ...
      function r() {
        ...
        for (const [u, s] of t.entries()) i.set(u, [
          ...
          return o[1] - a[1] || go(String(a[0]), String(o[0]), 0);
        }).map(function(a) {
          return a[0];
        }));
        return i;
  ...
  function go(e, t, n) {
    return (e.charCodeAt(n) || 0) - (t.charCodeAt(n) || 0) || go(e, t, n + 1);
  }
  const es = /[#.]/g;
  function eE(e, t) {
    const n = e || "", r = {};
    ...
    for (; i < n.length; ) {
      es.lastIndex = i;
      const a = es.exec(n), o = n.slice(i, a ? a.index : n.length);
  ...
  function bo(e, t, n) {
    ...
    function i(u, s, ...a) {
      ...
      if (u == null) {
        ...
        if (o.tagName = h || l, tE(s)) a.unshift(s);
        else for (const [f, d] of Object.entries(s)) nE(e, o.properties, f, d);
      }
      for (const l of a) Zr(o.children, l);
  ...
  function nE(e, t, n, r) {
    ...
    if (r != null) {
      if (typeof r == "number") {
        ...
        u = r;
      } else typeof r == "boolean" ? u = r : typeof r == "string" ? i.spaceSeparated ? u = Hr(r) : i.commaSeparated ? u = eu(r) : i.commaOrSpaceSeparated ? u = Hr(eu(r).join(" ")) : u = ts(i, i.property, r) : Array.isArray(r) ? u = [
        ...r
      ] : u = i.property === "style" ? rE(r) : String(r);
      if (Array.isArray(u)) {
        const s = [];
        for (const a of u) s.push(ts(i, i.property, a));
        u = s;
      }
  ...
  function Zr(e, t) {
    ...
    else if (Array.isArray(t)) for (const n of t) Zr(e, n);
    else if (typeof t == "object" && "type" in t) t.type === "root" ? Zr(e, t.children) : e.push(t);
    else throw new Error("Expected node, nodes, or string, got `" + t + "`");
  }
  function ts(e, t, n) {
    if (typeof n == "string") {
      if (e.number && n && !Number.isNaN(Number(n))) return Number(n);
      if ((e.boolean || e.overloadedBoolean) && (n === "" || tu(n) === tu(t))) return true;
    }
    return n;
  }
  function rE(e) {
  ...
  function oE(e) {
    ...
    function i(u) {
      if (u && typeof u.line == "number" && typeof u.column == "number" && !Number.isNaN(u.line) && !Number.isNaN(u.column)) {
        for (; n.length < u.line; ) {
          const a = n[n.length - 1], o = ns(t, a), l = o === -1 ? t.length + 1 : o + 1;
          if (a === l) break;
          n.push(l);
        }
...
`, t);
  ...
  function wi(e, t) {
    ...
    switch (t.nodeName) {
      ...
      case "#document-fragment": {
        ...
        if (n = {
          type: "root",
          children: Ao(e, t.childNodes),
          data: {
            quirksMode: i
          }
        }, e.file && e.location) {
          const u = String(e.file), s = oE(u), a = s.toPoint(0), o = s.toPoint(u.length);
          n.position = {
            start: a,
            end: o
          };
  ...
  function fE(e, t) {
    const n = e.schema;
    e.schema = t.namespaceURI === rt.svg ? sn : Yn;
    let r = -1;
    const i = {};
    for (; ++r < t.attrs.length; ) {
      const a = t.attrs[r], o = (a.prefix ? a.prefix + ":" : "") + a.name;
      To.call(cE, o) || (i[o] = a.value);
    }
    const s = (e.schema.space === "svg" ? aE : sE)(t.tagName, i, Ao(e, t.childNodes));
    if (Sn(e, t, s), s.tagName === "template") {
      const a = t, o = a.sourceCodeLocation, l = o && o.startTag && gt(o.startTag), h = o && o.endTag && gt(o.endTag), f = wi(e, a.content);
  ...
  function Sn(e, t, n) {
    if ("sourceCodeLocation" in t && t.sourceCodeLocation && e.file) {
      const r = hE(e, n, t.sourceCodeLocation);
  ...
  function hE(e, t, n) {
    ...
    if (t.type === "element") {
      ...
      if (r && !n.endTag && i && i.position && i.position.end && (r.end = Object.assign({}, i.position.end)), e.verbose) {
        const u = {};
        let s;
        if (n.attrs) for (s in n.attrs) To.call(n.attrs, s) && (u[fi(e.schema, s).property] = gt(n.attrs[s]));
        n.startTag;
  ...
  const pE = {}, dE = {}.hasOwnProperty, Co = li("type", {
    handlers: {
      root: EE,
      element: CE,
      text: TE,
  ...
  function EE(e, t) {
    ...
    return n.childNodes = Ri(e.children, n, t), St(e, n), n;
  }
  function gE(e, t) {
    const n = {
  ...
  function CE(e, t) {
    ...
    let u;
    if (e.properties) {
      for (u in e.properties) if (u !== "children" && dE.call(e.properties, u)) {
        const o = _E(r, u, e.properties[u]);
        o && i.push(o);
      }
    }
    const s = r.space, a = {
    ...
    return a.childNodes = Ri(e.children, a, r), St(e, a), e.tagName === "template" && e.content && (a.content = gE(e.content, r)), a;
  }
  function _E(e, t, n) {
    const r = fi(e, t);
    if (n === false || n === null || n === void 0 || typeof n == "number" && Number.isNaN(n) || !n && r.boolean) return;
    Array.isArray(n) && (n = r.commaSeparated ? Xc(n) : Jc(n));
    const i = {
      name: r.attribute,
  ...
  function yo(e) {
    return e >= 64976 && e <= 65007 || DE.has(e);
  }
  var F;
  (function(e) {
  ...
  class NE {
    constructor(t) {
      this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = false, this.lastChunkWritten = false, this.endOfChunkHit = false, this.bufferWaterline = IE, this.isEol = false, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
    }
    get col() {
    ...
    _processSurrogate(t) {
      if (this.pos !== this.html.length - 1) {
        ...
        if (yE(n)) return this.pos++, this._addGap(), kE(t, n);
    ...
    advance() {
      ...
      return t === g.CARRIAGE_RETURN ? (this.isEol = true, this.skipNextNewLine = true, g.LINE_FEED) : t === g.LINE_FEED && (this.isEol = true, this.skipNextNewLine) ? (this.line--, this.skipNextNewLine = false, this._addGap(), this.advance()) : (this.skipNextNewLine = false, _o(t) && (t = this._processSurrogate(t)), this.handler.onParseError === null || t > 31 && t < 127 || t === g.LINE_FEED || t === g.CARRIAGE_RETURN || t > 159 && t < 64976 || this._checkForProblematicCharacters(t), t);
    }
    _checkForProblematicCharacters(t) {
      Do(t) ? this._err(F.controlCharacterInInputStream) : yo(t) && this._err(F.noncharacterInInputStream);
    }
    retreat(t) {
  ...
  function wE(e) {
    return e >= me.UPPER_A && e <= me.UPPER_Z || e >= me.LOWER_A && e <= me.LOWER_Z || ei(e);
  }
  function RE(e) {
    return e === me.EQUALS || wE(e);
  }
  var pe;
  (function(e) {
  ...
  class BE {
    ...
    stateNumericStart(t, n) {
      return n >= t.length ? -1 : (t.charCodeAt(n) | FE) === me.LOWER_X ? (this.state = pe.NumericHex, this.consumed += 1, this.stateNumericHex(t, n + 1)) : (this.state = pe.NumericDecimal, this.stateNumericDecimal(t, n));
    }
    ...
    emitNumericEntity(t, n) {
      ...
      return this.emitCodePoint(LE(this.result), this.consumed), this.errors && (t !== me.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
    }
    stateNamedEntity(t, n) {
      ...
      for (; n < t.length; n++, this.excess++) {
        ...
        if (this.treeIndex = PE(r, i, this.treeIndex + Math.max(1, u), s), this.treeIndex < 0) return this.result === 0 || this.decodeMode === ve.Attribute && (u === 0 || RE(s)) ? 0 : this.emitNotTerminatedNamedEntity();
  ...
  function xt(e) {
    var t;
    return (t = ME.get(e)) !== null && t !== void 0 ? t : c.UNKNOWN;
  }
  const H = c, UE = {
  ...
  function us(e) {
    return Io(e) || e === g.SOLIDUS || e === g.GREATER_THAN_SIGN;
  }
  function zE(e) {
    return e === g.NULL ? F.nullCharacterReference : e > 1114111 ? F.characterReferenceOutsideUnicodeRange : _o(e) ? F.surrogateCharacterReference : yo(e) ? F.noncharacterCharacterReference : Do(e) || e === g.CARRIAGE_RETURN ? F.controlCharacterReference : null;
  }
  class YE {
    constructor(t, n) {
      this.options = t, this.handler = n, this.paused = false, this.inLoop = false, this.inForeignNode = false, this.lastStartTagName = "", this.active = false, this.state = b.DATA, this.returnState = b.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = {
        name: "",
        value: ""
      }, this.preprocessor = new NE(n), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new BE(SE, (r, i) => {
    ...
    _leaveAttrName() {
      ...
      if (ko(r, this.currentAttr.name) === null) {
    ...
    _emitCodePoint(t) {
      const n = Io(t) ? te.WHITESPACE_CHARACTER : t === g.NULL ? te.NULL_CHARACTER : te.CHARACTER;
    ...
    _stateScriptDataDoubleEscapeStart(t) {
      if (this.preprocessor.startsWith(be.SCRIPT, false) && us(this.preprocessor.peek(be.SCRIPT.length))) {
        this._emitCodePoint(t);
        for (let n = 0; n < be.SCRIPT.length; n++) this._emitCodePoint(this._consume());
    ...
    _stateMarkupDeclarationOpen(t) {
      this._consumeSequenceIfMatch(be.DASH_DASH, true) ? (this._createCommentToken(be.DASH_DASH.length + 1), this.state = b.COMMENT_START) : this._consumeSequenceIfMatch(be.DOCTYPE, false) ? (this.currentLocation = this.getCurrentLocation(be.DOCTYPE.length + 1), this.state = b.DOCTYPE) : this._consumeSequenceIfMatch(be.CDATA_START, true) ? this.inForeignNode ? this.state = b.CDATA_SECTION : (this._err(F.cdataInHtmlContent), this._createCommentToken(be.CDATA_START.length + 1), this.currentToken.data = "[CDATA[", this.state = b.BOGUS_COMMENT) : this._ensureHibernation() || (this._err(F.incorrectlyOpenedComment), this._createCommentToken(2), this.state = b.BOGUS_COMMENT, this._stateBogusComment(t));
    }
    ...
    _stateAfterDoctypeName(t) {
      ...
      switch (t) {
        ...
        default:
          this._consumeSequenceIfMatch(be.PUBLIC, false) ? this.state = b.AFTER_DOCTYPE_PUBLIC_KEYWORD : this._consumeSequenceIfMatch(be.SYSTEM, false) ? this.state = b.AFTER_DOCTYPE_SYSTEM_KEYWORD : this._ensureHibernation() || (this._err(F.invalidCharacterSequenceAfterDoctypeName), n.forceQuirks = true, this.state = b.BOGUS_DOCTYPE, this._stateBogusDoctype(t));
      }
    }
    ...
    _stateCharacterReference() {
      ...
      t === 0 ? (this.preprocessor.pos = this.entityStartPos, this._flushCodePointConsumedAsCharacterReference(g.AMPERSAND), this.state = !this._isCharacterReferenceInAttribute() && is(this.preprocessor.peek(1)) ? b.AMBIGUOUS_AMPERSAND : this.returnState) : this.state = this.returnState;
    }
    _stateAmbiguousAmpersand(t) {
      is(t) ? this._flushCodePointConsumedAsCharacterReference(t) : (t === g.SEMICOLON && this._err(F.unknownNamedCharacterReference), this.state = this.returnState, this._callState(t));
    }
  }
  ...
  class GE {
    ...
    popUntilNumberedHeaderPopped() {
      this.popUntilPopped(ti, U.HTML);
    }
    popUntilTableCellPopped() {
      this.popUntilPopped(WE, U.HTML);
    }
    ...
    hasInScope(t) {
      return this.hasInDynamicScope(t, Hn);
    }
    hasInListItemScope(t) {
      return this.hasInDynamicScope(t, qE);
    }
    hasInButtonScope(t) {
      return this.hasInDynamicScope(t, $E);
    }
    hasNumberedHeaderInScope() {
      for (let t = this.stackTop; t >= 0; t--) {
        ...
        switch (this.treeAdapter.getNamespaceURI(this.items[t])) {
          case U.HTML: {
            if (ti.has(n)) return true;
            if (Hn.has(n)) return false;
            break;
          }
          case U.SVG: {
            if (os.has(n)) return false;
            break;
          }
          case U.MATHML: {
    ...
    generateImpliedEndTags() {
      for (; this.currentTagId !== void 0 && No.has(this.currentTagId); ) this.pop();
    }
    generateImpliedEndTagsThoroughly() {
      for (; this.currentTagId !== void 0 && ss.has(this.currentTagId); ) this.pop();
    }
    generateImpliedEndTagsWithExclusion(t) {
      for (; this.currentTagId !== void 0 && this.currentTagId !== t && ss.has(this.currentTagId); ) this.pop();
    }
  }
  const xr = 3;
  var we;
  ...
  class QE {
    ...
    _ensureNoahArkCondition(t) {
      ...
      for (let s = 0; s < r.length; s++) {
        const a = r[s];
        a.attrs.every((o) => i.get(o.name) === o.value) && (u += 1, u >= xr && this.entries.splice(a.idx, 1));
      }
    }
    insertMarker() {
      this.entries.unshift(cs);
    }
    pushElement(t, n) {
    ...
    clearToLastMarker() {
      const t = this.entries.indexOf(cs);
  ...
  }, So = "html", XE = "about:legacy-compat", JE = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", xo = [
  ...
  function ng(e) {
    return e.name === So && e.publicId === null && (e.systemId === null || e.systemId === XE);
  }
  function rg(e) {
    if (e.name !== So) return ye.QUIRKS;
    const { systemId: t } = e;
    if (t && t.toLowerCase() === JE) return ye.QUIRKS;
    let { publicId: n } = e;
    if (n !== null) {
      if (n = n.toLowerCase(), eg.has(n)) return ye.QUIRKS;
      let r = t === null ? ZE : xo;
      if (ls(n, r)) return ye.QUIRKS;
      if (r = t === null ? Lo : tg, ls(n, r)) return ye.LIMITED_QUIRKS;
    }
    return ye.NO_QUIRKS;
  }
  const fs = {
  ...
  }, ig = "definitionurl", ug = "definitionURL", sg = new Map([
    "attributeName",
    "attributeType",
    "baseFrequency",
    "baseProfile",
  ...
  function lg(e) {
    const t = e.tagID;
    return t === c.FONT && e.attrs.some(({ name: r }) => r === it.COLOR || r === it.SIZE || r === it.FACE) || cg.has(t);
  }
  function Fo(e) {
    for (let t = 0; t < e.attrs.length; t++) if (e.attrs[t].name === ig) {
      e.attrs[t].name = ug;
      break;
    }
  }
  ...
  function Bi(e) {
    for (let t = 0; t < e.attrs.length; t++) {
      const n = ag.get(e.attrs[t].name);
      n && (e.attrs[t].prefix = n.prefix, e.attrs[t].name = n.name, e.attrs[t].namespace = n.namespace);
    }
  }
  function fg(e) {
    const t = og.get(e.tagName);
  ...
  function pg(e, t, n) {
    if (t === U.MATHML && e === c.ANNOTATION_XML) {
      for (let r = 0; r < n.length; r++) if (n[r].name === it.ENCODING) {
        ...
        return i === fs.TEXT_HTML || i === fs.APPLICATION_XML;
      }
    }
    return t === U.SVG && (e === c.FOREIGN_OBJECT || e === c.DESC || e === c.TITLE);
  }
  function dg(e, t, n, r) {
    return (!r || r === U.HTML) && pg(e, t, n) || (!r || r === U.MATHML) && hg(e, t);
  }
  const mg = "hidden", Eg = 8, gg = 3;
  var T;
  (function(e) {
  ...
  class ps {
    constructor(t, n, r = null, i = null) {
      this.fragmentContext = r, this.scriptHandler = i, this.currentToken = null, this.stopped = false, this.insertionMode = T.INITIAL, this.originalInsertionMode = T.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = false, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = false, this.framesetOk = true, this.skipNextNewLine = false, this.fosterParentingEnabled = false, this.options = {
        ...hs,
        ...t
      }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = true), this.document = n ?? this.treeAdapter.createDocument(), this.tokenizer = new YE(this.options, this), this.activeFormattingElements = new QE(this.treeAdapter), this.fragmentContextID = r ? xt(this.treeAdapter.getTagName(r)) : c.UNKNOWN, this._setContextModes(r ?? this.document, this.fragmentContextID), this.openElements = new GE(this.document, this.treeAdapter, this);
    }
    static parse(t, n) {
      const r = new this(n);
    ...
    _err(t, n, r) {
      ...
      const u = (i = t.location) !== null && i !== void 0 ? i : bg, s = {
        code: n,
    ...
    _processStartTag(t) {
      this.shouldProcessStartTagTokenInForeignContent(t) ? Gb(this, t) : this._startTagOutsideForeignContent(t);
    }
    ...
    onEndTag(t) {
      this.skipNextNewLine = false, this.currentToken = t, this.currentNotInHTML ? Qb(this, t) : this._endTagOutsideForeignContent(t);
    }
  ...
  function Tg(e, t) {
    ...
    return n ? e.openElements.contains(n.element) ? e.openElements.hasInScope(t.tagID) || (n = null) : (e.activeFormattingElements.removeEntry(n), n = null) : Uo(e, t), n;
  }
  function Ag(e, t) {
  ...
  function Cg(e, t, n) {
    ...
    for (let u = 0, s = i; s !== n; u++, s = i) {
      ...
      const a = e.activeFormattingElements.getElementEntry(s), o = a && u >= gg;
      !a || o ? (o && e.activeFormattingElements.removeEntry(a), e.openElements.remove(s)) : (s = _g(e, a), r === t && (e.activeFormattingElements.bookmark = a), e.treeAdapter.detachNode(r), e.treeAdapter.appendChild(s, r), r = s);
    }
    return r;
  }
  function _g(e, t) {
  ...
  function Pi(e, t) {
    for (let n = 0; n < Eg; n++) {
      ...
      const u = Cg(e, i, r.element), s = e.openElements.getCommonAncestor(r.element);
      e.treeAdapter.detachNode(u), s && Dg(e, s, u), yg(e, i, r);
    }
  }
  function ni(e, t) {
  ...
  function Ng(e, t) {
    ...
    const n = t.forceQuirks ? ye.QUIRKS : rg(t);
    ng(t) || e._err(t, F.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, n), e.insertionMode = T.BEFORE_HTML;
  }
  function Ut(e, t) {
    e._err(t, F.missingDoctype, true), e.treeAdapter.setDocumentMode(e.document, ye.QUIRKS), e.insertionMode = T.BEFORE_HTML, e._processToken(t);
  }
  function Sg(e, t) {
  ...
  function Jt(e, t) {
    e._insertFakeElement(N.BODY, c.BODY), e.insertionMode = T.IN_BODY, nr(e, t);
  }
  function nr(e, t) {
    switch (t.type) {
      case te.CHARACTER: {
  ...
  function zg(e, t) {
    e.openElements.hasInButtonScope(c.P) && e._closePElement(), e.openElements.currentTagId !== void 0 && ti.has(e.openElements.currentTagId) && e.openElements.pop(), e._insertElement(t, U.HTML);
  }
  function Yg(e, t) {
  ...
  function Kg(e, t) {
    ...
    n && (Pi(e, t), e.openElements.remove(n.element), e.activeFormattingElements.removeEntry(n)), e._reconstructActiveFormattingElements(), e._insertElement(t, U.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
  }
  function Wg(e, t) {
  ...
  function Gg(e, t) {
    e._reconstructActiveFormattingElements(), e.openElements.hasInScope(c.NOBR) && (Pi(e, t), e._reconstructActiveFormattingElements()), e._insertElement(t, U.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
  }
  function Qg(e, t) {
  ...
  function Xg(e, t) {
    e.treeAdapter.getDocumentMode(e.document) !== ye.QUIRKS && e.openElements.hasInButtonScope(c.P) && e._closePElement(), e._insertElement(t, U.HTML), e.framesetOk = false, e.insertionMode = T.IN_TABLE;
  }
  function Po(e, t) {
    e._reconstructActiveFormattingElements(), e._appendElement(t, U.HTML), e.framesetOk = false, t.ackSelfClosing = true;
  }
  function Mo(e) {
    const t = ko(e, it.TYPE);
    return t != null && t.toLowerCase() === mg;
  }
  function Jg(e, t) {
    e._reconstructActiveFormattingElements(), e._appendElement(t, U.HTML), Mo(t) || (e.framesetOk = false), t.ackSelfClosing = true;
  }
  function Zg(e, t) {
    e._appendElement(t, U.HTML), t.ackSelfClosing = true;
  }
  ...
  function tb(e, t) {
    t.tagName = N.IMG, t.tagID = c.IMG, Po(e, t);
  }
  function nb(e, t) {
  ...
  function cb(e, t) {
    e._reconstructActiveFormattingElements(), Fo(t), Bi(t), t.selfClosing ? e._appendElement(t, U.MATHML) : e._insertElement(t, U.MATHML), t.ackSelfClosing = true;
  }
  function lb(e, t) {
    e._reconstructActiveFormattingElements(), Oo(t), Bi(t), t.selfClosing ? e._appendElement(t, U.SVG) : e._insertElement(t, U.SVG), t.ackSelfClosing = true;
  }
  function ms(e, t) {
  ...
  function ge(e, t) {
    switch (t.tagID) {
      ...
      case c.NOSCRIPT: {
        e.options.scriptingEnabled ? ds(e, t) : ms(e, t);
        break;
      }
      case c.PLAINTEXT: {
        jg(e, t);
  ...
  function hb(e, t) {
    e.openElements.hasInScope(c.BODY) && (e.insertionMode = T.AFTER_BODY, Ko(e, t));
  }
  function pb(e, t) {
    const n = t.tagID;
  ...
  function Ho(e, t) {
    e.tmplInsertionModeStack.length > 0 ? Vo(e, t) : Mi(e, t);
  }
  function Cb(e, t) {
    var n;
  ...
  function Lr(e, t) {
    if (e.openElements.currentTagId !== void 0 && wo.has(e.openElements.currentTagId)) switch (e.pendingCharacterTokens.length = 0, e.hasNonWhitespacePendingCharacterToken = false, e.originalInsertionMode = e.insertionMode, e.insertionMode = T.IN_TABLE_TEXT, t.type) {
      case te.CHARACTER: {
        zo(e, t);
        break;
      }
  ...
  function kb(e, t) {
    e.openElements.clearBackToTableContext(), e._insertFakeElement(N.COLGROUP, c.COLGROUP), e.insertionMode = T.IN_COLUMN_GROUP, Ui(e, t);
  }
  function Ib(e, t) {
    e.openElements.clearBackToTableContext(), e._insertElement(t, U.HTML), e.insertionMode = T.IN_TABLE_BODY;
  }
  function Nb(e, t) {
    e.openElements.clearBackToTableContext(), e._insertFakeElement(N.TBODY, c.TBODY), e.insertionMode = T.IN_TABLE_BODY, ir(e, t);
  }
  function Sb(e, t) {
  ...
  function xb(e, t) {
    Mo(t) ? e._appendElement(t, U.HTML) : fn(e, t), t.ackSelfClosing = true;
  }
  function Lb(e, t) {
  ...
  function fn(e, t) {
    ...
    e.fosterParentingEnabled = true, nr(e, t), e.fosterParentingEnabled = n;
  }
  function vo(e, t) {
  ...
  function Fb(e, t) {
    const n = t.tagID;
    Yo.has(n) ? e.openElements.hasInTableScope(c.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(c.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = T.IN_TABLE, Dt(e, t)) : ge(e, t);
  }
  function Ob(e, t) {
    const n = t.tagID;
    switch (n) {
  ...
  function ir(e, t) {
    switch (t.tagID) {
      ...
      case c.TH:
      case c.TD: {
        e.openElements.clearBackToTableBodyContext(), e._insertFakeElement(N.TR, c.TR), e.insertionMode = T.IN_ROW, ur(e, t);
        break;
      }
      case c.CAPTION:
      case c.COL:
  ...
  function ur(e, t) {
    switch (t.tagID) {
      ...
      case c.THEAD:
      case c.TR: {
        e.openElements.hasInTableScope(c.TR) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = T.IN_TABLE_BODY, ir(e, t));
        break;
      }
      default:
        Dt(e, t);
  ...
  function qo(e, t) {
    switch (t.tagID) {
      ...
      case c.TABLE: {
        e.openElements.hasInTableScope(c.TR) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = T.IN_TABLE_BODY, ri(e, t));
        break;
      }
      case c.TBODY:
      case c.TFOOT:
      case c.THEAD: {
        (e.openElements.hasInTableScope(t.tagID) || e.openElements.hasInTableScope(c.TR)) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = T.IN_TABLE_BODY, ri(e, t));
        break;
      }
      case c.BODY:
      case c.CAPTION:
  ...
  function Rb(e, t) {
    const n = t.tagID;
    Yo.has(n) ? (e.openElements.hasInTableScope(c.TD) || e.openElements.hasInTableScope(c.TH)) && (e._closeTableCell(), ur(e, t)) : ge(e, t);
  }
  function Bb(e, t) {
    const n = t.tagID;
    switch (n) {
      ...
      case c.THEAD:
      case c.TR: {
        e.openElements.hasInTableScope(n) && (e._closeTableCell(), qo(e, t));
        break;
      }
      case c.BODY:
      case c.CAPTION:
  ...
  function Pb(e, t) {
    const n = t.tagID;
    n === c.CAPTION || n === c.TABLE || n === c.TBODY || n === c.TFOOT || n === c.THEAD || n === c.TR || n === c.TD || n === c.TH ? (e.openElements.popUntilTagNamePopped(c.SELECT), e._resetInsertionMode(), e._processStartTag(t)) : $o(e, t);
  }
  function Mb(e, t) {
    const n = t.tagID;
    n === c.CAPTION || n === c.TABLE || n === c.TBODY || n === c.TFOOT || n === c.THEAD || n === c.TR || n === c.TD || n === c.TH ? e.openElements.hasInTableScope(n) && (e.openElements.popUntilTagNamePopped(c.SELECT), e._resetInsertionMode(), e.onEndTag(t)) : jo(e, t);
  }
  function Ub(e, t) {
    switch (t.tagID) {
      case c.BASE:
      ...
      case c.COL: {
        e.tmplInsertionModeStack[0] = T.IN_COLUMN_GROUP, e.insertionMode = T.IN_COLUMN_GROUP, Ui(e, t);
        break;
      }
      case c.TR: {
        e.tmplInsertionModeStack[0] = T.IN_TABLE_BODY, e.insertionMode = T.IN_TABLE_BODY, ir(e, t);
        break;
      }
      case c.TD:
      case c.TH: {
        e.tmplInsertionModeStack[0] = T.IN_ROW, e.insertionMode = T.IN_ROW, ur(e, t);
        break;
      }
      default:
        e.tmplInsertionModeStack[0] = T.IN_BODY, e.insertionMode = T.IN_BODY, ge(e, t);
    }
  }
  function Hb(e, t) {
  ...
  function Vo(e, t) {
    e.openElements.tmplCount > 0 ? (e.openElements.popUntilTagNamePopped(c.TEMPLATE), e.activeFormattingElements.clearToLastMarker(), e.tmplInsertionModeStack.shift(), e._resetInsertionMode(), e.onEof(t)) : Mi(e, t);
  }
  function vb(e, t) {
    t.tagID === c.HTML ? ge(e, t) : zn(e, t);
  }
  function Ko(e, t) {
    var n;
    if (t.tagID === c.HTML) {
  ...
  function zn(e, t) {
    e.insertionMode = T.IN_BODY, nr(e, t);
  }
  function zb(e, t) {
    switch (t.tagID) {
      case c.HTML: {
  ...
  function Gb(e, t) {
    if (lg(t)) Wo(e), e._startTagOutsideForeignContent(t);
    else {
      const n = e._getAdjustedCurrentElement(), r = e.treeAdapter.getNamespaceURI(n);
      r === U.MATHML ? Fo(t) : r === U.SVG && (fg(t), Oo(t)), Bi(t), t.selfClosing ? e._appendElement(t, r) : e._insertElement(t, r), t.ackSelfClosing = true;
    }
  }
  function Qb(e, t) {
    if (t.tagID === c.P || t.tagID === c.BR) {
      Wo(e), e._endTagOutsideForeignContent(t);
      return;
    }
  ...
  const Xb = /<(\/?)(iframe|noembed|noframes|plaintext|script|style|textarea|title|xmp)(?=[\t\n\f\r />])/gi, Jb = /* @__PURE__ */ new Set([
    "mdxFlowExpression",
    "mdxJsxFlowElement",
    "mdxJsxTextElement",
    "mdxTextExpression",
  ...
  function Go(e, t) {
    const n = oT(e), r = li("type", {
      ...
      parser: n ? new ps(Es) : ps.getFragmentParser(void 0, Es),
      handle(a) {
        r(a, i);
      },
      stitches: false,
    ...
    r(e, i), Lt(i, ze());
    const u = n ? i.parser.document : i.parser.getFragment(), s = lE(u, {
      file: i.options.file
    });
    return i.stitches && ke(s, "comment", function(a, o, l) {
      const h = a;
  ...
  function iT(e, t) {
    if (t.parser.tokenizer.preprocessor.html = "", t.parser.tokenizer.preprocessor.pos = -1, t.parser.tokenizer.preprocessor.lastGapPos = -2, t.parser.tokenizer.preprocessor.gapStack = [], t.parser.tokenizer.preprocessor.skipNextNewLine = false, t.parser.tokenizer.preprocessor.lastChunkWritten = false, t.parser.tokenizer.preprocessor.endOfChunkHit = false, t.parser.tokenizer.preprocessor.isEol = false, Jo(t, ze(e)), t.parser.tokenizer.write(t.options.tagfilter ? e.value.replace(Xb, "&lt;$1$2") : e.value, false), t.parser.tokenizer._runParsingLoop(), t.parser.tokenizer.state === 72 || t.parser.tokenizer.state === 78) {
  ...
  function uT(e, t) {
    const n = e;
    if (t.options.passThrough && t.options.passThrough.includes(n.type)) rT(n, t);
    else {
      let r = "";
      throw Jb.has(n.type) && (r = ". It looks like you are using MDX nodes with `hast-util-raw` (or `rehype-raw`). If you use this because you are using remark or rehype plugins that inject `'html'` nodes, then please raise an issue with that plugin, as its a bad and slow idea. If you use this because you are using markdown syntax, then you have to configure this utility (or plugin) to pass through these nodes (see `passThrough` in docs), but you can also migrate to use the MDX syntax"), new Error("Cannot compile `" + n.type + "` node" + r);
    }
  }
  function Lt(e, t) {
    Jo(e, t);
  ...
  function aT(e, t) {
    const n = e.tagName.toLowerCase();
    if (!t.parser.tokenizer.inForeignNode && Zc.includes(n) || t.parser.tokenizer.state === ce.PLAINTEXT) return;
    Lt(t, Vn(e));
    const r = {
      type: te.END_TAG,
      tagName: n,
  ...
  function hT(e, t = 4) {
    ...
    for (; i < e.length; ) {
      gs.lastIndex = i;
      const s = gs.exec(e), a = s ? s.index : e.length;
  ...
  function pT(e) {
    ...
    return (r == null ? void 0 : r[1]) && (u = r[1].replace(/\\([[\]{}().*+?^$|])/g, "$1")), {
      ...
      highlights: dT((n == null ? void 0 : n[1]) || void 0),
      filename: u,
      meta: i
    };
  }
  ...
  const mT = /^<\/?([\w-]+)(\s[^>]*?)?\/?>/;
  function Zo(e) {
    const t = String(e).match(mT);
    return t && t[1];
  }
  const ET = (e, t) => {
    const n = (t.lang || "") + " " + (t.meta || ""), { language: r = "text", highlights: i, filename: u, meta: s } = pT(n), a = t.value ? hT(t.value + `
`) : "";
    let o = {
      type: "element",
      tagName: "code",
  ...
  function AT(e, t) {
    if (t.children && t.children[0] && t.children[0].type === "html") {
      const r = en(Zo(t.children[0].value) || "div");
      if (!ol.has(r)) return e.all(t);
    }
    const n = {
      type: "element",
      tagName: "p",
  ...
  function tc(e) {
    return "children" in e ? nc(e) : "value" in e ? e.value : "";
  }
  function IT(e) {
    return e.type === "text" ? e.value : "children" in e ? nc(e) : "";
  }
  function nc(e) {
    let t = -1;
    const n = [];
    for (; ++t < e.children.length; ) n[t] = IT(e.children[t]);
    return n.join("");
  }
  const NT = /[\0-\x1F!-,\.\/:-@\[-\^`\{-\xA9\xAB-\xB4\xB6-\xB9\xBB-\xBF\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0378\u0379\u037E\u0380-\u0385\u0387\u038B\u038D\u03A2\u03F6\u0482\u0530\u0557\u0558\u055A-\u055F\u0589-\u0590\u05BE\u05C0\u05C3\u05C6\u05C8-\u05CF\u05EB-\u05EE\u05F3-\u060F\u061B-\u061F\u066A-\u066D\u06D4\u06DD\u06DE\u06E9\u06FD\u06FE\u0700-\u070F\u074B\u074C\u07B2-\u07BF\u07F6-\u07F9\u07FB\u07FC\u07FE\u07FF\u082E-\u083F\u085C-\u085F\u086B-\u089F\u08B5\u08C8-\u08D2\u08E2\u0964\u0965\u0970\u0984\u098D\u098E\u0991\u0992\u09A9\u09B1\u09B3-\u09B5\u09BA\u09BB\u09C5\u09C6\u09C9\u09CA\u09CF-\u09D6\u09D8-\u09DB\u09DE\u09E4\u09E5\u09F2-\u09FB\u09FD\u09FF\u0A00\u0A04\u0A0B-\u0A0E\u0A11\u0A12\u0A29\u0A31\u0A34\u0A37\u0A3A\u0A3B\u0A3D\u0A43-\u0A46\u0A49\u0A4A\u0A4E-\u0A50\u0A52-\u0A58\u0A5D\u0A5F-\u0A65\u0A76-\u0A80\u0A84\u0A8E\u0A92\u0AA9\u0AB1\u0AB4\u0ABA\u0ABB\u0AC6\u0ACA\u0ACE\u0ACF\u0AD1-\u0ADF\u0AE4\u0AE5\u0AF0-\u0AF8\u0B00\u0B04\u0B0D\u0B0E\u0B11\u0B12\u0B29\u0B31\u0B34\u0B3A\u0B3B\u0B45\u0B46\u0B49\u0B4A\u0B4E-\u0B54\u0B58-\u0B5B\u0B5E\u0B64\u0B65\u0B70\u0B72-\u0B81\u0B84\u0B8B-\u0B8D\u0B91\u0B96-\u0B98\u0B9B\u0B9D\u0BA0-\u0BA2\u0BA5-\u0BA7\u0BAB-\u0BAD\u0BBA-\u0BBD\u0BC3-\u0BC5\u0BC9\u0BCE\u0BCF\u0BD1-\u0BD6\u0BD8-\u0BE5\u0BF0-\u0BFF\u0C0D\u0C11\u0C29\u0C3A-\u0C3C\u0C45\u0C49\u0C4E-\u0C54\u0C57\u0C5B-\u0C5F\u0C64\u0C65\u0C70-\u0C7F\u0C84\u0C8D\u0C91\u0CA9\u0CB4\u0CBA\u0CBB\u0CC5\u0CC9\u0CCE-\u0CD4\u0CD7-\u0CDD\u0CDF\u0CE4\u0CE5\u0CF0\u0CF3-\u0CFF\u0D0D\u0D11\u0D45\u0D49\u0D4F-\u0D53\u0D58-\u0D5E\u0D64\u0D65\u0D70-\u0D79\u0D80\u0D84\u0D97-\u0D99\u0DB2\u0DBC\u0DBE\u0DBF\u0DC7-\u0DC9\u0DCB-\u0DCE\u0DD5\u0DD7\u0DE0-\u0DE5\u0DF0\u0DF1\u0DF4-\u0E00\u0E3B-\u0E3F\u0E4F\u0E5A-\u0E80\u0E83\u0E85\u0E8B\u0EA4\u0EA6\u0EBE\u0EBF\u0EC5\u0EC7\u0ECE\u0ECF\u0EDA\u0EDB\u0EE0-\u0EFF\u0F01-\u0F17\u0F1A-\u0F1F\u0F2A-\u0F34\u0F36\u0F38\u0F3A-\u0F3D\u0F48\u0F6D-\u0F70\u0F85\u0F98\u0FBD-\u0FC5\u0FC7-\u0FFF\u104A-\u104F\u109E\u109F\u10C6\u10C8-\u10CC\u10CE\u10CF\u10FB\u1249\u124E\u124F\u1257\u1259\u125E\u125F\u1289\u128E\u128F\u12B1\u12B6\u12B7\u12BF\u12C1\u12C6\u12C7\u12D7\u1311\u1316\u1317\u135B\u135C\u1360-\u137F\u1390-\u139F\u13F6\u13F7\u13FE-\u1400\u166D\u166E\u1680\u169B-\u169F\u16EB-\u16ED\u16F9-\u16FF\u170D\u1715-\u171F\u1735-\u173F\u1754-\u175F\u176D\u1771\u1774-\u177F\u17D4-\u17D6\u17D8-\u17DB\u17DE\u17DF\u17EA-\u180A\u180E\u180F\u181A-\u181F\u1879-\u187F\u18AB-\u18AF\u18F6-\u18FF\u191F\u192C-\u192F\u193C-\u1945\u196E\u196F\u1975-\u197F\u19AC-\u19AF\u19CA-\u19CF\u19DA-\u19FF\u1A1C-\u1A1F\u1A5F\u1A7D\u1A7E\u1A8A-\u1A8F\u1A9A-\u1AA6\u1AA8-\u1AAF\u1AC1-\u1AFF\u1B4C-\u1B4F\u1B5A-\u1B6A\u1B74-\u1B7F\u1BF4-\u1BFF\u1C38-\u1C3F\u1C4A-\u1C4C\u1C7E\u1C7F\u1C89-\u1C8F\u1CBB\u1CBC\u1CC0-\u1CCF\u1CD3\u1CFB-\u1CFF\u1DFA\u1F16\u1F17\u1F1E\u1F1F\u1F46\u1F47\u1F4E\u1F4F\u1F58\u1F5A\u1F5C\u1F5E\u1F7E\u1F7F\u1FB5\u1FBD\u1FBF-\u1FC1\u1FC5\u1FCD-\u1FCF\u1FD4\u1FD5\u1FDC-\u1FDF\u1FED-\u1FF1\u1FF5\u1FFD-\u203E\u2041-\u2053\u2055-\u2070\u2072-\u207E\u2080-\u208F\u209D-\u20CF\u20F1-\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F-\u215F\u2189-\u24B5\u24EA-\u2BFF\u2C2F\u2C5F\u2CE5-\u2CEA\u2CF4-\u2CFF\u2D26\u2D28-\u2D2C\u2D2E\u2D2F\u2D68-\u2D6E\u2D70-\u2D7E\u2D97-\u2D9F\u2DA7\u2DAF\u2DB7\u2DBF\u2DC7\u2DCF\u2DD7\u2DDF\u2E00-\u2E2E\u2E30-\u3004\u3008-\u3020\u3030\u3036\u3037\u303D-\u3040\u3097\u3098\u309B\u309C\u30A0\u30FB\u3100-\u3104\u3130\u318F-\u319F\u31C0-\u31EF\u3200-\u33FF\u4DC0-\u4DFF\u9FFD-\u9FFF\uA48D-\uA4CF\uA4FE\uA4FF\uA60D-\uA60F\uA62C-\uA63F\uA673\uA67E\uA6F2-\uA716\uA720\uA721\uA789\uA78A\uA7C0\uA7C1\uA7CB-\uA7F4\uA828-\uA82B\uA82D-\uA83F\uA874-\uA87F\uA8C6-\uA8CF\uA8DA-\uA8DF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA954-\uA95F\uA97D-\uA97F\uA9C1-\uA9CE\uA9DA-\uA9DF\uA9FF\uAA37-\uAA3F\uAA4E\uAA4F\uAA5A-\uAA5F\uAA77-\uAA79\uAAC3-\uAADA\uAADE\uAADF\uAAF0\uAAF1\uAAF7-\uAB00\uAB07\uAB08\uAB0F\uAB10\uAB17-\uAB1F\uAB27\uAB2F\uAB5B\uAB6A-\uAB6F\uABEB\uABEE\uABEF\uABFA-\uABFF\uD7A4-\uD7AF\uD7C7-\uD7CA\uD7FC-\uD7FF\uE000-\uF8FF\uFA6E\uFA6F\uFADA-\uFAFF\uFB07-\uFB12\uFB18-\uFB1C\uFB29\uFB37\uFB3D\uFB3F\uFB42\uFB45\uFBB2-\uFBD2\uFD3E-\uFD4F\uFD90\uFD91\uFDC8-\uFDEF\uFDFC-\uFDFF\uFE10-\uFE1F\uFE30-\uFE32\uFE35-\uFE4C\uFE50-\uFE6F\uFE75\uFEFD-\uFF0F\uFF1A-\uFF20\uFF3B-\uFF3E\uFF40\uFF5B-\uFF65\uFFBF-\uFFC1\uFFC8\uFFC9\uFFD0\uFFD1\uFFD8\uFFD9\uFFDD-\uFFFF]|\uD800[\uDC0C\uDC27\uDC3B\uDC3E\uDC4E\uDC4F\uDC5E-\uDC7F\uDCFB-\uDD3F\uDD75-\uDDFC\uDDFE-\uDE7F\uDE9D-\uDE9F\uDED1-\uDEDF\uDEE1-\uDEFF\uDF20-\uDF2C\uDF4B-\uDF4F\uDF7B-\uDF7F\uDF9E\uDF9F\uDFC4-\uDFC7\uDFD0\uDFD6-\uDFFF]|\uD801[\uDC9E\uDC9F\uDCAA-\uDCAF\uDCD4-\uDCD7\uDCFC-\uDCFF\uDD28-\uDD2F\uDD64-\uDDFF\uDF37-\uDF3F\uDF56-\uDF5F\uDF68-\uDFFF]|\uD802[\uDC06\uDC07\uDC09\uDC36\uDC39-\uDC3B\uDC3D\uDC3E\uDC56-\uDC5F\uDC77-\uDC7F\uDC9F-\uDCDF\uDCF3\uDCF6-\uDCFF\uDD16-\uDD1F\uDD3A-\uDD7F\uDDB8-\uDDBD\uDDC0-\uDDFF\uDE04\uDE07-\uDE0B\uDE14\uDE18\uDE36\uDE37\uDE3B-\uDE3E\uDE40-\uDE5F\uDE7D-\uDE7F\uDE9D-\uDEBF\uDEC8\uDEE7-\uDEFF\uDF36-\uDF3F\uDF56-\uDF5F\uDF73-\uDF7F\uDF92-\uDFFF]|\uD803[\uDC49-\uDC7F\uDCB3-\uDCBF\uDCF3-\uDCFF\uDD28-\uDD2F\uDD3A-\uDE7F\uDEAA\uDEAD-\uDEAF\uDEB2-\uDEFF\uDF1D-\uDF26\uDF28-\uDF2F\uDF51-\uDFAF\uDFC5-\uDFDF\uDFF7-\uDFFF]|\uD804[\uDC47-\uDC65\uDC70-\uDC7E\uDCBB-\uDCCF\uDCE9-\uDCEF\uDCFA-\uDCFF\uDD35\uDD40-\uDD43\uDD48-\uDD4F\uDD74\uDD75\uDD77-\uDD7F\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDFF\uDE12\uDE38-\uDE3D\uDE3F-\uDE7F\uDE87\uDE89\uDE8E\uDE9E\uDEA9-\uDEAF\uDEEB-\uDEEF\uDEFA-\uDEFF\uDF04\uDF0D\uDF0E\uDF11\uDF12\uDF29\uDF31\uDF34\uDF3A\uDF45\uDF46\uDF49\uDF4A\uDF4E\uDF4F\uDF51-\uDF56\uDF58-\uDF5C\uDF64\uDF65\uDF6D-\uDF6F\uDF75-\uDFFF]|\uD805[\uDC4B-\uDC4F\uDC5A-\uDC5D\uDC62-\uDC7F\uDCC6\uDCC8-\uDCCF\uDCDA-\uDD7F\uDDB6\uDDB7\uDDC1-\uDDD7\uDDDE-\uDDFF\uDE41-\uDE43\uDE45-\uDE4F\uDE5A-\uDE7F\uDEB9-\uDEBF\uDECA-\uDEFF\uDF1B\uDF1C\uDF2C-\uDF2F\uDF3A-\uDFFF]|\uD806[\uDC3B-\uDC9F\uDCEA-\uDCFE\uDD07\uDD08\uDD0A\uDD0B\uDD14\uDD17\uDD36\uDD39\uDD3A\uDD44-\uDD4F\uDD5A-\uDD9F\uDDA8\uDDA9\uDDD8\uDDD9\uDDE2\uDDE5-\uDDFF\uDE3F-\uDE46\uDE48-\uDE4F\uDE9A-\uDE9C\uDE9E-\uDEBF\uDEF9-\uDFFF]|\uD807[\uDC09\uDC37\uDC41-\uDC4F\uDC5A-\uDC71\uDC90\uDC91\uDCA8\uDCB7-\uDCFF\uDD07\uDD0A\uDD37-\uDD39\uDD3B\uDD3E\uDD48-\uDD4F\uDD5A-\uDD5F\uDD66\uDD69\uDD8F\uDD92\uDD99-\uDD9F\uDDAA-\uDEDF\uDEF7-\uDFAF\uDFB1-\uDFFF]|\uD808[\uDF9A-\uDFFF]|\uD809[\uDC6F-\uDC7F\uDD44-\uDFFF]|[\uD80A\uD80B\uD80E-\uD810\uD812-\uD819\uD824-\uD82B\uD82D\uD82E\uD830-\uD833\uD837\uD839\uD83D\uD83F\uD87B-\uD87D\uD87F\uD885-\uDB3F\uDB41-\uDBFF][\uDC00-\uDFFF]|\uD80D[\uDC2F-\uDFFF]|\uD811[\uDE47-\uDFFF]|\uD81A[\uDE39-\uDE3F\uDE5F\uDE6A-\uDECF\uDEEE\uDEEF\uDEF5-\uDEFF\uDF37-\uDF3F\uDF44-\uDF4F\uDF5A-\uDF62\uDF78-\uDF7C\uDF90-\uDFFF]|\uD81B[\uDC00-\uDE3F\uDE80-\uDEFF\uDF4B-\uDF4E\uDF88-\uDF8E\uDFA0-\uDFDF\uDFE2\uDFE5-\uDFEF\uDFF2-\uDFFF]|\uD821[\uDFF8-\uDFFF]|\uD823[\uDCD6-\uDCFF\uDD09-\uDFFF]|\uD82C[\uDD1F-\uDD4F\uDD53-\uDD63\uDD68-\uDD6F\uDEFC-\uDFFF]|\uD82F[\uDC6B-\uDC6F\uDC7D-\uDC7F\uDC89-\uDC8F\uDC9A-\uDC9C\uDC9F-\uDFFF]|\uD834[\uDC00-\uDD64\uDD6A-\uDD6C\uDD73-\uDD7A\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDE41\uDE45-\uDFFF]|\uD835[\uDC55\uDC9D\uDCA0\uDCA1\uDCA3\uDCA4\uDCA7\uDCA8\uDCAD\uDCBA\uDCBC\uDCC4\uDD06\uDD0B\uDD0C\uDD15\uDD1D\uDD3A\uDD3F\uDD45\uDD47-\uDD49\uDD51\uDEA6\uDEA7\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3\uDFCC\uDFCD]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85-\uDE9A\uDEA0\uDEB0-\uDFFF]|\uD838[\uDC07\uDC19\uDC1A\uDC22\uDC25\uDC2B-\uDCFF\uDD2D-\uDD2F\uDD3E\uDD3F\uDD4A-\uDD4D\uDD4F-\uDEBF\uDEFA-\uDFFF]|\uD83A[\uDCC5-\uDCCF\uDCD7-\uDCFF\uDD4C-\uDD4F\uDD5A-\uDFFF]|\uD83B[\uDC00-\uDDFF\uDE04\uDE20\uDE23\uDE25\uDE26\uDE28\uDE33\uDE38\uDE3A\uDE3C-\uDE41\uDE43-\uDE46\uDE48\uDE4A\uDE4C\uDE50\uDE53\uDE55\uDE56\uDE58\uDE5A\uDE5C\uDE5E\uDE60\uDE63\uDE65\uDE66\uDE6B\uDE73\uDE78\uDE7D\uDE7F\uDE8A\uDE9C-\uDEA0\uDEA4\uDEAA\uDEBC-\uDFFF]|\uD83C[\uDC00-\uDD2F\uDD4A-\uDD4F\uDD6A-\uDD6F\uDD8A-\uDFFF]|\uD83E[\uDC00-\uDFEF\uDFFA-\uDFFF]|\uD869[\uDEDE-\uDEFF]|\uD86D[\uDF35-\uDF3F]|\uD86E[\uDC1E\uDC1F]|\uD873[\uDEA2-\uDEAF]|\uD87A[\uDFE1-\uDFFF]|\uD87E[\uDE1E-\uDFFF]|\uD884[\uDF4B-\uDFFF]|\uDB40[\uDC00-\uDCFF\uDDF0-\uDFFF]/g, ST = Object.hasOwnProperty;
  class xT {
    constructor() {
    ...
    slug(t, n) {
      ...
      let i = LT(t, n === true);
      const u = i;
      for (; ST.call(r.occurrences, i); ) r.occurrences[u]++, i = u + "-" + r.occurrences[u];
  ...
  function LT(e, t) {
    return typeof e != "string" ? "" : (t || (e = e.toLowerCase()), e.replace(NT, "").replace(/ /g, "-"));
  }
  const FT = [
    "object"
  ], OT = [
  ...
  function RT(e) {
    ...
    try {
      ...
      if (wT.some((i) => r.protocol.toLowerCase().startsWith(i))) return false;
    } catch {
      return false;
    }
    return true;
  }
  const BT = (e, t) => (e = e.toLowerCase(), e.startsWith("on") || OT.includes(e) ? false : e === "href" || e === "src" ? RT(t) : true), PT = (e, t) => FT.includes(e) ? {} : t ? (t = Object.fromEntries(Object.entries(t).filter(([n, r]) => {
  ...
  function MT(e = {}) {
    ...
    function n(r, i) {
      ...
      if (r.type === "element") {
        ...
        if (r.tagName === "li") {
          let o = false;
          r.children = (_e2 = r.children) == null ? void 0 : _e2.flatMap((l) => l.type === "element" && l.tagName === "p" ? (o && l.children.unshift({
            type: "element",
            tagName: "br",
            properties: {},
            children: []
        ...
        ((_f2 = r.tagName) == null ? void 0 : _f2.match(/^h\d$/)) && (r.properties = r.properties || {}, r.properties.id = String(((_g2 = r.properties) == null ? void 0 : _g2.id) || t.slug(tc(r))).replace(/-+/g, "-").replace(/^-|-$/g, "").replace(/^(\d)/, "_$1")), r.tagName === "component-slot" && (r.tagName = "template");
        const s = (r.tagName === "template" && ((_h2 = r.content) == null ? void 0 : _h2.children.length) ? r.content.children : r.children).map((o) => n(o, r)).filter(Boolean), a = {
          type: "element",
          tag: r.tagName,
          props: PT(r.tagName, r.properties),
          children: s
        };
  ...
  let vt, Fr;
  const rc = async (e = {}) => {
    var _a2, _b2, _c2, _d2, _e2, _f2, _g2, _h2, _i2, _j, _k, _l2, _m2;
    vt || (vt = await Ln(() => import("./8G-HYffv.js").then(async (m) => {
      await m.__tla;
      return m;
    }), __vite__mapDeps([0,1,2,3,4,5,6,7]), import.meta.url).catch(() => ({}))), Fr || (Fr = await Ln(() => import("./bNaE6FFb.js"), [], import.meta.url).then((i) => i.getMdcConfigs()).catch(() => []));
    const t = [
      ...Fr || [],
      ...e.configs || []
    ];
    ...
    ((_b2 = (_a2 = n.rehype) == null ? void 0 : _a2.plugins) == null ? void 0 : _b2.highlight) && (e.highlight === false ? delete n.rehype.plugins.highlight : n.rehype.plugins.highlight.options = Ur({}, n.rehype.plugins.highlight.options, n.highlight || {}));
    let r = Hs();
    for (const i of t) r = await ((_d2 = (_c2 = i.unified) == null ? void 0 : _c2.pre) == null ? void 0 : _d2.call(_c2, r)) || r;
    r.use(Oh);
    for (const i of t) r = await ((_f2 = (_e2 = i.unified) == null ? void 0 : _e2.remark) == null ? void 0 : _f2.call(_e2, r)) || r;
    await Wu(r, (_g2 = n.remark) == null ? void 0 : _g2.plugins), r.use(k0, (_h2 = n.rehype) == null ? void 0 : _h2.options);
    for (const i of t) r = await ((_j = (_i2 = i.unified) == null ? void 0 : _i2.rehype) == null ? void 0 : _j.call(_i2, r)) || r;
    await Wu(r, (_k = n.rehype) == null ? void 0 : _k.plugins), r.use(MT, n);
    ...
    return async function(r, { fileOptions: i } = {}) {
      const { content: u, data: s } = await Ka(r), a = typeof process < "u" && typeof process.cwd == "function" ? process.cwd() : "/tmp", o = await new Promise((p, E) => {
        t.process({
          cwd: a,
          ...i,
          value: u,
      ...
      }), l = o == null ? void 0 : o.result, h = Object.assign(e.contentHeading !== false ? HT(l.body) : {}, s, (o == null ? void 0 : o.data) || {}), f = {
        data: h,
        body: l.body
      }, d = h.toc ?? e.toc;
      if (d !== false) {
  ...
  }, UT = async (e, t = {}, n = {}) => (await ic(t))(e.replace(/\r\n/g, `
`), n);
  function HT(e) {
    let t = "", n = "";
  ...
  function uc(e, t) {
    sc(e, {
      collapse: XT((t || $T).newlines ? GT : QT),
      whitespace: "normal"
    });
  }
  function sc(e, t) {
    if ("children" in e) {
      ...
      return (e.type === "root" || cc(e)) && (n.before = true, n.after = true), n.whitespace = JT(e, t), VT(e, n);
    }
    if (e.type === "text") {
      if (t.whitespace === "normal") return jT(e, t);
  ...
  function jT(e, t) {
    ...
    let i = 0, u = n.length;
    return t.before && bs(n.charAt(0)) && i++, i !== u && bs(n.charAt(u - 1)) && (t.after ? u-- : r.stripAtStart = true), i === u ? r.remove = true : e.value = n.slice(i, u), r;
  }
  function VT(e, t) {
    let n = t.before;
    ...
    for (; ++s < u; ) {
      ...
      a.remove ? (i.splice(s, 1), s--, u--) : a.ignore || (n = a.stripAtStart), oc(i[s]) && (n = false);
    }
    return {
      ignore: false,
      stripAtStart: !!(n || r),
  ...
  function ac(e, t, n) {
    for (; ++t < e.length; ) {
      const r = e[t];
      let i = KT(r);
      if (i === void 0 && "children" in r && !WT(r) && (i = ac(r.children, -1)), typeof i == "boolean") return i;
    }
    return n;
  }
  function KT(e) {
    if (e.type === "element") {
      if (oc(e)) return false;
      if (cc(e)) return true;
    } else if (e.type === "text") {
      if (!jt(e)) return false;
    } else if (!vi(e)) return false;
  }
  function oc(e) {
    return Hi(e) || tr(e, YT);
  }
  ...
  function WT(e) {
    return !!(e.type === "element" && e.properties.hidden) || vi(e) || tr(e, qT);
  }
  function bs(e) {
    return e === " " || e === `
`;
  ...
  }), As = /\n/g, Cs = /[\t ]+/g, ii = Ie("br"), _s = Ie(l2), i2 = Ie("p"), Ds = Ie("tr"), u2 = Ie([
    "datalist",
    "head",
    "noembed",
    "noframes",
  ...
  pn = function(e, t) {
    const n = t || {}, r = "children" in e ? e.children : [], i = lc(e), u = pc(e, {
      whitespace: n.whitespace || "normal"
    }), s = [];
    (e.type === "text" || e.type === "comment") && s.push(...hc(e, {
      breakBefore: true,
      breakAfter: true
    }));
    let a = -1;
    for (; ++a < r.length; ) s.push(...fc(r[a], e, {
      whitespace: u,
      breakBefore: a ? void 0 : i,
      breakAfter: a < r.length - 1 ? ii(r[a + 1]) : i
    }));
    const o = [];
    let l;
    for (a = -1; ++a < s.length; ) {
...
`.repeat(l) || " "), l = -1, o.push(h));
  ...
  function fc(e, t, n) {
    return e.type === "element" ? s2(e, t, n) : e.type === "text" ? n.whitespace === "normal" ? hc(e, n) : a2(e) : [];
  }
  function s2(e, t, n) {
    const r = pc(e, n), i = e.children || [];
    let u = -1, s = [];
    if (u2(e)) return s;
    let a, o;
    for (ii(e) || Ds(e) && Ts(t, e, Ds) ? o = `
` : i2(e) ? (a = 2, o = 2) : lc(e) && (a = 1, o = 1); ++u < i.length; ) s = s.concat(fc(i[u], e, {
      whitespace: r,
      breakBefore: u ? void 0 : a,
      breakAfter: u < i.length - 1 ? ii(i[u + 1]) : o
    }));
    return _s(e) && Ts(t, e, _s) && s.push("	"), a && s.unshift(a), o && s.push(o), s;
  }
  function hc(e, t) {
    ...
    for (; u <= n.length; ) {
      As.lastIndex = u;
      const o = As.exec(n), l = o && "index" in o ? o.index : n.length;
      r.push(o2(n.slice(u, l).replace(/[\u061C\u200E\u200F\u202A-\u202E\u2066-\u2069]/g, ""), u === 0 ? t.breakBefore : true, l === n.length ? t.breakAfter : true)), u = l + 1;
    }
    let s = -1, a;
  ...
  function yn(e, t) {
    ...
    if (i) {
      for (r = -1; ++r < i.length; ) if (String(i[r]).slice(0, Or.length) === Or) {
        u = String(i[r]).slice(Or.length);
        break;
      }
    }
    const s = {
  ...
  function mt(e, t) {
    const n = Number(t.tagName.charAt(1)) || 1, r = Yi(e.all(t)), i = {
      type: "heading",
      depth: n,
      children: r
    };
  ...
  function dc(e, t) {
    const n = [], r = [], i = t || e.properties || {}, u = mc(e), s = Math.min(Number.parseInt(String(i.size), 10), 0) || (i.multiple ? 4 : 1);
    let a = -1;
    for (; ++a < u.length; ) {
      const h = u[a];
  ...
  function mc(e) {
    ...
    for (; ++n < e.children.length; ) {
      ...
      "children" in r && Array.isArray(r.children) && t.push(...mc(r)), r.type === "element" && r.tagName === "option" && (!r.properties || !r.properties.disabled) && t.push(r);
    }
    return t;
  }
  const b2 = "[x]", T2 = "[ ]";
  function A2(e, t) {
    ...
    if (n.type === "checkbox" || n.type === "radio") {
      const o = {
        type: "text",
        value: n.checked ? e.options.checked || b2 : e.options.unchecked || T2
      };
  ...
  const C2 = {}.hasOwnProperty;
  function _2(e, t) {
    const n = e.type === "element" && C2.call(e.properties, t) && e.properties[t];
  ...
  function y2(e) {
    ...
    for (; ++n < t.length; ) if (!D2.has(String(t[n]))) return false;
    return true;
  }
  const k2 = Ie([
    "a",
  ...
  function qi(e) {
    return !!(e.type === "text" || k2(e) || Hi(e) || y2(e) || I2(e) && _2(e, "itemProp"));
  }
  function Rr(e, t) {
    const { rest: n, checkbox: r } = gc(t), i = r ? !!r.properties.checked : null, u = Ec(n), s = e.toFlow(e.all(n)), a = {
      type: "listItem",
      spread: u,
      checked: i,
      children: s
  ...
  function Ec(e) {
    ...
    for (; ++t < e.children.length; ) {
      ...
      if (r.type === "element") {
        if (qi(r)) continue;
        if (r.tagName === "p" || n || Ec(r)) return true;
        n = true;
      }
    }
    return false;
  ...
  function Br(e, t) {
    const n = t.tagName === "ol", r = e.toSpecificContent(e.all(t), N2);
    let i = null;
  ...
  function sr(e) {
    ...
    for (; ++t < e.length; ) {
      const n = e[t];
      if (!Ac(n) || "children" in n && sr(n.children)) return true;
    }
    return false;
  }
  function bc(e) {
  ...
  function Tc(e, t, n) {
    ...
    for (; ++s < r.length; ) {
      const a = r[s];
      Ac(a) ? u.push(a) : (u.length > 0 && (i.push(...t(u)), u = []), i.push(n(a)));
    }
  ...
  function x2(e) {
    ...
    for (; ++n < e.length; ) {
      const r = e[n];
      (r.type === "delete" || r.type === "link") && sr(r.children) ? t.push(...S2(r)) : t.push(r);
    }
    return t;
  }
  function Ac(e) {
  ...
  function O2(e, t) {
    let n = e.all(t);
    (e.options.document || sr(n)) && (n = bc(n));
    const r = {
      type: "root",
      children: n
    };
  ...
  function R2(e, t) {
    const r = {
      type: "tableRow",
      children: e.toSpecificContent(e.all(t), B2)
    };
    return e.patch(t, r), r;
  }
  function B2() {
  ...
  function P2(e, t) {
    ...
    e.inTable = true;
    const { align: n, headless: r } = M2(t), i = e.toSpecificContent(e.all(t), Ls);
    r && i.unshift(Ls());
    let u = -1;
    for (; ++u < i.length; ) {
      const l = i[u], h = e.toSpecificContent(l.children, U2);
      l.children = h;
    }
    let s = 1;
    for (u = -1; ++u < i.length; ) {
  ...
  function M2(e) {
    ...
    let n = 0, r = 0;
    return ke(e, function(i) {
      if (i.type === "element") {
        if (i.tagName === "table" && e !== i) return bi;
  ...
  function j2(e, t) {
    if (e.type === "element") {
      ...
      if (Fs.call(this.handlers, e.tagName)) return this.handlers[e.tagName](this, e, t) || void 0;
    } else if (Fs.call(this.nodeHandlers, e.type)) return this.nodeHandlers[e.type](this, e, t) || void 0;
  ...
  function eA(e, t) {
    ...
    function i(s, a) {
      ...
      if (s.type === "element" && s.tagName === "head" && (r.head = true), r.head && s.type === "element" && s.tagName === "body" && (r.head = false), s.type === "element" && J2.includes(s.tagName)) return bi;
      if (s.children.length === 0 || !Mr(r, s)) return;
      let o = a.length;
      r.indentInitial || o--;
      let l = false;
...
`) && (l = true), d.value = d.value.replace(/ *\n/g, "$&" + r.indent.repeat(o)));
      const h = [];
      let f;
      for (const d of s.children) (Mr(r, d) || l && !f) && (u(h, o, d), l = true), f = d, h.push(d);
      f && (l || Mr(r, f)) && (jt(f) && (h.pop(), f = h[h.length - 1]), u(h, o - 1)), s.children = h;
    }
    function u(s, a, o) {
      const l = s[s.length - 1], h = l && jt(l) ? s[s.length - 2] : l, f = (Os(r, h) && Os(r, o) ? `
...
`) + r.indent.repeat(Math.max(a, 0));
  ...
  function Mr(e, t) {
    return t.type === "root" || (t.type === "element" ? e.head || t.tagName === "script" || Hi(t) || !qi(t) : false);
  }
  function tA(e) {
  ...
  const ar = "mdc-element", Zt = "textDirective", nA = "textComponent", rA = {}.hasOwnProperty;
  function iA(e) {
    return function(t, n) {
      const r = ui(t), i = X2(r, {
        document: true,
      ...
      return ke(i, (u) => u.type === Zt, (u, s, a) => {
        var _a2, _b2;
        if (u.type = nA, u.name !== "binding" && s && a && a.children) {
...
`,
  ...
  const uA = {
    [ar]: (e, t, n) => {
      ...
      if (rA.call(e.handlers, t.tagName)) return e.handlers[t.tagName](e, t, n) || void 0;
...
`)) && (i.value = i.value.trim());
    ...
    code: (e, t) => {
      ...
      "style" in n && !n.style && delete n.style, "class" in n && (n.className = String(n.class).split(" ").filter(Boolean), delete n.class), Array.isArray(n.className) && (n.className = n.className.filter((i) => !i.startsWith("language-")), Array.isArray(n.className) && !n.className.length && delete n.className), n.language && (n.lang = ws(n.language), delete n.language);
      const r = {
        type: "inlineCode",
        value: Fn(t),
        attributes: n
    ...
    pre: (e, t) => {
      ...
      const n = [
        ...
        ((_a2 = t.properties.highlights) == null ? void 0 : _a2.length) ? `{${tA(t.properties.highlights)}}` : "",
        t.properties.meta
      ].filter(Boolean).join(" ");
      return {
        type: "code",
        value: String(t.properties.code || "").replace(/\n$/, ""),
        lang: ws(t.properties.language),
        meta: n
      };
    },
    button: (e, t, n) => aA(t, n) ? Ue("button")(e, t) : {
      type: "containerComponent",
      name: "button",
      children: e.all(t),
      attributes: t.properties
    ...
    br: Ue("br"),
    table: (e, t) => (ke(t, (n) => {
      n.type === ar && (n.type = "element");
    }), Object.keys(t.properties).length ? (eA({
      type: "root",
      children: [
        t
      ]
    ...
    a(e, t) {
      ...
      wc(String(n || "")) && (i.target === "_blank" && delete i.target, [
  ...
  function aA(e, t) {
    var _a2, _b2;
    return !(((_a2 = e.children) == null ? void 0 : _a2.find((n) => n.type === ar)) || ((_b2 = e.children) == null ? void 0 : _b2.find((n) => n.type === "text" && n.value.includes(`
`))) || !Cc(e, t));
  }
  function _c(e = {}) {
    var _a2, _b2, _c2, _d2, _e2, _f2;
    return Hs().use(function() {
      this.parser = function(n) {
        return JSON.parse(n);
      };
    }).use(iA).use(po).use(eo, ((_b2 = (_a2 = e == null ? void 0 : e.plugins) == null ? void 0 : _a2["remark-mdc"]) == null ? void 0 : _b2.options) || ((_d2 = (_c2 = e == null ? void 0 : e.plugins) == null ? void 0 : _c2.remarkMDC) == null ? void 0 : _d2.options) || {}).use(vT, {
      bullet: "-",
      emphasis: "*",
      rule: "-",
      listItemIndent: "one",
      fence: "`",
      fences: true,
      ...(_f2 = (_e2 = e == null ? void 0 : e.plugins) == null ? void 0 : _e2.remarkStringify) == null ? void 0 : _f2.options
    });
  }
  function Dc(e = {}) {
    const t = _c(e);
    async function n(r, i = {}) {
      ...
      return Object.keys(i).length ? Va(i, u.value, (_a2 = e.frontMatter) == null ? void 0 : _a2.options) : u.value;
    }
    return n;
  }
  ...
  cA = function(e) {
    ...
    return async (n) => {
      ...
      ke(n, (u) => {
        ...
        const s = u, a = typeof s.properties.highlights == "string" ? s.properties.highlights.split(/[,\s]+/).map(Number) : Array.isArray(s.properties.highlights) ? s.properties.highlights.map(Number) : [], o = t.highlighter(tc(u), s.properties.language, t.theme, {
  ...
  function fA({ langs: e = [], themes: t = [], bundledLangs: n = {}, bundledThemes: r = {}, getMdcConfigs: i, options: u, engine: s } = {}) {
    let a, o;
    async function l() {
      var _a2, _b2;
      const { createHighlighterCore: p, addClassToHast: E, isSpecialLang: m, isSpecialTheme: D } = await Ln(async () => {
        const { createHighlighterCore: k, addClassToHast: Y, isSpecialLang: w, isSpecialTheme: $ } = await import("./Cp9leU2x.js");
        return {
...
`);
  ...
  AA = Object.freeze(Object.defineProperty({
    __proto__: null,
    TEXT_TAGS: nl,
    createCachedParser: Wc,
    createMarkdownParser: ic,
    createMarkdownStringifier: Dc,
    createParseProcessor: rc,
    createShikiHighlighter: fA,
    createStringifyProcessor: _c,
    flatUnwrap: rl,
    isTag: il,
    isText: ul,
    nodeChildren: sl,
