    ...
    return a(), p(l(H), { as: t.as, "data-orientation": t.orientation, "data-slot": "root", class: o(i.value.root({ class: [(_a = l(s)) == null ? void 0 : _a.root, u.class] })) }, { default: g(() => {
      ...
      return [n(r.$slots, "top"), w(C, { "data-slot": "container", class: o(i.value.container({ class: (_a2 = l(s)) == null ? void 0 : _a2.container })) }, { default: g(() => {
        ...
        return [e.header || t.headline || e.headline || t.title || e.title || t.description || e.description || e.body || e.footer || ((_a3 = t.links) == null ? void 0 : _a3.length) || e.links ? (a(), d("div", { key: 0, "data-slot": "wrapper", class: o(i.value.wrapper({ class: (_b = l(s)) == null ? void 0 : _b.wrapper })) }, [e.header || t.headline || e.headline || t.title || e.title || t.description || e.description ? (a(), d("div", { key: 0, "data-slot": "header", class: o(i.value.header({ class: (_c = l(s)) == null ? void 0 : _c.header })) }, [n(r.$slots, "header", {}, () => {
          ...
          var _a4, _b2;
          return [((_a4 = t.links) == null ? void 0 : _a4.length) || e.links ? (a(), d("div", { key: 0, "data-slot": "links", class: o(i.value.links({ class: (_b2 = l(s)) == null ? void 0 : _b2.links })) }, [n(r.$slots, "links", {}, () => [(a(true), d(S, null, z(t.links, (k, v) => (a(), p(B, P({ key: v, size: "xl" }, { ref_for: true }, k), null, 16))), 128))])], 2)) : c("", true)];
        })], 2)) : c("", true)], 2)) : c("", true), e.default ? n(r.$slots, "default", { key: 1 }) : t.orientation === "horizontal" ? (a(), d("div", j)) : c("", true)];
