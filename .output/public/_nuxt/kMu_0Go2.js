const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Cp9leU2x.js","./UYQwraN4.js","./6GRe1c0h.js","./BYNxcJcd.js","./entry.jj7id34R.css","./iik6CYzq.js","./CnnebwVN.js","./wDzz0qaB.js","./DPfMkruS.js","./Dw0ZUpBv.js","./BPQ3VLAy.js","./Cp-IABpG.js","./25uufFqr.js","./BMG7h6za.js","./Cvjx9yec.js","./Buea-lGh.js"])))=>i.map(i=>d[i]);
...
let b, Q;
let __tla = (async () => {
  b = function({ langs: t = [], themes: R = [], bundledLangs: D = {}, bundledThemes: P = {}, getMdcConfigs: I, options: V, engine: w } = {}) {
    let E, g;
    async function $() {
      var _a, _b;
      const { createHighlighterCore: h, addClassToHast: o, isSpecialLang: l, isSpecialTheme: u } = await i(async () => {
        const { createHighlighterCore: a, addClassToHast: s, isSpecialLang: p, isSpecialTheme: d } = await import("./Cp9leU2x.js");
        return {
      ...
      for await (const a of await A()) await ((_b = (_a = a.shiki) == null ? void 0 : _a.setup) == null ? void 0 : _b.call(_a, f));
      return {
        shiki: f,
        addClassToHast: o,
        isSpecialLang: l,
    ...
    return async (h, o, l, u = {}) => {
      ...
      typeof o == "string" && !d.includes(o) && !T(o) && (D[o] ? await n.loadLanguage(D[o]) : o = "text");
      for (const [e, r] of Object.entries(s)) typeof r == "string" && !p.includes(r) && !y(r) && (P[r] ? await n.loadTheme(P[r]) : s[e] = "none");
      const L = /* @__PURE__ */ new Map();
      for (const e of f) L.set(e.name || `transformer:${Math.random()}-${e.constructor.name}`, e);
      for (const e of await A()) {
