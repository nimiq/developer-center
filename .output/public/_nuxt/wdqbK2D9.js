import { F as p, C as m, H as y, c as g, L as f, l as s, m as b, w as h, y as i, O as o, p as e, e as n, B as u, P as C } from "#entry";
const k = { slots: { root: "rounded-lg overflow-hidden", header: "p-4 sm:px-6", body: "p-4 sm:p-6", footer: "p-4 sm:px-6" }, variants: { variant: { solid: { root: "bg-inverted text-inverted" }, outline: { root: "bg-default ring ring-default divide-y divide-default" }, soft: { root: "bg-elevated/50 divide-y divide-default" }, subtle: { root: "bg-elevated/50 ring ring-default divide-y divide-default" } } }, defaultVariants: { variant: "outline" } }, B = { __name: "UCard", props: { as: { type: null, required: false }, variant: { type: null, required: false }, class: { type: null, required: false }, ui: { type: Object, required: false } }, setup(c) {
  const r = c, l = p(), v = m(), a = y("card", r), t = g(() => {
    var _a;
    return f({ extend: f(k), ...((_a = v.ui) == null ? void 0 : _a.card) || {} })({ variant: r.variant });
  });
  return (d, q) => {
    var _a;
    return s(), b(e(C), { as: c.as, "data-slot": "root", class: o(t.value.root({ class: [(_a = e(a)) == null ? void 0 : _a.root, r.class] })) }, { default: h(() => {
      var _a2, _b, _c;
