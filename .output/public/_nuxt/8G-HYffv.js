const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./kMu_0Go2.js","./BYNxcJcd.js","./entry.jj7id34R.css","./bNaE6FFb.js","./UYQwraN4.js","./6GRe1c0h.js","./iik6CYzq.js"])))=>i.map(i=>d[i]);
...
import { __tla as __tla_1 } from "./D0o_tKqw.js";
import "./6GRe1c0h.js";
import "./iik6CYzq.js";
import "./UYQwraN4.js";
let VA, $A, UA;
let __tla = Promise.all([
  ...
  function lo() {
    return nr || (nr = 1, (function(t, e) {
      ...
      const { toString: m } = Object.prototype, g = (i) => {
        ...
        if (/HTML\w+Element/.test(z) && u.domElement(i)) return "HTMLElement";
        if (n(z)) return z;
      }, _ = (i) => (z) => g(z) === i;
      function u(i) {
        ...
        if (u.observable(i)) return "Observable";
        if (u.array(i)) return "Array";
        if (u.buffer(i)) return "Buffer";
        const z = g(i);
        if (z) return z;
      ...
      u.undefined = d("undefined"), u.string = d("string");
      const b = d("number");
      u.number = (i) => b(i) && !u.nan(i), u.bigint = d("bigint"), u.function_ = d("function"), u.null_ = (i) => i === null, u.class_ = (i) => u.function_(i) && i.toString().startsWith("class "), u.boolean = (i) => i === true || i === false, u.symbol = d("symbol"), u.numericString = (i) => u.string(i) && !u.emptyStringOrWhitespace(i) && !Number.isNaN(Number(i)), u.array = (i, z) => Array.isArray(i) ? u.function_(z) ? i.every(z) : true : false, u.buffer = (i) => {
        var z, F, O, X;
      ...
      }, u.blob = (i) => _("Blob")(i), u.nullOrUndefined = (i) => u.null_(i) || u.undefined(i), u.object = (i) => !u.null_(i) && (typeof i == "object" || u.function_(i)), u.iterable = (i) => {
        var z;
        return u.function_((z = i) === null || z === void 0 ? void 0 : z[Symbol.iterator]);
      }, u.asyncIterable = (i) => {
        var z;
        return u.function_((z = i) === null || z === void 0 ? void 0 : z[Symbol.asyncIterator]);
      }, u.generator = (i) => {
        var z, F;
        return u.iterable(i) && u.function_((z = i) === null || z === void 0 ? void 0 : z.next) && u.function_((F = i) === null || F === void 0 ? void 0 : F.throw);
      }, u.asyncGenerator = (i) => u.asyncIterable(i) && u.function_(i.next) && u.function_(i.throw), u.nativePromise = (i) => _("Promise")(i);
      const S = (i) => {
        var z, F;
        return u.function_((z = i) === null || z === void 0 ? void 0 : z.then) && u.function_((F = i) === null || F === void 0 ? void 0 : F.catch);
      };
      u.promise = (i) => u.nativePromise(i) || S(i), u.generatorFunction = _("GeneratorFunction"), u.asyncGeneratorFunction = (i) => g(i) === "AsyncGeneratorFunction", u.asyncFunction = (i) => g(i) === "AsyncFunction", u.boundFunction = (i) => u.function_(i) && !i.hasOwnProperty("prototype"), u.regExp = _("RegExp"), u.date = _("Date"), u.error = _("Error"), u.map = (i) => _("Map")(i), u.set = (i) => _("Set")(i), u.weakMap = (i) => _("WeakMap")(i), u.weakSet = (i) => _("WeakSet")(i), u.int8Array = _("Int8Array"), u.uint8Array = _("Uint8Array"), u.uint8ClampedArray = _("Uint8ClampedArray"), u.int16Array = _("Int16Array"), u.uint16Array = _("Uint16Array"), u.int32Array = _("Int32Array"), u.uint32Array = _("Uint32Array"), u.float32Array = _("Float32Array"), u.float64Array = _("Float64Array"), u.bigInt64Array = _("BigInt64Array"), u.bigUint64Array = _("BigUint64Array"), u.arrayBuffer = _("ArrayBuffer"), u.sharedArrayBuffer = _("SharedArrayBuffer"), u.dataView = _("DataView"), u.enumCase = (i, z) => Object.values(z).includes(i), u.directInstanceOf = (i, z) => Object.getPrototypeOf(i) === z.prototype, u.urlInstance = (i) => _("URL")(i), u.urlString = (i) => {
        if (!u.string(i)) return false;
        try {
          return new URL(i), true;
        } catch {
          return false;
        }
      }, u.truthy = (i) => !!i, u.falsy = (i) => !i, u.nan = (i) => Number.isNaN(i), u.primitive = (i) => u.null_(i) || h(typeof i), u.integer = (i) => Number.isInteger(i), u.safeInteger = (i) => Number.isSafeInteger(i), u.plainObject = (i) => {
        if (m.call(i) !== "[object Object]") return false;
        const z = Object.getPrototypeOf(i);
        return z === null || z === Object.getPrototypeOf({});
      }, u.typedArray = (i) => r(g(i));
      const v = (i) => u.safeInteger(i) && i >= 0;
      u.arrayLike = (i) => !u.nullOrUndefined(i) && !u.function_(i) && v(i.length), u.inRange = (i, z) => {
        if (u.number(z)) return i >= Math.min(0, z) && i <= Math.max(z, 0);
        if (u.array(z) && z.length === 2) return i >= Math.min(...z) && i <= Math.max(...z);
      ...
      u.domElement = (i) => u.object(i) && i.nodeType === B && u.string(i.nodeName) && !u.plainObject(i) && C.every((z) => z in i), u.observable = (i) => {
        var z, F, O, X;
        return i ? i === ((F = (z = i)[Symbol.observable]) === null || F === void 0 ? void 0 : F.call(z)) || i === ((X = (O = i)["@@observable"]) === null || X === void 0 ? void 0 : X.call(O)) : false;
      }, u.nodeStream = (i) => u.object(i) && u.function_(i.pipe) && !u.observable(i), u.infinite = (i) => i === 1 / 0 || i === -1 / 0;
      const A = (i) => (z) => u.integer(z) && Math.abs(z % 2) === i;
      u.evenInteger = A(0), u.oddInteger = A(1), u.emptyArray = (i) => u.array(i) && i.length === 0, u.nonEmptyArray = (i) => u.array(i) && i.length > 0, u.emptyString = (i) => u.string(i) && i.length === 0;
      const R = (i) => u.string(i) && !/\S/.test(i);
      u.emptyStringOrWhitespace = (i) => u.emptyString(i) || R(i), u.nonEmptyString = (i) => u.string(i) && i.length > 0, u.nonEmptyStringAndNotWhitespace = (i) => u.string(i) && !u.emptyStringOrWhitespace(i), u.emptyObject = (i) => u.object(i) && !u.map(i) && !u.set(i) && Object.keys(i).length === 0, u.nonEmptyObject = (i) => u.object(i) && !u.map(i) && !u.set(i) && Object.keys(i).length > 0, u.emptySet = (i) => u.set(i) && i.size === 0, u.nonEmptySet = (i) => u.set(i) && i.size > 0, u.emptyMap = (i) => u.map(i) && i.size === 0, u.nonEmptyMap = (i) => u.map(i) && i.size > 0, u.propertyKey = (i) => u.any([
        u.string,
        u.number,
        u.symbol
      ], i), u.formData = (i) => _("FormData")(i), u.urlSearchParams = (i) => _("URLSearchParams")(i);
      const N = (i, z, F) => {
        if (!u.function_(z)) throw new TypeError(`Invalid predicate: ${JSON.stringify(z)}`);
        if (F.length === 0) throw new TypeError("Invalid number of values");
        return i.call(F, z);
      };
      u.any = (i, ...z) => (u.array(i) ? i : [
        i
      ]).some((O) => N(Array.prototype.some, O, z)), u.all = (i, ...z) => N(Array.prototype.every, i, z);
      const x = (i, z, F, O = {}) => {
        if (!i) {
          const { multipleValues: X } = O, se = X ? `received values of types ${[
            ...new Set(F.map((Q) => `\`${u(Q)}\``))
          ].join(", ")}` : `received value of type \`${u(F)}\``;
          throw new TypeError(`Expected value which is \`${z}\`, ${se}.`);
        }
      };
      e.assert = {
        undefined: (i) => x(u.undefined(i), "undefined", i),
        string: (i) => x(u.string(i), "string", i),
        number: (i) => x(u.number(i), "number", i),
        bigint: (i) => x(u.bigint(i), "bigint", i),
        function_: (i) => x(u.function_(i), "Function", i),
        null_: (i) => x(u.null_(i), "null", i),
        class_: (i) => x(u.class_(i), "Class", i),
        boolean: (i) => x(u.boolean(i), "boolean", i),
        symbol: (i) => x(u.symbol(i), "symbol", i),
        numericString: (i) => x(u.numericString(i), "string with a number", i),
        array: (i, z) => {
          x(u.array(i), "Array", i), z && i.forEach(z);
        },
        buffer: (i) => x(u.buffer(i), "Buffer", i),
        blob: (i) => x(u.blob(i), "Blob", i),
        nullOrUndefined: (i) => x(u.nullOrUndefined(i), "null or undefined", i),
        object: (i) => x(u.object(i), "Object", i),
        iterable: (i) => x(u.iterable(i), "Iterable", i),
        asyncIterable: (i) => x(u.asyncIterable(i), "AsyncIterable", i),
        generator: (i) => x(u.generator(i), "Generator", i),
        asyncGenerator: (i) => x(u.asyncGenerator(i), "AsyncGenerator", i),
        nativePromise: (i) => x(u.nativePromise(i), "native Promise", i),
        promise: (i) => x(u.promise(i), "Promise", i),
        generatorFunction: (i) => x(u.generatorFunction(i), "GeneratorFunction", i),
        asyncGeneratorFunction: (i) => x(u.asyncGeneratorFunction(i), "AsyncGeneratorFunction", i),
        asyncFunction: (i) => x(u.asyncFunction(i), "AsyncFunction", i),
        boundFunction: (i) => x(u.boundFunction(i), "Function", i),
        regExp: (i) => x(u.regExp(i), "RegExp", i),
        date: (i) => x(u.date(i), "Date", i),
        error: (i) => x(u.error(i), "Error", i),
        map: (i) => x(u.map(i), "Map", i),
        set: (i) => x(u.set(i), "Set", i),
        weakMap: (i) => x(u.weakMap(i), "WeakMap", i),
        weakSet: (i) => x(u.weakSet(i), "WeakSet", i),
        int8Array: (i) => x(u.int8Array(i), "Int8Array", i),
        uint8Array: (i) => x(u.uint8Array(i), "Uint8Array", i),
        uint8ClampedArray: (i) => x(u.uint8ClampedArray(i), "Uint8ClampedArray", i),
        int16Array: (i) => x(u.int16Array(i), "Int16Array", i),
        uint16Array: (i) => x(u.uint16Array(i), "Uint16Array", i),
        int32Array: (i) => x(u.int32Array(i), "Int32Array", i),
        uint32Array: (i) => x(u.uint32Array(i), "Uint32Array", i),
        float32Array: (i) => x(u.float32Array(i), "Float32Array", i),
        float64Array: (i) => x(u.float64Array(i), "Float64Array", i),
        bigInt64Array: (i) => x(u.bigInt64Array(i), "BigInt64Array", i),
        bigUint64Array: (i) => x(u.bigUint64Array(i), "BigUint64Array", i),
        arrayBuffer: (i) => x(u.arrayBuffer(i), "ArrayBuffer", i),
        sharedArrayBuffer: (i) => x(u.sharedArrayBuffer(i), "SharedArrayBuffer", i),
        dataView: (i) => x(u.dataView(i), "DataView", i),
        enumCase: (i, z) => x(u.enumCase(i, z), "EnumCase", i),
        urlInstance: (i) => x(u.urlInstance(i), "URL", i),
        urlString: (i) => x(u.urlString(i), "string with a URL", i),
        truthy: (i) => x(u.truthy(i), "truthy", i),
        falsy: (i) => x(u.falsy(i), "falsy", i),
        nan: (i) => x(u.nan(i), "NaN", i),
        primitive: (i) => x(u.primitive(i), "primitive", i),
        integer: (i) => x(u.integer(i), "integer", i),
        safeInteger: (i) => x(u.safeInteger(i), "integer", i),
        plainObject: (i) => x(u.plainObject(i), "plain object", i),
        typedArray: (i) => x(u.typedArray(i), "TypedArray", i),
        arrayLike: (i) => x(u.arrayLike(i), "array-like", i),
        domElement: (i) => x(u.domElement(i), "HTMLElement", i),
        observable: (i) => x(u.observable(i), "Observable", i),
        nodeStream: (i) => x(u.nodeStream(i), "Node.js Stream", i),
        infinite: (i) => x(u.infinite(i), "infinite number", i),
        emptyArray: (i) => x(u.emptyArray(i), "empty array", i),
        nonEmptyArray: (i) => x(u.nonEmptyArray(i), "non-empty array", i),
        emptyString: (i) => x(u.emptyString(i), "empty string", i),
        emptyStringOrWhitespace: (i) => x(u.emptyStringOrWhitespace(i), "empty string or whitespace", i),
        nonEmptyString: (i) => x(u.nonEmptyString(i), "non-empty string", i),
        nonEmptyStringAndNotWhitespace: (i) => x(u.nonEmptyStringAndNotWhitespace(i), "non-empty string and not whitespace", i),
        emptyObject: (i) => x(u.emptyObject(i), "empty object", i),
        nonEmptyObject: (i) => x(u.nonEmptyObject(i), "non-empty object", i),
        emptySet: (i) => x(u.emptySet(i), "empty set", i),
        nonEmptySet: (i) => x(u.nonEmptySet(i), "non-empty set", i),
        emptyMap: (i) => x(u.emptyMap(i), "empty map", i),
        nonEmptyMap: (i) => x(u.nonEmptyMap(i), "non-empty map", i),
        propertyKey: (i) => x(u.propertyKey(i), "PropertyKey", i),
        formData: (i) => x(u.formData(i), "FormData", i),
        urlSearchParams: (i) => x(u.urlSearchParams(i), "URLSearchParams", i),
        evenInteger: (i) => x(u.evenInteger(i), "even integer", i),
        oddInteger: (i) => x(u.oddInteger(i), "odd integer", i),
        directInstanceOf: (i, z) => x(u.directInstanceOf(i, z), "T", i),
        inRange: (i, z) => x(u.inRange(i, z), "in range", i),
        any: (i, ...z) => x(u.any(i, ...z), "predicate returns truthy for any value", z, {
          multipleValues: true
        }),
        all: (i, ...z) => x(u.all(i, ...z), "predicate returns truthy for all values", z, {
          multipleValues: true
        })
  ...
  const uo = {
    ...
    wink: zo,
    blush: xo,
    slightly_smiling_face: So,
    upside_down_face: Ao,
    relaxed: Mo,
    yum: To,
    relieved: qo,
    heart_eyes: jo,
    smiling_face_with_three_hearts: Do,
    kissing_heart: Bo,
    kissing: Co,
    kissing_smiling_eyes: Eo,
    kissing_closed_eyes: Io,
    stuck_out_tongue_winking_eye: No,
    zany: Ro,
    raised_eyebrow: Fo,
    monocle: Oo,
    stuck_out_tongue_closed_eyes: Ho,
    stuck_out_tongue: Po,
    money_mouth_face: Lo,
    nerd_face: Go,
    sunglasses: Uo,
    ...
    dizzy_face: R0,
    astonished: F0,
    zipper_mouth_face: O0,
    nauseated_face: H0,
    sneezing_face: P0,
    vomiting: L0,
    mask: G0,
    face_with_thermometer: U0,
    ...
    point_right: Rn,
    fu: Fn,
    raised_hand_with_fingers_splayed: On,
    love_you: Hn,
    metal: Pn,
    crossed_fingers: Ln,
    vulcan_salute: Gn,
    ...
    eyes: Qn,
    brain: ec,
    bust_in_silhouette: ac,
    busts_in_silhouette: tc,
    speaking_head: rc,
    baby: sc,
    child: oc,
    boy: nc,
    ...
    older_man: mc,
    older_woman: yc,
    man_with_gua_pi_mao: gc,
    woman_with_headscarf: kc,
    woman_with_turban: _c,
    man_with_turban: wc,
    policewoman: bc,
    policeman: vc,
    construction_worker_woman: zc,
    construction_worker_man: xc,
    guardswoman: Sc,
    guardsman: Ac,
    female_detective: Mc,
    male_detective: Tc,
    woman_health_worker: qc,
    man_health_worker: jc,
    woman_farmer: Dc,
    man_farmer: Bc,
    woman_cook: Cc,
    man_cook: Ec,
    ...
    woman_teacher: Oc,
    man_teacher: Hc,
    woman_factory_worker: Pc,
    man_factory_worker: Lc,
    woman_technologist: Gc,
    man_technologist: Uc,
    woman_office_worker: $c,
    man_office_worker: Vc,
    woman_mechanic: Xc,
    man_mechanic: Wc,
    woman_scientist: Yc,
    man_scientist: Zc,
    ...
    dancing_men: Pi,
    couple: Li,
    two_men_holding_hands: Gi,
    two_women_holding_hands: Ui,
    bowing_woman: $i,
    bowing_man: Vi,
    man_facepalming: Xi,
    woman_facepalming: Wi,
    woman_shrugging: Yi,
    man_shrugging: Zi,
    tipping_hand_woman: Ki,
    tipping_hand_man: Ji,
    no_good_woman: Qi,
    no_good_man: el,
    ok_woman: al,
    ok_man: tl,
    raising_hand_woman: rl,
    raising_hand_man: sl,
    pouting_woman: ol,
    pouting_man: nl,
    frowning_woman: cl,
    ...
    massage_woman: ul,
    massage_man: hl,
    woman_in_steamy_room: dl,
    man_in_steamy_room: pl,
    couple_with_heart_woman_man: ml,
    couple_with_heart_woman_woman: yl,
    couple_with_heart_man_man: gl,
    couplekiss_man_woman: kl,
    couplekiss_woman_woman: _l,
    couplekiss_man_man: wl,
    family_man_woman_boy: bl,
    family_man_woman_girl: vl,
    family_man_woman_girl_boy: zl,
    family_man_woman_boy_boy: xl,
    family_man_woman_girl_girl: Sl,
    family_woman_woman_boy: Al,
    family_woman_woman_girl: Ml,
    family_woman_woman_girl_boy: Tl,
    family_woman_woman_boy_boy: ql,
    family_woman_woman_girl_girl: jl,
    family_man_man_boy: Dl,
    family_man_man_girl: Bl,
    family_man_man_girl_boy: Cl,
    family_man_man_boy_boy: El,
    family_man_man_girl_girl: Il,
    family_woman_boy: Nl,
    family_woman_girl: Rl,
    family_woman_girl_boy: Fl,
    family_woman_boy_boy: Ol,
    family_woman_girl_girl: Hl,
    family_man_boy: Pl,
    family_man_girl: Ll,
    family_man_girl_boy: Gl,
    family_man_boy_boy: Ul,
    family_man_girl_girl: $l,
    yarn: Vl,
    thread: Xl,
    coat: Wl,
    labcoat: Yl,
    ...
    earth_asia: r1,
    full_moon: s1,
    waning_gibbous_moon: o1,
    last_quarter_moon: n1,
    waning_crescent_moon: c1,
    new_moon: i1,
    waxing_crescent_moon: l1,
    first_quarter_moon: f1,
    waxing_gibbous_moon: u1,
    new_moon_with_face: h1,
    full_moon_with_face: d1,
    first_quarter_moon_with_face: p1,
    last_quarter_moon_with_face: m1,
    sun_with_face: y1,
    crescent_moon: g1,
    star: k1,
    star2: _1,
    ...
    comet: v1,
    sunny: z1,
    sun_behind_small_cloud: x1,
    partly_sunny: S1,
    sun_behind_large_cloud: A1,
    sun_behind_rain_cloud: M1,
    cloud: T1,
    cloud_with_rain: q1,
    cloud_with_lightning_and_rain: j1,
    cloud_with_lightning: D1,
    zap: B1,
    fire: C1,
    boom: E1,
    snowflake: I1,
    ...
    women_wrestling: pm,
    men_wrestling: mm,
    woman_cartwheeling: ym,
    man_cartwheeling: gm,
    woman_playing_handball: km,
    man_playing_handball: _m,
    ice_skate: wm,
    curling_stone: bm,
    skateboard: vm,
    sled: zm,
    bow_and_arrow: xm,
    fishing_pole_and_fish: Sm,
    boxing_glove: Am,
    martial_arts_uniform: Mm,
    rowing_woman: Tm,
    rowing_man: qm,
    climbing_woman: jm,
    climbing_man: Dm,
    swimming_woman: Bm,
    swimming_man: Cm,
    woman_playing_water_polo: Em,
    man_playing_water_polo: Im,
    woman_in_lotus_position: Nm,
    man_in_lotus_position: Rm,
    surfing_woman: Fm,
    surfing_man: Om,
    bath: Hm,
    basketball_woman: Pm,
    basketball_man: Lm,
    weight_lifting_woman: Gm,
    weight_lifting_man: Um,
    biking_woman: $m,
    biking_man: Vm,
    mountain_biking_woman: Xm,
    mountain_biking_man: Wm,
    horse_racing: Ym,
    business_suit_levitating: Zm,
    trophy: Km,
    running_shirt_with_sash: Jm,
    medal_sports: Qm,
    medal_military: ey,
    "1st_place_medal": {
      keywords: [
    ...
    motor_scooter: Uy,
    rotating_light: $y,
    oncoming_police_car: Vy,
    oncoming_bus: Xy,
    oncoming_automobile: Wy,
    oncoming_taxi: Yy,
    aerial_tramway: Zy,
    mountain_cableway: Ky,
    suspension_railway: Jy,
    railway_car: Qy,
    train: e4,
    monorail: a4,
    bullettrain_side: t4,
    bullettrain_front: r4,
    light_rail: s4,
    mountain_railway: o4,
    steam_locomotive: n4,
    train2: c4,
    ...
    japanese_castle: yg,
    stadium: gg,
    statue_of_liberty: kg,
    house: _g,
    house_with_garden: wg,
    derelict_house: bg,
    office: vg,
    department_store: zg,
    post_office: xg,
    european_post_office: Sg,
    hospital: Ag,
    bank: Mg,
    hotel: Tg,
    convenience_store: qg,
    school: jg,
    love_hotel: Dg,
    wedding: Bg,
    classical_building: Cg,
    church: Eg,
    mosque: Ig,
    synagogue: Ng,
    kaaba: Rg,
    ...
    film_projector: o2,
    film_strip: n2,
    telephone_receiver: c2,
    phone: i2,
    pager: l2,
    fax: f2,
    tv: u2,
    radio: h2,
    studio_microphone: d2,
    level_slider: p2,
    control_knobs: m2,
    compass: y2,
    stopwatch: g2,
    timer_clock: k2,
    alarm_clock: _2,
    mantelpiece_clock: w2,
    hourglass_flowing_sand: b2,
    hourglass: v2,
    satellite: z2,
    battery: x2,
    electric_plug: S2,
    ...
    red_envelope: n5,
    email: c5,
    envelope_with_arrow: i5,
    incoming_envelope: l5,
    "e-mail": {
      keywords: [
        "communication",
        "inbox"
    ...
    mailbox_closed: h5,
    mailbox: d5,
    mailbox_with_mail: p5,
    mailbox_with_no_mail: m5,
    package: {
      keywords: [
        "mail",
        "gift",
    ...
    receipt: v5,
    bar_chart: z5,
    chart_with_upwards_trend: x5,
    chart_with_downwards_trend: S5,
    page_facing_up: A5,
    date: M5,
    calendar: T5,
    spiral_calendar: q5,
    ...
    blue_book: U5,
    orange_book: $5,
    notebook_with_decorative_cover: V5,
    ledger: X5,
    books: W5,
    open_book: Y5,
    safety_pin: Z5,
    ...
    pushpin: s3,
    round_pushpin: o3,
    triangular_flag_on_post: n3,
    white_flag: c3,
    black_flag: i3,
    rainbow_flag: l3,
    closed_lock_with_key: f3,
    lock: u3,
    unlock: h3,
    lock_with_ink_pen: d3,
    pen: p3,
    fountain_pen: m3,
    black_nib: y3,
    memo: g3,
    ...
    u55b6: b6,
    u6708: v6,
    eight_pointed_black_star: z6,
    vs: x6,
    accept: S6,
    white_flower: A6,
    ideograph_advantage: M6,
    secret: T6,
    congratulations: q6,
    u5408: j6,
    u6e80: D6,
    ...
    trident: n7,
    fleur_de_lis: c7,
    part_alternation_mark: i7,
    warning: l7,
    children_crossing: f7,
    beginner: u7,
    recycle: h7,
    u6307: d7,
    chart: p7,
    sparkle: m7,
    eight_spoked_asterisk: y7,
    negative_squared_cross_mark: g7,
    white_check_mark: k7,
    diamond_shape_with_a_dot_inside: _7,
    cyclone: w7,
    loop: b7,
    globe_with_meridians: v7,
    m: z7,
    atm: x7,
    sa: S7,
    passport_control: A7,
    ...
    arrow_forward: c_,
    pause_button: i_,
    next_track_button: l_,
    stop_button: f_,
    record_button: u_,
    play_or_pause_button: h_,
    previous_track_button: d_,
    fast_forward: p_,
    rewind: m_,
    twisted_rightwards_arrows: y_,
    repeat: g_,
    repeat_one: k_,
    arrow_backward: __,
    arrow_up_small: w_,
    arrow_down_small: b_,
    arrow_double_up: v_,
    arrow_double_down: z_,
    arrow_right: x_,
    arrow_left: S_,
    arrow_up: A_,
    arrow_down: M_,
    arrow_upper_right: T_,
    arrow_lower_right: q_,
    arrow_lower_left: j_,
    arrow_upper_left: D_,
    arrow_up_down: B_,
    left_right_arrow: C_,
    arrows_counterclockwise: E_,
    arrow_right_hook: I_,
    leftwards_arrow_with_hook: N_,
    arrow_heading_up: R_,
    arrow_heading_down: F_,
    hash: O_,
    information_source: H_,
    abc: P_,
    abcd: L_,
    capital_abcd: G_,
    symbols: U_,
    ...
    heavy_plus_sign: K_,
    heavy_minus_sign: J_,
    heavy_division_sign: Q_,
    heavy_multiplication_x: e8,
    infinity: a8,
    heavy_dollar_sign: t8,
    currency_exchange: r8,
    copyright: s8,
    registered: o8,
    tm: n8,
    end: c8,
    ...
    top: f8,
    soon: u8,
    ballot_box_with_check: h8,
    radio_button: d8,
    white_circle: p8,
    black_circle: m8,
    red_circle: y8,
    large_blue_circle: g8,
    small_orange_diamond: k8,
    small_blue_diamond: _8,
    large_orange_diamond: w8,
    large_blue_diamond: b8,
    small_red_triangle: v8,
    black_small_square: z8,
    white_small_square: x8,
    black_large_square: S8,
    white_large_square: A8,
    small_red_triangle_down: M8,
    black_medium_square: T8,
    white_medium_square: q8,
    black_medium_small_square: j8,
    white_medium_small_square: D8,
    black_square_button: B8,
    white_square_button: C8,
    speaker: E8,
    sound: I8,
    loud_sound: N8,
    mute: R8,
    ...
    hearts: V8,
    diamonds: X8,
    flower_playing_cards: W8,
    thought_balloon: Y8,
    right_anger_bubble: Z8,
    speech_balloon: K8,
    left_speech_bubble: J8,
    clock1: Q8,
    clock2: ew,
    clock3: aw,
    clock4: tw,
    ...
    bhutan: Ww,
    bolivia: Yw,
    caribbean_netherlands: Zw,
    bosnia_herzegovina: Kw,
    botswana: Jw,
    brazil: Qw,
    british_indian_ocean_territory: eb,
    british_virgin_islands: ab,
    brunei: tb,
    bulgaria: rb,
    burkina_faso: sb,
    burundi: ob,
    ...
    djibouti: jb,
    dominica: Db,
    dominican_republic: Bb,
    ecuador: Cb,
    egypt: Eb,
    el_salvador: Ib,
    equatorial_guinea: Nb,
    eritrea: Rb,
    estonia: Fb,
    ethiopia: Ob,
    eu: Hb,
    ...
    french_guiana: Vb,
    french_polynesia: Xb,
    french_southern_territories: Wb,
    gabon: Yb,
    gambia: Zb,
    georgia: Kb,
    de: Jb,
    ...
    niue: vv,
    norfolk_island: zv,
    northern_mariana_islands: xv,
    north_korea: Sv,
    norway: Av,
    oman: Mv,
    pakistan: Tv,
    palau: qv,
    palestinian_territories: jv,
    panama: Dv,
    papua_new_guinea: Bv,
    paraguay: Cv,
    peru: Ev,
    ...
    st_kitts_nevis: Xv,
    st_lucia: Wv,
    st_pierre_miquelon: Yv,
    st_vincent_grenadines: Zv,
    samoa: Kv,
    san_marino: Jv,
    sao_tome_principe: Qv,
    saudi_arabia: ez,
    senegal: az,
    serbia: tz,
    seychelles: rz,
    ...
    somalia: fz,
    south_africa: uz,
    south_georgia_south_sandwich_islands: hz,
    kr: dz,
    south_sudan: pz,
    es: mz,
    sri_lanka: yz,
    ...
    tr: Cz,
    turkmenistan: Ez,
    turks_caicos_islands: Iz,
    tuvalu: Nz,
    uganda: Rz,
    ukraine: Fz,
    united_arab_emirates: Oz,
    uk: Hz,
    england: Pz,
    scotland: Lz,
    wales: Gz,
  ...
  function fx() {
    return ir || (ir = 1, at = () => {
      const t = "\\ud800-\\udfff", l = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\u1ab0-\\u1aff\\u1dc0-\\u1dff", h = "\\ufe0e\\ufe0f", d = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, g = `[${l}]`, _ = "\\ud83c[\\udffb-\\udfff]", u = `(?:${g}|${_})`, b = `[^${t}]`, S = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", v = "[\\ud800-\\udbff][\\udc00-\\udfff]", B = "\\u200d", C = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", A = `[${d}]`, R = `${u}?`, N = `[${h}]?`, x = `(?:${B}(?:${[
        b,
        S,
        v
      ].join("|")})${N + R})*`, i = N + R + x, F = `(?:${[
  ...
  var Vr = Object.entries(lx.lib).map(([t, { char: e }]) => [
    t,
    e
  ]), gx = new Map(Vr);
  new Map(Vr.map(([t, e]) => [
  ...
  var kx = (t) => (fo.assert.string(t), gx.get(yx(t)));
  const va = [
    {
  ...
  ], _x = /:\+1:|:-1:|:[\w-]+:/g, wx = /(^|\s)[@$|*'",;.=:\-)([\]\\/<>038BOopPsSdDxXzZ]{2,5}/g, bx = /(?:_|-(?!1))/g, vx = {
    padSpaceAfter: false,
    emoticon: false,
    accessible: false
  }, zx = (t) => {
    const e = Object.assign({}, vx, t), a = !!e.padSpaceAfter, r = !!e.emoticon, s = !!e.accessible;
    function n(g, _) {
      return {
        type: "text",
        value: g,
    ...
    function l(g) {
      const _ = va.find((N) => N.emoticons.includes(g)), u = va.find((N) => N.emoticons.includes(g.slice(0, -1))), b = va.find((N) => N.emoticons.includes(g.slice(1))), S = va.find((N) => N.emoticons.includes(g.slice(1, -1))), v = _ || u || b || S;
      if (!v) return false;
      const B = !(_ || b) && (S || u) ? g.slice(-1) : "", C = !(_ || u) && (S || b) ? g.slice(0, 1) : "", A = a ? " " : "", R = C + v.emoji + A + B;
    ...
    function h(g) {
      ...
      if (a && (_ = _ + " "), s) {
        const u = g.slice(1, -1).replace(bx, " ") + " emoji";
        return n(_, u);
      }
      return _;
    }
...
`,
    ...
    function a(n, l, h, d) {
      const m = n.value || "", g = h.createTracker(d), _ = "$".repeat(Math.max(eo(m, "$") + 1, 2)), u = h.enter("mathFlow");
      let b = g.move(_);
      if (n.meta) {
        const S = h.enter("mathFlowMeta");
        b += g.move(h.safe(n.meta, {
          after: `
`,
          before: b,
          encode: [
...
`)), b += g.move(_), u(), b;
    ...
    function r(n, l, h) {
      ...
      /[^ \r\n]/.test(d) && (/^[ \r\n]/.test(d) && /[ \r\n]$/.test(d) || /^\$|\$$/.test(d)) && (d = " " + d + " ");
      let _ = -1;
      for (; ++_ < h.unsafe.length; ) {
        const u = h.unsafe[_];
        if (!u.atBreak) continue;
        const b = h.compilePattern(u);
        let S;
        for (; S = b.exec(d); ) {
          let v = S.index;
  ...
  function Mx(t, e, a) {
    ...
    function _(A) {
      return t.exit("mathFlowFence"), r.interrupt ? e(A) : t.attempt(lr, u, B)(A);
    }
    function u(A) {
      return t.attempt({
        tokenize: C,
    ...
    function S(A) {
      return A === null ? B(A) : Ve(A) ? t.attempt(lr, u, B)(A) : (t.enter("mathFlowValue"), v(A));
    }
    function v(A) {
  ...
  function qx(t) {
    ...
    function r(s, n, l) {
      ...
      function _(v) {
        return v === 36 ? (s.consume(v), h++, _) : h < 2 && !a ? l(v) : (s.exit("mathTextSequence"), u(v));
      }
      function u(v) {
        return v === null ? l(v) : v === 36 ? (m = s.enter("mathTextSequence"), d = 0, S(v)) : v === 32 ? (s.enter("space"), s.consume(v), s.exit("space"), u) : Ve(v) ? (s.enter("lineEnding"), s.consume(v), s.exit("lineEnding"), u) : (s.enter("mathTextData"), b(v));
      }
      function b(v) {
        return v === null || v === 32 || v === 36 || Ve(v) ? (s.exit("mathTextData"), u(v)) : (s.consume(v), b);
      }
      function S(v) {
        return v === 36 ? (s.consume(v), d++, S) : d === h ? (s.exit("mathTextSequence"), s.exit("mathText"), n(v)) : (m.type = "mathTextData", b(v));
      }
    }
  }
  function jx(t) {
  ...
  class q extends Error {
    constructor(e, a) {
      ...
      if (l && l.start <= l.end) {
        var h = l.lexer.input;
        s = l.start, n = l.end, s === h.length ? r += " at end of input: " : r += " at position " + (s + 1) + ": ";
        var d = h.slice(s, n).replace(/[^]/g, "$&\u0332"), m;
        s > 15 ? m = "\u2026" + h.slice(s - 15, s) : m = h.slice(0, s);
        var g;
        n + 15 < h.length ? g = h.slice(n, n + 15) + "\u2026" : g = h.slice(n), r += m + d + g;
      }
  ...
  var Cx = /([A-Z])/g, Bt = (t) => t.replace(Cx, "-$1").toLowerCase(), Ex = {
    "&": "&amp;",
    ">": "&gt;",
    "<": "&lt;",
    '"': "&quot;",
    "'": "&#x27;"
  }, Ix = /[&><"']/g, oe = (t) => String(t).replace(Ix, (e) => Ex[e]), Ba = (t) => t.type === "ordgroup" || t.type === "color" ? t.body.length === 1 ? Ba(t.body[0]) : t : t.type === "font" ? Ba(t.body) : t, Nx = /* @__PURE__ */ new Set([
    "mathord",
    "textord",
    "atom"
  ]), qe = (t) => Nx.has(Ba(t).type), Rx = (t) => {
  ...
  class Ct {
    constructor(e) {
      ...
      for (var a of Object.keys(kt)) {
        var r = kt[a], s = e[a];
        this[a] = s !== void 0 ? r.processor ? r.processor(s) : s : Fx(r);
      }
    }
  ...
  var Et = 0, Ea = 1, Qe = 2, Me = 3, ua = 4, ye = 5, ea = 6, ie = 7, we = [
    new Ie(Et, 0, false),
    new Ie(Ea, 0, true),
    new Ie(Qe, 1, false),
    new Ie(Me, 1, true),
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`;
  ...
  var wt = {
    ...
    return typeof e != "string" && (e = e.unit), e in wt || e in tS || e === "ex";
  }, K = function(e, a) {
    var r;
    ...
    return a;
  }, rS = /[\s"'>/=\x00-\x1f]/, Kr = function(e) {
    var a = "<" + e;
    this.classes.length && (a += ' class="' + oe(Fe(this.classes)) + '"');
    var r = "";
    for (var s of Object.keys(this.style)) r += Bt(s) + ":" + this.style[s] + ";";
    r && (a += ' style="' + oe(r) + '"');
    for (var n of Object.keys(this.attributes)) {
      if (rS.test(n)) throw new q("Invalid attribute name '" + n + "'");
  ...
  class sa {
    constructor(e, a, r, s) {
      Yr.call(this, e, r, s), this.children = a || [];
    }
    setAttribute(e, a) {
      this.attributes[e] = a;
    }
  ...
  class Oa {
    constructor(e, a, r, s) {
      Yr.call(this, a, s), this.children = r || [], this.setAttribute("href", e);
    }
    setAttribute(e, a) {
      this.attributes[e] = a;
    }
  ...
  class sS {
    ...
    toMarkup() {
      ...
      for (var r of Object.keys(this.style)) a += Bt(r) + ":" + this.style[r] + ";";
  ...
  class de {
    constructor(e, a, r, s, n, l, h, d) {
      this.text = e, this.height = a || 0, this.depth = r || 0, this.italic = s || 0, this.skew = n || 0, this.width = l || 0, this.classes = h || [], this.style = d || {}, this.maxFontSize = 0;
      var m = $x(this.text.charCodeAt(0));
      m && this.classes.push(m + "_fallback"), /[îïíì]/.test(this.text) && (this.text = oS[this.text]);
    }
    hasClass(e) {
      return this.classes.includes(e);
    }
  ...
  class Oe {
    ...
    toNode() {
      ...
      return this.alternate ? a.setAttribute("d", this.alternate) : a.setAttribute("d", fr[this.pathName]), a;
    }
    toMarkup() {
      return this.alternate ? '<path d="' + oe(this.alternate) + '"/>' : '<path d="' + oe(fr[this.pathName]) + '"/>';
    }
  }
  class bt {
    constructor(e) {
  ...
  var iS = (t) => t instanceof sa || t instanceof Oa || t instanceof ra, be = {
    "AMS-Regular": {
      32: [
        0,
        0,
  ...
  function It(t, e, a) {
    ...
    if (!s && t[0] in ur && (r = ur[t[0]].charCodeAt(0), s = be[e][r]), !s && a === "text" && Xr(r) && (s = be[e][77]), s) return {
      depth: s[0],
      height: s[1],
      italic: s[2],
      skew: s[3],
  ...
  o(M, y, w, "\u2720", "\\maltese");
  var hr = '0123456789/@."';
  for (var rt = 0; rt < hr.length; rt++) {
    var dr = hr.charAt(rt);
    o(c, f, w, dr, dr);
  }
  var pr = '0123456789!@*()-=+";:?/.,';
  for (var st = 0; st < pr.length; st++) {
    var mr = pr.charAt(st);
    o(M, f, w, mr, mr);
  }
  ...
  var Aa = [
    ...
    var l = Pa(e, a, r), h = l.metrics;
    e = l.value;
    var d;
    if (h) {
      var m = h.italic;
      (r === "text" || s && s.font === "mathit") && (m = 0), d = new de(e, h.height, h.depth, m, h.skew, h.width, n);
    ...
    var s = e.mode, n = e.text, l = [
      "mord"
    ], h = s === "math" || s === "text" && a.font, d = h ? a.font : a.fontFamily, m = "", g = "";
    if (n.charCodeAt(0) === 55349 && ([m, g] = dS(n, s)), m.length > 0) return ce(n, m, s, a, l.concat(g));
    if (d) {
      var _, u;
      if (d === "boldsymbol") {
        var b = pS(n, s, a, l, r);
      ...
      } else h ? (_ = zt[d].fontName, u = [
        d
      ]) : (_ = Ma(d, a.fontWeight, a.fontShape), u = [
        d,
        a.fontWeight,
        a.fontShape
      ]);
      if (Pa(n, _, s).metrics) return ce(n, _, s, a, l.concat(u));
      if (Jr.hasOwnProperty(n) && _.slice(0, 10) === "Typewriter") {
        for (var S = [], v = 0; v < n.length; v++) S.push(ce(n[v], _, s, a, l.concat(u)));
        return De(S);
      }
    }
    ...
    for (var e = 0; e < t.length - 1; e++) {
      var a = t[e], r = t[e + 1];
      a instanceof de && r instanceof de && mS(a, r) && (a.text += r.text, a.height = Math.max(a.height, r.height), a.depth = Math.max(a.depth, r.depth), a.italic = r.italic, t.splice(e + 1, 1), e--);
    }
    return t;
  }, Rt = function(e) {
    ...
    if (e.positionType === "individualShift") {
      for (var a = e.children, r = [
        ...
        var h = -a[l].shift - n - a[l].elem.depth, d = h - (a[l - 1].elem.height + a[l - 1].elem.depth);
        n = n + h, r.push({
          type: "kern",
          size: d
        }), r.push(a[l]);
    ...
    if (e.positionType === "top") {
      for (var g = e.positionData, _ = 0; _ < e.children.length; _++) {
        var u = e.children[_];
        g -= u.type === "kern" ? u.size : u.elem.height + u.elem.depth;
      }
      m = g;
    ...
    for (var { children: r, depth: s } = gS(e), n = 0, l = 0; l < r.length; l++) {
      var h = r[l];
      if (h.type === "elem") {
        var d = h.elem;
    ...
    m.style.height = D(n);
    for (var g = [], _ = s, u = s, b = s, S = 0; S < r.length; S++) {
      var v = r[S];
    ...
    return x.length === 2 && O.classes.push("vlist-t2"), O.height = u, O.depth = -_, O;
  }, es = (t, e) => {
    var a = T([
      "mspace"
    ], [], e), r = K(t, e);
    ...
    var [r, s, n] = as[e], l = new Oe(r), h = new Te([
      l
    ], {
      width: D(s),
      height: D(n),
  ...
  function E(t) {
    for (var { type: e, names: a, props: r, handler: s, htmlBuilder: n, mathmlBuilder: l } = t, h = {
      type: e,
      numArgs: r.numArgs,
      argTypes: r.argTypes,
  ...
  var Fa = function(e) {
    ...
    if (e.length === 1) {
      var g = e[0];
      g.type === "sizing" ? m = a.havingSize(g.size) : g.type === "styling" && (m = a.havingStyle(vS[g.style]));
    }
    var _ = T([
      s[0] || "leftmost"
    ], [], a), u = T([
    ...
    return xt(n, (S, v) => {
      ...
      B === "mbin" && bS.has(C) ? v.classes[0] = "mord" : C === "mbin" && wS.has(B) && (S.classes[0] = "mord");
    }, {
      node: _
    }, u, b), xt(n, (S, v) => {
      var B, C, A = At(v), R = At(S), N = A && R ? S.hasClass("mtight") ? (B = _S[A]) == null ? void 0 : B[R] : (C = kS[A]) == null ? void 0 : C[R] : null;
      if (N) return es(N, m);
    }, {
      node: _
    }, u, b), n;
    ...
    for (var l = 0; l < e.length; l++) {
      ...
      m ? r.node = h : n && h.hasClass("newline") && (r.node = T([
        "leftmost"
      ])), r.insertAfter = /* @__PURE__ */ ((_) => (u) => {
        e.splice(_ + 1, 0, u), l++;
      })(l);
    }
    s && e.pop();
  ...
  function Mt(t, e) {
    ...
    for (var n = [], l = [], h = 0; h < r.length; h++) if (l.push(r[h]), r[h].hasClass("mbin") || r[h].hasClass("mrel") || r[h].hasClass("allowbreak")) {
      for (var d = false; h < r.length - 1 && r[h + 1].hasClass("mspace") && !r[h + 1].hasClass("newline"); ) h++, l.push(r[h]), r[h].hasClass("nobreak") && (d = true);
      d || (n.push(Ta(l, e)), l = []);
    } else r[h].hasClass("newline") && (l.pop(), l.length > 0 && (n.push(Ta(l, e)), l = []), n.push(r[h]));
  ...
  var xS = /* @__PURE__ */ new Set([
    ...
    return W[a][e] && W[a][e].replace && e.charCodeAt(0) !== 55349 && !(Jr.hasOwnProperty(e) && r && (r.fontFamily && r.fontFamily.slice(4, 6) === "tt" || r.font && r.font.slice(4, 6) === "tt")) && (e = W[a][e].replace), new ae(e);
  }, Ft = function(e) {
    ...
    var n = e.text;
    if (xS.has(n)) return null;
    if (W[s][n]) {
      var l = W[s][n].replace;
      l && (n = l);
    }
    var h = zt[r].fontName;
    return It(n, h, s) ? zt[r].variant : null;
  };
  function ct(t) {
    if (!t) return false;
  ...
  function gr(t, e, a, r, s) {
    var n = me(t, a), l;
    n.length === 1 && n[0] instanceof j && SS.has(n[0].type) ? l = n[0] : l = new j("mrow", n);
    var h = new j("annotation", [
      new ae(e)
    ]);
  ...
  var AS = [
    ...
    return a.size < 2 ? e : AS[e - 1][a.size - 1];
  };
  class Ae {
    constructor(e) {
      this.style = e.style, this.color = e.color, this.size = e.size || Ae.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = kr[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0;
    }
    extend(e) {
      var a = {
        style: this.style,
    ...
    fontMetrics() {
      return this._fontMetrics || (this._fontMetrics = fS(this.size)), this._fontMetrics;
    }
    getColor() {
  ...
  var cs = function(e) {
    ...
    var s = cs(r), n;
    if (r.output === "mathml") return gr(e, a, s, r.displayMode, true);
    if (r.output === "html") {
      var l = Mt(e, s);
      n = T([
        "katex"
      ...
      var h = gr(e, a, s, r.displayMode, false), d = Mt(e, s);
      n = T([
        "katex"
      ], [
        h,
    ...
    function r() {
      ...
      if (DS.has(d)) {
        var m = e, g = m.base.type === "ordgroup" ? m.base.body.length : 1, _, u, b;
        if (g > 5) d === "widehat" || d === "widecheck" ? (_ = 420, h = 2364, b = 0.42, u = d + "4") : (_ = 312, h = 2340, b = 0.34, u = "tilde4");
        else {
          var S = [
            1,
            1,
        ...
        var C = [], A = jS[d], [R, N, x] = A, i = x / 1e3, z = R.length, F, O;
        if (z === 1) {
          var X = A[3];
          F = [
            "hide-tail"
  ...
  }, BS = function(e, a, r, s, n) {
    var l, h = e.height + e.depth + r + s;
    ...
    return l.height = h, l.style.height = D(h), l;
  };
  function G(t, e) {
  ...
  function Va(t) {
    return t && (t.type === "atom" || hS.hasOwnProperty(t.type)) ? t : null;
  }
  var ls = (t) => {
    if (t instanceof de) return t;
    if (iS(t) && t.children.length === 1) return ls(t.children[0]);
  }, Ht = (t, e) => {
    var a, r, s;
    t && t.type === "supsub" ? (r = G(t.base, "accent"), a = r.base, t.base = a, s = cS($(t, e)), t.base = r) : (r = G(t, "accent"), a = r.base);
    var n = $(a, e.havingCrampedStyle()), l = r.isShifty && qe(a), h = 0;
    if (l) {
      var d, m;
      h = (d = (m = ls(n)) == null ? void 0 : m.skew) != null ? d : 0;
    }
    var g = r.label === "\\c", _ = g ? n.height + n.depth : Math.min(n.height, e.fontMetrics().xHeight), u;
    if (r.isStretchy) u = Ua(r, e), u = U({
      ...
      var b, S;
      r.label === "\\vec" ? (b = ts("vec", e), S = as.vec[1]) : (b = La({
        mode: r.mode,
        text: r.label
      }, e, "textord"), b = nS(b), b.italic = 0, S = b.width, g && (_ += b.depth)), u = T([
        "accent-body"
      ], [
        b
      ]);
      var v = r.label === "\\textcircled";
      v && (u.classes.push("accent-full"), _ = n.height);
      var B = h;
      v || (B -= S / 2), u.style.left = D(B), r.label === "\\textcircled" && (u.style.top = ".2em"), u = U({
        positionType: "firstBaseline",
        children: [
          {
            type: "elem",
  ...
  E({
    ...
    handler: (t, e) => {
      var a = Fa(e[0]), r = !CS.test(t.funcName), s = !r || t.funcName === "\\widehat" || t.funcName === "\\widetilde" || t.funcName === "\\widecheck";
      return {
        type: "accent",
        mode: t.parser.mode,
        label: t.funcName,
  ...
  E({
    ...
    htmlBuilder(t, e) {
      ...
      var h = Ua(t, e), d = -e.fontMetrics().axisHeight + 0.5 * h.height, m = -e.fontMetrics().axisHeight - 0.5 * h.height - 0.111;
      (s.depth > 0.25 || t.label === "\\xleftequilibrium") && (m -= s.depth);
      var g;
      if (l) {
        var _ = -e.fontMetrics().axisHeight + l.height + 0.5 * h.height + 0.111;
        g = U({
  ...
  var ES = {
    ...
    mode: "math",
    style: "display"
  }), br = (t) => t.type === "textord" && t.text === "@", IS = (t, e) => (t.type === "mathord" || t.type === "atom") && t.text === e;
  function NS(t, e, a) {
    var r = ES[t];
    switch (r) {
      case "\\\\cdrightarrow":
  ...
  function RS(t) {
    ...
    for (var r = [], s = [
      ...
      for (var l = e[n], h = wr(), d = 0; d < l.length; d++) if (!br(l[d])) h.body.push(l[d]);
      else {
        r.push(h), d += 1;
        ...
        if (g[0] = {
          ...
          for (var u = true, b = d + 1; b < l.length; b++) {
            if (IS(l[b], m)) {
              u = false, d = b;
              break;
            }
            if (br(l[b])) throw new q("Missing a " + m + " character to complete a CD arrow.", l[b]);
            g[_].body.push(l[b]);
          }
          if (u) throw new q("Missing a " + m + " character to complete a CD arrow.", l[d]);
        }
      ...
      n % 2 === 0 ? r.push(h) : r.shift(), r = [], s.push(r);
    }
  ...
  E({
    ...
    handler(t) {
      var { parser: e, funcName: a } = t, r = ms(e.gullet.popToken());
      e.gullet.consumeSpaces();
      var s = FS(e);
      return ys(e, r, s, a === "\\\\globallet"), {
        type: "internal",
        mode: e.mode
      };
    }
  ...
  E({
    ...
    handler(t) {
      var { parser: e, funcName: a } = t, r = ms(e.gullet.popToken()), s = e.gullet.popToken(), n = e.gullet.popToken();
      return ys(e, r, n, a === "\\\\globalfuture"), e.gullet.pushToken(n), e.gullet.pushToken(s), {
        type: "internal",
        mode: e.mode
      };
    }
  ...
  var la = function(e, a, r) {
    var s = W.math[e] && W.math[e].replace, n = It(s || e, a, r);
    if (!n) throw new Error("Unsupported symbol " + e + " and font size " + a + ".");
    return n;
  }, Pt = function(e, a, r, s) {
    var n = r.havingBaseStyle(a), l = T(s.concat(n.sizingClasses(r)), [
      e
    ], r), h = n.sizeMultiplier / r.sizeMultiplier;
    return l.height *= h, l.depth *= h, l.maxFontSize = n.sizeMultiplier, l;
  }, gs = function(e, a, r) {
  ...
  }, OS = function(e, a, r, s, n, l) {
    var h = ce(e, "Main-Regular", n, s), d = Pt(h, a, s, l);
    return gs(d, s, a), d;
  }, HS = function(e, a, r, s) {
    return ce(e, "Size" + a + "-Regular", r, s);
  }, ks = function(e, a, r, s, n, l) {
    var h = HS(e, a, n, s), d = Pt(T([
      "delimsizing",
      "size" + a
    ], [
      h
    ], s), L.TEXT, s, l);
    return r && gs(d, s, L.TEXT), d;
  }, it = function(e, a, r) {
    var s;
    ...
    var s = be["Size4-Regular"][e.charCodeAt(0)] ? be["Size4-Regular"][e.charCodeAt(0)][4] : be["Size1-Regular"][e.charCodeAt(0)][4], n = new Oe("inner", eS(e, Math.round(1e3 * a))), l = new Te([
      n
    ], {
      width: D(s),
      height: D(a),
    ...
    return h.height = a, h.style.height = D(a), h.style.width = D(s), {
      type: "elem",
      elem: h
    };
  }, qt = 8e-3, ja = {
    ...
    h = m = g = e, d = null;
    var b = "Size1-Regular";
    e === "\\uparrow" ? m = g = "\u23D0" : e === "\\Uparrow" ? m = g = "\u2016" : e === "\\downarrow" ? h = m = "\u23D0" : e === "\\Downarrow" ? h = m = "\u2016" : e === "\\updownarrow" ? (h = "\\uparrow", m = "\u23D0", g = "\\downarrow") : e === "\\Updownarrow" ? (h = "\\Uparrow", m = "\u2016", g = "\\Downarrow") : PS.has(e) ? (m = "\u2223", _ = "vert", u = 333) : LS.has(e) ? (m = "\u2225", _ = "doublevert", u = 556) : e === "[" || e === "\\lbrack" ? (h = "\u23A1", m = "\u23A2", g = "\u23A3", b = "Size4-Regular", _ = "lbrack", u = 667) : e === "]" || e === "\\rbrack" ? (h = "\u23A4", m = "\u23A5", g = "\u23A6", b = "Size4-Regular", _ = "rbrack", u = 667) : e === "\\lfloor" || e === "\u230A" ? (m = h = "\u23A2", g = "\u23A3", b = "Size4-Regular", _ = "lfloor", u = 667) : e === "\\lceil" || e === "\u2308" ? (h = "\u23A1", m = g = "\u23A2", b = "Size4-Regular", _ = "lceil", u = 667) : e === "\\rfloor" || e === "\u230B" ? (m = h = "\u23A5", g = "\u23A6", b = "Size4-Regular", _ = "rfloor", u = 667) : e === "\\rceil" || e === "\u2309" ? (h = "\u23A4", m = g = "\u23A5", b = "Size4-Regular", _ = "rceil", u = 667) : e === "(" || e === "\\lparen" ? (h = "\u239B", m = "\u239C", g = "\u239D", b = "Size4-Regular", _ = "lparen", u = 875) : e === ")" || e === "\\rparen" ? (h = "\u239E", m = "\u239F", g = "\u23A0", b = "Size4-Regular", _ = "rparen", u = 875) : e === "\\{" || e === "\\lbrace" ? (h = "\u23A7", d = "\u23A8", g = "\u23A9", m = "\u23AA", b = "Size4-Regular") : e === "\\}" || e === "\\rbrace" ? (h = "\u23AB", d = "\u23AC", g = "\u23AD", m = "\u23AA", b = "Size4-Regular") : e === "\\lgroup" || e === "\u27EE" ? (h = "\u23A7", g = "\u23A9", m = "\u23AA", b = "Size4-Regular") : e === "\\rgroup" || e === "\u27EF" ? (h = "\u23AB", g = "\u23AD", m = "\u23AA", b = "Size4-Regular") : e === "\\lmoustache" || e === "\u23B0" ? (h = "\u23A7", g = "\u23AD", m = "\u23AA", b = "Size4-Regular") : (e === "\\rmoustache" || e === "\u23B1") && (h = "\u23AB", g = "\u23A9", m = "\u23AA", b = "Size4-Regular");
    var S = la(h, b, n), v = S.height + S.depth, B = la(m, b, n), C = B.height + B.depth, A = la(g, b, n), R = A.height + A.depth, N = 0, x = 1;
    if (d !== null) {
      var i = la(d, b, n);
    ...
    var se = O / 2 - X, Q = [];
    if (_.length > 0) {
      var Ge = O - v - R, fe = Math.round(O * 1e3), ke = aS(_, Math.round(Ge * 1e3)), Be = new Oe(_, ke), We = (u / 1e3).toFixed(3) + "em", Ye = (fe / 1e3).toFixed(3) + "em", Ka = new Te([
        Be
      ], {
        width: We,
        height: Ye,
    ...
    var l = Qx(e, s, r), h = new Oe(e, l), d = new Te([
      h
    ], {
      width: "400em",
      height: D(a),
    ...
    var r = a.havingBaseSizing(), s = xs("\\surd", e * r.sizeMultiplier, zs, r), n = r.sizeMultiplier, l = Math.max(0, a.minRuleThickness - a.fontMetrics().sqrtRuleThickness), h, d = 0, m = 0, g = 0, _;
    return s.type === "small" ? (g = 1e3 + 1e3 * l + ft, e < 1 ? n = 1 : e < 1.4 && (n = 0.7), d = (1 + l + ut) / n, m = (1 + l) / n, h = ht("sqrtMain", d, g, l, a), h.style.minWidth = "0.853em", _ = 0.833 / n) : s.type === "large" ? (g = (1e3 + ft) * fa[s.size], m = (fa[s.size] + l) / n, d = (fa[s.size] + l + ut) / n, h = ht("sqrtSize" + s.size, d, g, l, a), h.style.minWidth = "1.02em", _ = 1 / n) : (d = e + l + ut, m = e + l, g = Math.floor(1e3 * e + l) + ft, h = ht("sqrtTall", d, g, l, a), h.style.minWidth = "0.742em", _ = 1.056), h.height = m, h.style.height = D(d), {
      span: h,
      advanceWidth: _,
    ...
    2.4,
    3
  ], vs = function(e, a, r, s, n) {
    if (e === "<" || e === "\\lt" || e === "\u27E8" ? e = "\\langle" : (e === ">" || e === "\\gt" || e === "\u27E9") && (e = "\\rangle"), ws.has(e) || bs.has(e)) return ks(e, a, false, r, s, n);
    if (US.has(e)) return _s(e, fa[a], false, r, s, n);
    ...
    for (var n = Math.min(2, 3 - s.style.size), l = n; l < r.length; l++) {
      ...
      var d = la(e, XS(h), "math"), m = d.height + d.depth;
      if (h.type === "small") {
        var g = s.havingBaseStyle(h.style);
        m *= g.sizeMultiplier;
      }
      if (m > a) return h;
    }
    ...
    var h;
    bs.has(e) ? h = $S : ws.has(e) ? h = zs : h = VS;
    var d = xs(e, a, h, s);
    return d.type === "small" ? OS(e, d.style, r, s, n, l) : d.type === "large" ? ks(e, d.size, r, s, n, l) : _s(e, a, r, s, n, l);
  }, dt = function(e, a, r, s, n, l) {
    var h = s.fontMetrics().axisHeight * s.sizeMultiplier, d = 901, m = 5 / s.fontMetrics().ptPerEm, g = Math.max(a - h, r + h), _ = Math.max(g / 500 * d, 2 * g - m);
  ...
  E({
    ...
    handler: (t, e) => {
      ...
      return {
        type: "delimsizing",
        mode: t.parser.mode,
        size: vr[t.funcName].size,
        mclass: vr[t.funcName].mclass,
        delim: a.text
      };
    },
    htmlBuilder: (t, e) => t.delim === "." ? T([
      t.mclass
    ]) : vs(t.delim, t.size, e, t.mode, [
      t.mclass
    ]),
    mathmlBuilder: (t) => {
      var e = [];
  ...
  E({
    ...
    htmlBuilder: (t, e) => {
      ...
      if (t.left === "." ? h = ha(e, [
        "mopen"
      ]) : h = dt(t.left, r, s, e, t.mode, [
        "mopen"
      ]), a.unshift(h), n) for (var d = 1; d < a.length; d++) {
  ...
  var Lt = (t, e) => {
    var a = ta($(t.body, e), e), r = t.label.slice(1), s = e.sizeMultiplier, n, l = 0, h = qe(t.body);
    if (r === "sout") n = T([
      "stretchy",
      "sout"
      ...
      var u = Math.floor(1e3 * _ * s), b = Kx(u), S = new Te([
        new Oe("phase", b)
      ], {
        width: "400em",
        height: D(u / 1e3),
    ...
    return /cancel/.test(r) && (A.height = a.height, A.depth = a.depth), /cancel/.test(r) && !h ? T([
      "mord",
      "cancel-lap"
    ], [
      A
  ...
  E({
    ...
    handler(t, e, a) {
      var { parser: r, funcName: s } = t, n = G(e[0], "color-token").color, l = G(e[1], "color-token").color, h = e[2];
      return {
        type: "enclose",
        mode: r.mode,
        label: s,
  ...
  function Le(t, e, a) {
    var { hskipBeforeAndAfter: r, addJot: s, cols: n, arraystretch: l, colSeparationType: h, autoTag: d, singleRow: m, emptySingleRow: g, maxNumCols: _, leqno: u } = e;
    ...
    for (R(), C.push(xr(t)); ; ) {
      ...
      if (z === "&") {
        if (_ && S.length === _) {
          if (m || h) throw new q("Too many tab characters: &", t.nextToken);
        ...
        t.consume();
        var F = void 0;
        t.gullet.future().text !== " " && (F = t.parseSizeGroup(true)), B.push(F ? F.value : null), N(), C.push(xr(t)), S = [], v.push(S), R();
  ...
  var ze = function(e, a) {
    var r, s, n = e.body.length, l = e.hLinesBeforeRow, h = 0, d = new Array(n), m = [], g = Math.max(a.fontMetrics().arrayRuleWidth, a.minRuleThickness), _ = 1 / a.fontMetrics().ptPerEm, u = 5 * _;
    if (e.colSeparationType && e.colSeparationType === "small") {
      var b = a.havingStyle(L.SCRIPT).sizeMultiplier;
      u = 0.2778 * (b / a.sizeMultiplier);
    }
    ...
    for (s = 0, Be = 0; s < h || Be < Ge.length; ++s, ++Be) {
      for (var ca, _e = Ge[Be], pa = true; ((Zt = _e) == null ? void 0 : Zt.type) === "separator"; ) {
        var Zt;
        if (pa || (ke = T([
          "arraycolsep"
        ], []), ke.style.width = D(a.fontMetrics().doubleRuleSep), fe.push(ke)), _e.separator === "|" || _e.separator === ":") {
          var $s = _e.separator === "|" ? "solid" : "dashed", Ze = T([
            "vertical-separator"
          ], [], a);
          Ze.style.height = D(R), Ze.style.borderRightWidth = D(g), Ze.style.borderRightStyle = $s, Ze.style.margin = "0 " + D(-g / 2);
          var Kt = R - Q;
          Kt && (Ze.style.verticalAlign = D(-Kt)), fe.push(Ze);
      ...
      if (!(s >= h)) {
        ...
        if (s > 0 || e.hskipBeforeAndAfter) {
          var Jt, Qt;
          Ke = (Jt = (Qt = _e) == null ? void 0 : Qt.pregap) != null ? Jt : u, Ke !== 0 && (ke = T([
            "arraycolsep"
        ...
        for (r = 0; r < n; ++r) {
          ...
          if (ya) {
            var Vs = ma.pos - Q;
            ya.depth = ma.depth, ya.height = ma.height, er.push({
              type: "elem",
              elem: ya,
              shift: Vs
            });
        ...
        if (fe.push(Ws), s < h - 1 || e.hskipBeforeAndAfter) {
          var ar, tr;
          Ke = (ar = (tr = _e) == null ? void 0 : tr.postgap) != null ? ar : u, Ke !== 0 && (ke = T([
            "arraycolsep"
          ], []), ke.style.width = D(Ke), fe.push(ke));
        }
      }
    ...
    if (m.length > 0) {
      for (var Ys = aa("hline", a, g), Zs = aa("hdashline", a, g), Ja = [
        {
          type: "elem",
          elem: ga,
          shift: 0
    ...
    for (var r = [], s = new j("mtd", [], [
      ...
      for (var h = e.body[l], d = [], m = 0; m < h.length; m++) d.push(new j("mtd", [
        V(h[m], a)
      ]));
    ...
    if (e.cols && e.cols.length > 0) {
      ...
      S[0].type === "separator" && (u += "top ", C = 1), S[S.length - 1].type === "separator" && (u += "bottom ", A -= 1);
      for (var R = C; R < A; R++) {
        var N = S[R];
        N.type === "align" ? (b += ZS[N.align], B && (v += "none "), B = true) : N.type === "separator" && B && (v += N.separator === "|" ? "solid " : "dashed ", B = false);
      }
    ...
    u += O[0].length > 0 ? "left " : "", u += O[O.length - 1].length > 0 ? "right " : "";
    for (var X = 1; X < O.length - 1; X++) F += O[X].length === 0 ? "none " : O[X][0] ? "dashed " : "solid ";
    return /[sd]/.test(F) && g.setAttribute("rowlines", F.trim()), u !== "" && (g = new j("menclose", [
      g
    ]), g.setAttribute("notation", u.trim())), e.arraystretch && e.arraystretch < 1 && (g = new j("mstyle", [
      g
    ...
    l.body.forEach(function(C) {
      ...
      if (b) d < C.length && (d = C.length);
        ...
        var x = C.length / 2;
        if (h < x) throw new q("Too many math in a row: " + ("expected " + h + ", but got " + x), C[0]);
      }
    });
    for (var S = 0; S < d; ++S) {
      var v = "r", B = 0;
  ...
  ve({
    ...
    handler(t, e) {
      ...
      return Le(t.parser, n, $t(t.envName));
    },
    htmlBuilder: ze,
    mathmlBuilder: xe
  });
  ve({
    ...
    handler(t) {
      ...
      var n = Le(t.parser, r, $t(t.envName)), l = Math.max(0, ...n.body.map((h) => h.length));
  ...
  ve({
    ...
    handler(t, e) {
      var a = Va(e[0]), r = a ? [
        e[0]
      ] : G(e[0], "ordgroup").body, s = r.map(function(h) {
        var d = $a(h), m = d.text;
        if ("lc".includes(m)) return {
          type: "align",
          align: m
        };
        throw new q("Unknown column alignment: " + m, h);
      });
  ...
  E({
    ...
    handler(t, e) {
      ...
      if (r === "\\begin") {
        if (!Sr.hasOwnProperty(n)) throw new q("No such environment: " + n, s);
        var h = Sr[n], { args: d, optArgs: m } = a.parseArguments("\\begin{" + n + "}", h), g = {
          mode: a.mode,
          envName: n,
          parser: a
        }, _ = h.handler(g, d, m);
        a.expect("\\end", false);
        var u = a.nextToken, b = G(a.parseFunction(), "environment");
        if (b.name !== n) throw new q("Mismatch: \\begin{" + n + "} matched by \\end{" + b.name + "}", u);
        return _;
      }
      return {
        type: "environment",
  ...
  E({
    ...
    handler: (t, e) => {
      var { parser: a, funcName: r, breakOnTokenText: s } = t, { mode: n } = a, l = a.parseExpression(true, s), h = "math" + r.slice(1);
      return {
        type: "font",
        mode: n,
        font: h,
  ...
  var KS = (t, e) => {
    ...
    var l = $(t.numer, n, e);
    if (t.continued) {
      var h = 8.5 / e.fontMetrics().ptPerEm, d = 3.5 / e.fontMetrics().ptPerEm;
      l.height = l.height < h ? h : l.height, l.depth = l.depth < d ? d : l.depth;
    }
    n = e.havingStyle(s);
    var m = $(t.denom, n, e), g, _, u;
    t.hasBarLine ? (t.barSize ? (_ = K(t.barSize, e), g = aa("frac-line", e, _)) : g = aa("frac-line", e), _ = g.height, u = g.height) : (g = null, _ = 0, u = e.fontMetrics().defaultRuleThickness);
    var b, S, v;
    a.size === L.DISPLAY.size ? (b = e.fontMetrics().num1, _ > 0 ? S = 3 * u : S = 7 * u, v = e.fontMetrics().denom1) : (_ > 0 ? (b = e.fontMetrics().num2, S = u) : (b = e.fontMetrics().num3, S = 3 * u), v = e.fontMetrics().denom2);
    var B;
    if (g) {
  ...
  E({
    ...
    handler: (t, e) => {
      var { parser: a, funcName: r } = t, s = e[0], n = e[1], l, h = null, d = null;
      switch (r) {
        case "\\cfrac":
        case "\\dfrac":
        case "\\frac":
      ...
      return m || r.startsWith("\\d") ? g = "display" : r.startsWith("\\t") && (g = "text"), js({
        type: "genfrac",
        mode: a.mode,
        numer: s,
        denom: n,
  ...
  E({
    ...
    handler(t, e) {
      var { parser: a } = t, r = e[4], s = e[5], n = Fa(e[0]), l = n.type === "atom" && n.family === "open" ? Tr(n.text) : null, h = Fa(e[1]), d = h.type === "atom" && h.family === "close" ? Tr(h.text) : null, m = G(e[2], "size"), g, _ = null;
      ...
      } else b = G(b, "textord"), u = Mr[Number(b.text)];
      return js({
        type: "genfrac",
        mode: a.mode,
        numer: r,
  ...
  var Ds = (t, e) => {
    ...
    var n = $(s.base, e.havingBaseStyle(L.DISPLAY)), l = Ua(s, e), h;
    if (s.isOver ? (h = U({
      positionType: "firstBaseline",
      children: [
        {
    ...
    }), h.children[0].children[0].children[1].classes.push("svg-align")) : (h = U({
      positionType: "bottom",
    ...
    }), h.children[0].children[0].children[0].classes.push("svg-align")), r) {
      var d = T([
        "mord",
      ...
      switch (r) {
        ...
        case "\\htmlData": {
          for (var m = n.split(","), g = 0; g < m.length; g++) {
            var _ = m[g], u = _.indexOf("=");
            if (u < 0) throw new q("\\htmlData key/value '" + _ + "' missing equals sign");
            var b = _.slice(0, u), S = _.slice(u + 1);
            d["data-" + b.trim()] = S;
          }
          h = {
            command: "\\htmlData",
  ...
  var pt = function(e) {
    ...
    if (!Wr(r)) throw new q("Invalid unit: '" + r.unit + "' in \\includegraphics.");
    return r;
  };
  E({
    ...
    handler: (t, e, a) => {
      ...
      var b = G(e[0], "url").url;
      return h === "" && (h = b, h = h.replace(/^.*[\\/]/, ""), h = h.substring(0, h.lastIndexOf("."))), r.settings.isTrusted({
  ...
  var Bs = (t, e, a, r, s, n, l) => {
    ...
    var l = e.style, h = false;
    l.size === L.DISPLAY.size && n.symbol && !Cs.has(n.name) && (h = true);
    var d;
    if (n.symbol) {
      var m = h ? "Size2-Regular" : "Size1-Regular", g = "";
      if ((n.name === "\\oiint" || n.name === "\\oiiint") && (g = n.name.slice(1), n.name = g === "oiint" ? "\\iint" : "\\iiint"), d = ce(n.name, m, "math", e, [
        "mop",
        "op-symbol",
        h ? "large-op" : "small-op"
      ]), g.length > 0) {
        var _ = d.italic, u = ts(g + "Size" + (h ? "2" : "1"), e);
        d = U({
          positionType: "individualShift",
          children: [
            {
      ...
      for (var S = [], v = 1; v < n.name.length; v++) S.push(Nt(n.name[v], n.mode, e));
      d = T([
        "mop"
      ], S, e);
    }
    var B = 0, C = 0;
    return (d instanceof de || n.name === "\\oiint" || n.name === "\\oiiint") && !n.suppressBaseShift && (B = (d.height - d.depth) / 2 - e.fontMetrics().axisHeight, C = d.italic || 0), s ? Bs(d, a, r, e, l, C, B) : (B && (d.style.position = "relative", d.style.top = D(B)), d);
  }, da = (t, e) => {
    var a;
    if (t.symbol) a = new j("mo", [
      ge(t.name, t.mode)
    ]), Cs.has(t.name) && a.setAttribute("largeop", "false");
  ...
  var Es = (t, e) => {
    ...
    var l;
    if (n.body.length > 0) {
      for (var h = n.body.map((_) => {
        var u = "text" in _ ? _.text : void 0;
        return typeof u == "string" ? {
          type: "textord",
          mode: _.mode,
          text: u
        } : _;
      }), d = re(h, e.withFont("mathrm"), true), m = 0; m < d.length; m++) {
        var g = d[m];
    ...
    return s ? Bs(l, a, r, e, e.style, 0, 0) : l;
  }, tA = (t, e) => {
    for (var a = me(t.body, e.withFont("mathrm")), r = true, s = 0; s < a.length; s++) {
      var n = a[s];
      if (!(n instanceof ns)) if (n instanceof j) switch (n.type) {
        case "mi":
        case "mn":
        case "mspace":
        case "mtext":
  ...
  E({
    ...
    mathmlBuilder(t, e) {
      ...
      return s >= 0 ? h.setAttribute("height", D(s)) : (h.setAttribute("height", D(s)), h.setAttribute("depth", D(-s))), h.setAttribute("voffset", D(s)), h;
    }
  });
  function Is(t, e, a) {
  ...
  E({
    ...
    handler: (t, e, a) => {
      ...
      if (l) for (var h = "", d = 0; d < l.body.length; ++d) {
        var m = l.body[d];
        if (h = $a(m).text, h === "t") s = true;
        else if (h === "b") n = true;
        else {
          s = false, n = false;
          break;
  ...
  E({
    ...
    htmlBuilder(t, e) {
      ...
      var l = s + n / 4, h = a.height + a.depth + l + s, { span: d, ruleWidth: m, advanceWidth: g } = GS(h, e), _ = d.height - m;
      _ > a.height + a.depth + l && (l = (l + _ - a.height - a.depth) / 2);
      var u = d.height - a.height - l - m;
  ...
  E({
    ...
    htmlBuilder(t, e) {
      var a = Dr[t.style], r = e.havingStyle(a).withFont("");
      return Is(t.body, r, e);
    },
    mathmlBuilder(t, e) {
      var a = Dr[t.style], r = e.havingStyle(a), s = me(t.body, r), n = new j("mstyle", s), l = {
        display: [
          "0",
          "true"
        ],
      ...
      return n.setAttribute("scriptlevel", h[0]), n.setAttribute("displaystyle", h[1]), n;
    }
  });
  var sA = function(e, a) {
    var r = e.base;
    if (r) if (r.type === "op") {
      ...
      if (r.type === "accent") return qe(r.base) ? Ht : null;
      if (r.type === "horizBrace") {
        var l = !e.sub;
        return l === r.isOver ? Ds : null;
      } else return null;
    }
    else return null;
  };
  Xe({
    ...
    htmlBuilder(t, e) {
      var a = sA(t, e);
      if (a) return a(t, e);
      var { base: r, sup: s, sub: n } = t, l = $(r, e), h, d, m = e.fontMetrics(), g = 0, _ = 0, u = r && qe(r);
      if (s) {
        var b = e.havingStyle(e.style.sup());
        h = $(s, b, e), u || (g = l.height - b.fontMetrics().supDrop * b.sizeMultiplier / e.sizeMultiplier);
      }
      if (n) {
        var S = e.havingStyle(e.style.sub());
        d = $(n, S, e), u || (_ = l.depth + S.fontMetrics().subDrop * S.sizeMultiplier / e.sizeMultiplier);
      }
      var v;
      ...
      var N;
      if (h && d) {
        g = Math.max(g, v, h.depth + 0.25 * m.xHeight), _ = Math.max(_, m.sub2);
        var x = m.defaultRuleThickness, i = 4 * x;
        if (g - h.depth - (d.height - _) < i) {
          _ = i - (g - h.depth) + d.height;
          var z = 0.8 * m.xHeight - (g - h.depth);
          z > 0 && (g += z, _ -= z);
        }
        var F = [
          {
      ...
      } else if (h) g = Math.max(g, v, h.depth + 0.25 * m.xHeight), N = U({
        positionType: "shift",
        positionData: -g,
        children: [
          {
    ...
    mathmlBuilder(t, e) {
      ...
      if (a) l = r ? "mover" : "munder";
        ...
        var h = t.base;
        h && h.type === "op" && h.limits && (e.style === L.DISPLAY || h.alwaysHandleSupSub) || h && h.type === "operatorname" && h.alwaysHandleSupSub && (h.limits || e.style === L.DISPLAY) ? l = "mover" : l = "msup";
      }
      return new j(l, n);
    }
  });
  ...
  Xe({
    ...
    mathmlBuilder(t, e) {
      ...
      return r !== Ns[a.type] && a.setAttribute("mathvariant", r), a;
    }
  });
  Xe({
    type: "textord",
    ...
    mathmlBuilder(t, e) {
      var a = ge(t.text, t.mode, e), r = Ot(t, e) || "normal", s;
      return t.mode === "text" ? s = new j("mtext", [
        ...
        a
      ]), r !== Ns[s.type] && s.setAttribute("mathvariant", r), s;
    }
  });
  var mt = {
    "\\nobreak": "nobreak",
  ...
  var Cr = {
    ...
    var a = t.font;
    if (a) {
      if (Cr[a]) return e.withTextFontFamily(Cr[a]);
      if (Er[a]) return e.withTextFontWeight(Er[a]);
      if (a === "\\emph") return e.fontShape === "textit" ? e.withTextFontShape("textup") : e.withTextFontShape("textit");
    } else return e;
    return e.withTextFontShape(oA[a]);
  };
  E({
    type: "text",
    names: [
    ...
    htmlBuilder(t, e) {
      var a = Ir(t, e), r = re(t.body, a, true);
      return T([
        "mord",
        "text"
      ], r, a);
  ...
  E({
    ...
    htmlBuilder(t, e) {
      for (var a = Nr(t), r = [], s = e.havingStyle(e.style.text()), n = 0; n < a.length; n++) {
        var l = a[n];
      ...
      return T([
        "mord",
        "text"
      ].concat(s.sizingClasses(e)), Qr(r), s);
    },
    mathmlBuilder(t, e) {
      var a = new ae(Nr(t)), r = new j("mtext", [
        a
      ]);
      return r.setAttribute("mathvariant", "monospace"), r;
    }
  });
  var Nr = (t) => t.body.replace(/ /g, t.star ? "\u2423" : "\xA0"), Re = rs, Rs = `[ \r
	]`, nA = "\\\\[a-zA-Z@]+", cA = "\\\\[^\uD800-\uDFFF]", iA = "(" + nA + ")" + Rs + "*", lA = `\\\\(
|[ \r	]+
?)[ \r	]*`, Dt = "[\u0300-\u036F]", fA = new RegExp(Dt + "+$"), uA = "(" + Rs + "+)|" + (lA + "|") + "([!-\\[\\]-\u2027\u202A-\uD7FF\uF900-\uFFFF]" + (Dt + "*") + "|[\uD800-\uDBFF][\uDC00-\uDFFF]" + (Dt + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + iA) + ("|" + cA + ")");
  class Rr {
    constructor(e, a) {
      this.input = e, this.settings = a, this.tokenRegex = new RegExp(uA, "g"), this.catcodes = {
        "%": 14,
        "~": 13
      };
    }
...
`, this.tokenRegex.lastIndex);
  ...
  p("\\char", function(t) {
    ...
    if (a) {
      if (r = Fr[e.text], r == null || r >= a) throw new q("Invalid base-" + a + " digit " + e.text);
      for (var s; (s = Fr[t.future().text]) != null && s < a; ) r *= a, r += s, t.popToken();
    }
    return "\\@char{" + r + "}";
  });
  var Vt = (t, e, a, r) => {
    ...
    if (s = t.consumeArg().tokens, s.length === 1 && s[0].text === "[") {
      ...
      h = parseInt(d), s = t.consumeArg().tokens;
    }
  ...
  p("\\newcommand", (t) => Vt(t, false, true, false));
  p("\\renewcommand", (t) => Vt(t, true, false, false));
  p("\\providecommand", (t) => Vt(t, true, true, true));
  p("\\message", (t) => {
  ...
  p("\\dots", function(t) {
    ...
    return a in Or ? e = Or[a] : (a.slice(0, 4) === "\\not" || a in W.math && pA.has(W.math[a].group)) && (e = "\\dotsb"), e;
  });
  var Xt = {
    ")": true,
    "]": true,
  ...
  p("\\dotso", function(t) {
    var e = t.future().text;
    return e in Xt ? "\\ldots\\," : "\\ldots";
  });
  p("\\dotsc", function(t) {
    var e = t.future().text;
    return e in Xt && e !== "," ? "\\ldots\\," : "\\ldots";
  });
  p("\\cdots", function(t) {
    var e = t.future().text;
    return e in Xt ? "\\@cdots\\," : "\\@cdots";
  });
  p("\\dotsb", "\\cdots");
  p("\\dotsm", "\\cdots");
  p("\\dotsi", "\\!\\cdots");
  ...
  var Fs = D(be["Main-Regular"][84][1] - 0.7 * be["Main-Regular"][65][1]);
  p("\\LaTeX", "\\textrm{\\html@mathml{" + ("L\\kern-.36em\\raisebox{" + Fs + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{LaTeX}}");
  p("\\KaTeX", "\\textrm{\\html@mathml{" + ("K\\kern-.17em\\raisebox{" + Fs + "}{\\scriptstyle A}") + "\\kern-.15em\\TeX}{KaTeX}}");
  ...
  var Os = (t) => (e) => {
    var a = e.consumeArg().tokens, r = e.consumeArg().tokens, s = e.consumeArg().tokens, n = e.consumeArg().tokens, l = e.macros.get("|"), h = e.macros.get("\\|");
    e.macros.beginGroup();
    var d = (_) => (u) => {
      t && (u.macros.set("|", l), s.length && u.macros.set("\\|", h));
      var b = _;
      if (!_ && s.length) {
        var S = u.future();
        S.text === "|" && (u.popToken(), b = true);
      }
      return {
        tokens: b ? s : r,
        numArgs: 0
  ...
  class mA {
    constructor(e, a, r) {
      this.settings = a, this.expansionCount = 0, this.feed(e), this.macros = new hA(dA, a.macros), this.mode = r, this.stack = [];
    }
    feed(e) {
      this.lexer = new Rr(e, this.settings);
    }
    switchMode(e) {
      this.mode = e;
    }
    ...
    consumeArg(e) {
      ...
      var s = this.future(), n, l = 0, h = 0;
      do {
        if (n = this.popToken(), a.push(n), n.text === "{") ++l;
        else if (n.text === "}") {
          if (--l, l === -1) throw new q("Extra }", n);
        } else if (n.text === "EOF") throw new q("Unexpected end of input in a macro argument, expected '" + (e && r ? e[h] : "}") + "'", n);
        if (e && r) if ((l === 0 || l === 1 && e[h] === "{") && n.text === e[h]) {
          if (++h, h === e.length) {
            a.splice(-h, h);
            break;
          }
    ...
    consumeArgs(e, a) {
      ...
      for (var l = [], h = 0; h < e; h++) l.push(this.consumeArg(a && a[h + 1]).tokens);
      return l;
    }
    countExpansion(e) {
    ...
    expandOnce(e) {
      ...
      if (s.numArgs) {
        ...
        for (var h = n.length - 1; h >= 0; --h) {
          var d = n[h];
          if (d.text === "#") {
            if (h === 0) throw new q("Incomplete placeholder at end of macro body", d);
            if (d = n[--h], d.text === "#") n.splice(h + 1, 1);
            else if (/^[1-9]$/.test(d.text)) n.splice(h, 2, ...l[+d.text - 1]);
    ...
    _getExpansion(e) {
      ...
      if (typeof s == "string") {
        ...
        for (var h = new Rr(s, this.settings), d = [], m = h.lex(); m.text !== "EOF"; ) d.push(m), m = h.lex();
        d.reverse();
        var g = {
          tokens: d,
          numArgs: n
    ...
    isDefined(e) {
      return this.macros.has(e) || Re.hasOwnProperty(e) || W.math.hasOwnProperty(e) || W.text.hasOwnProperty(e) || Hs.hasOwnProperty(e);
    }
    isExpandable(e) {
      var a = this.macros.get(e);
  ...
  var Hr = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, Da = Object.freeze({
    "\u208A": "+",
    "\u208B": "-",
    "\u208C": "=",
    "\u208D": "(",
  ...
  class Za {
    constructor(e, a) {
      this.mode = "math", this.gullet = new mA(e, a, this.mode), this.settings = a, this.leftrightDepth = 0, this.nextToken = null;
    }
    expect(e, a) {
    ...
    handleInfixNodes(e) {
      ...
      if (a !== -1 && r) {
        var l, h, d = e.slice(0, a), m = e.slice(a + 1);
        d.length === 1 && d[0].type === "ordgroup" ? l = d[0] : l = {
          type: "ordgroup",
          mode: this.mode,
          body: d
        }, m.length === 1 && m[0].type === "ordgroup" ? h = m[0] : h = {
          type: "ordgroup",
          mode: this.mode,
          body: m
        };
    ...
    parseAtom(e) {
      ...
      for (var r, s; ; ) {
        ...
        if (n.text === "\\limits" || n.text === "\\nolimits") {
          ...
          for (this.consume(); this.fetch().text === "'"; ) d.push(h), this.consume();
    ...
    parseFunction(e, a) {
      ...
      var { args: l, optArgs: h } = this.parseArguments(s, n);
      return this.callFunction(s, l, h, r, e);
    }
    callFunction(e, a, r, s, n) {
      ...
      if (h && h.handler) return h.handler(l, a, r);
    ...
    parseArguments(e, a) {
      ...
      for (var s = [], n = [], l = 0; l < r; l++) {
        var h = a.argTypes && a.argTypes[l], d = l < a.numOptionalArgs;
        ("primitive" in a && a.primitive && h == null || a.type === "sqrt" && l === 1 && n[0] == null) && (h = "primitive");
        var m = this.parseGroupOfType("argument to '" + e + "'", h, d);
        if (d) n.push(m);
    ...
    parseSizeGroup(e) {
      ...
      if (!Wr(n)) throw new q("Invalid unit: '" + n.unit + "'", a);
      return {
        type: "size",
        mode: this.mode,
        value: n,
    ...
    parseGroup(e, a) {
      ...
      if (s === "{" || s === "\\begingroup") {
        ...
        var h = this.parseExpression(false, l), d = this.fetch();
      ...
      } else if (n = this.parseFunction(a, e) || this.parseSymbol(), n == null && s[0] === "\\" && !Hs.hasOwnProperty(s)) {
      ...
      for (var a = e.length - 1, r = 0; r < a; ++r) {
        ...
        if (s.type === "textord") {
          ...
          if (!(!l || l.type !== "textord")) {
            if (n === "-" && l.text === "-") {
              var h = e[r + 2];
              r + 1 < a && h && h.type === "textord" && h.text === "-" ? (e.splice(r, 3, {
                type: "textord",
                mode: "text",
                loc: ue.range(s, h),
                text: "---"
    ...
    parseSymbol() {
      ...
      Pr.hasOwnProperty(a[0]) && !W[this.mode][a[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + a[0] + '" used in math mode', e), a = Pr[a[0]] + a.slice(1));
      var n = fA.exec(a);
      ...
      if (W[this.mode][a]) {
        ...
        var h = W[this.mode][a].group, d = ue.range(e), m;
        if (uS.hasOwnProperty(h)) {
          var g = h;
          m = {
            type: "atom",
            mode: this.mode,
        ...
        l = m;
      } else if (a.charCodeAt(0) >= 128) this.settings.strict && (Xr(a.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + a[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + a[0] + '"' + (" (" + a.charCodeAt(0) + ")"), e)), l = {
        type: "textord",
        mode: "text",
        loc: ue.range(e),
        text: a
      ...
      if (this.consume(), n) for (var _ = 0; _ < n[0].length; _++) {
        var u = n[0][_];
        if (!gt[u]) throw new q("Unknown accent ' " + u + "'", e);
        var b = gt[u][this.mode] || gt[u].text;
        if (!b) throw new q("Accent " + u + " unsupported in " + this.mode + " mode", e);
        l = {
          type: "accent",
          mode: this.mode,
          loc: ue.range(e),
  ...
  var yA = function(e, a) {
    ...
    SETTINGS_SCHEMA: kt,
    __parse: gA,
    __renderToDomTree: Yt,
    __renderToHTMLTree: kA,
    __setFontMetrics: lS,
    __defineSymbol: o,
    __defineFunction: E,
    __defineMacro: p,
  ...
  const bA = {};
  function vA(t) {
    const e = this, a = t || bA, r = e.data(), s = r.micromarkExtensions || (r.micromarkExtensions = []), n = r.fromMarkdownExtensions || (r.fromMarkdownExtensions = []), l = r.toMarkdownExtensions || (r.toMarkdownExtensions = []);
    s.push(Bx(a)), n.push(xx()), l.push(Sx(a));
  }
  function zA(t, e) {
    return Gs(t, {}) || {
      type: "root",
  ...
  function TA(t, e) {
    const a = t.namespaceURI, r = a === Qa.svg ? ao : to, s = a === Qa.html ? t.tagName.toLowerCase() : t.tagName, n = a === Qa.html && s === "template" ? t.content : t, l = t.getAttributeNames(), h = {};
    let d = -1;
    for (; ++d < l.length; ) h[l[d]] = t.getAttribute(l[d]) || "";
    return r(s, h, Us(n, e));
  }
  function Us(t, e) {
  ...
  function CA(t) {
    const e = t || DA;
    return function(a, r) {
      ro(a, "element", function(s, n) {
        const l = Array.isArray(s.properties.className) ? s.properties.className : BA, h = l.includes("language-math"), d = l.includes("math-display"), m = l.includes("math-inline");
        let g = d;
        if (!h && !d && !m) return;
        let _ = n[n.length - 1], u = s;
        if (s.tagName === "code" && h && _ && _.type === "element" && _.tagName === "pre" && (u = _, _ = n[n.length - 2], g = true), !_) return;
        const b = so(u, {
          whitespace: "pre"
        });
        let S;
        try {
          S = Lr.renderToString(b, {
            ...e,
            displayMode: g,
            throwOnError: true
          });
        ...
        typeof S == "string" && (S = qA(S).children);
        const v = _.children.indexOf(u);
        return _.children.splice(v, 1, ...S), oo;
      });
    };
  }
  ...
  const Ur = {
    ...
    async highlighter(t, e, a, r) {
      var _a, _b2;
      try {
        if (window.sessionStorage.getItem("mdc-shiki-highlighter") === "browser") return or(() => import("./kMu_0Go2.js").then(async (m) => {
          await m.__tla;
          return m;
        }), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url).then((n) => n.default(t, e, a, r)).catch(() => ({}));
        {
          const n = io().public.mdc.highlight;
          ...
          if ((n == null ? void 0 : n.noApiRoute) === true) return or(() => import("./kMu_0Go2.js").then(async (m) => {
            await m.__tla;
            return m;
  ...
  function NA(t = {}) {
    ...
    return typeof e.highlighter != "function" && (e.highlighter = Ur.highlighter), no(e);
  }
  UA = {
    "remark-emoji": {
      instance: zx
