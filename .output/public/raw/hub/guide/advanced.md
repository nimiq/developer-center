...
<tbody>
  <tr>
    ...
    <td>
      Amount in Luna; omit to let the user enter an amount.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Optional greeting shown to the recipient. Use <code>
        autoTruncateMessage
      </code>
      
       if you plan to send long text.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <code>
        HubApi.CashlinkTheme
      </code>
    </td>
    
    <td>
      Controls the look of the Hub UI.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Prefill the funding address when you know which account should pay.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Optional balance hint for Hub optimisations.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      ISO 4217 code used for contextual pricing.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      ...
      , the Hub redirects back to your app. Combine with <code>
        skipSharing
      </code>
      
       to bypass the share dialog.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Automatically shortens long messages.
    </td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    ...
    <td>
      Cashlink status could not be determined.
    </td>
  </tr>
