...
<callout color="warning" icon="i-tabler-alert-triangle">
...
```ts [sign-staking.ts]
const unsignedTx = buildStakeTransaction(/* staking payload */) // returns Uint8Array
...
<tbody>
  ...
  <tr>
    ...
    <td>
      Offline signing, custom submission
    </td>
  </tr>
