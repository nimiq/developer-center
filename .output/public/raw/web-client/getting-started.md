...
Although the Web Client already offers extensive functionality, you can also set up your own private node for full control and advanced customization. [Find out more about their differences](./web-client-vs-rpc).
