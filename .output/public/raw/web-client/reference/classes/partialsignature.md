...
[@nimiq/core](../globals) / PartialSignature
...
(`string` | `Uint8Array`<`ArrayBufferLike`> | [`CommitmentPair`](CommitmentPair))<span>
...
(`string` | `Uint8Array`<`ArrayBufferLike`> | [`PublicKey`](PublicKey))<span>
...
(`string` | `Uint8Array`<`ArrayBufferLike`> | [`Commitment`](Commitment))[]<span>
