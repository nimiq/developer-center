...
(`string` | [`Address`](Address) | `Uint8Array`<`ArrayBufferLike`>)<span>
...
`string` | [`Address`](Address) | `Uint8Array`<`ArrayBufferLike`>

#### Returns

`Promise`<[`PlainAccount`](../type-aliases/PlainAccount)>

---

### getAccounts()

> **getAccounts**(`addresses`): `Promise`<[`PlainAccount`](../type-aliases/PlainAccount)<span>
> 
> 
> 
> </span>
...
`Promise`<[`PlainAccount`](../type-aliases/PlainAccount)<span>
...
> **getAddressBook**(): `Promise`<[`PlainPeerInfo`](../interfaces/PlainPeerInfo)<span>
> 
> 
> 
> </span>
...
`Promise`<[`PlainPeerInfo`](../interfaces/PlainPeerInfo)<span>
...
`Promise`<[`PlainBlock`](../type-aliases/PlainBlock)>
...
`Promise`<[`PlainStaker`](../interfaces/PlainStaker)>

---

### getStakers()

> **getStakers**(`addresses`): `Promise`<[`PlainStaker`](../interfaces/PlainStaker)<span>
> 
> 
> 
> </span>
...
`Promise`<[`PlainStaker`](../interfaces/PlainStaker)<span>
...
`Promise`<[`PlainTransactionDetails`](../interfaces/PlainTransactionDetails)>

---

### getTransactionReceiptsByAddress()

> **getTransactionReceiptsByAddress**(`address`, `limit?`, `start_at?`, `min_peers?`): `Promise`<[`PlainTransactionReceipt`](../interfaces/PlainTransactionReceipt)<span>
> 
> 
> 
> </span>
...
`Promise`<[`PlainTransactionReceipt`](../interfaces/PlainTransactionReceipt)<span>
...
> **getTransactionsByAddress**(`address`, `since_block_height?`, `known_transaction_details?`, `start_at?`, `limit?`, `min_peers?`): `Promise`<[`PlainTransactionDetails`](../interfaces/PlainTransactionDetails)<span>
> 
> 
> 
> </span>
...
[`PlainTransactionDetails`](../interfaces/PlainTransactionDetails)<span>
...
`Promise`<[`PlainTransactionDetails`](../interfaces/PlainTransactionDetails)<span>
...
`Promise`<[`PlainValidator`](../interfaces/PlainValidator)>

---

### getValidators()

> **getValidators**(`addresses`): `Promise`<[`PlainValidator`](../interfaces/PlainValidator)<span>
> 
> 
> 
> </span>
...
`Promise`<[`PlainValidator`](../interfaces/PlainValidator)<span>
...
Sends a transaction to the network and returns [PlainTransactionDetails](../interfaces/PlainTransactionDetails).
...
`string` | [`PlainTransaction`](../interfaces/PlainTransaction) | `Uint8Array`<`ArrayBufferLike`> | [`Transaction`](Transaction)
