...
[@nimiq/core](../globals) / Commitment

# Class: Commitment

Defined in: @nimiq/core/types/wasm/web.d.ts:1036

A cryptographic commitment to a [RandomSecret](RandomSecret). The commitment is public, while the secret is, well, secret.
...
(`string` | `Uint8Array`<`ArrayBufferLike`> | `Commitment`)<span>
