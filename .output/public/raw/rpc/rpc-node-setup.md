...
- Send RPC calls while Terminal 1 keeps the node alive:```bash
...
```
- Repeat with other methods as desired. Browse the full list at [RPC Methods](./methods/).
