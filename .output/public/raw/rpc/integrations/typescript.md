...
<u-button to="https://github.com/onmax/albatross-rpc-client-ts" target="_blank" label="View TypeScript Client Repository" icon="i-simple-icons:github" trailing-icon="i-tabler:arrow-up-right" color="primary" className="mt-4,rounded-full">
