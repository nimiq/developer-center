...
<u-button to="https://github.com/onmax/nimiq-mcp" target="_blank" label="View Nimiq MCP Repository" icon="i-simple-icons:github" trailing-icon="i-tabler:arrow-up-right" color="primary" className="mt-4,rounded-full">
