...
<u-button to="https://github.com/sisou/arpl" target="_blank" label="View ARPL Repository" icon="i-simple-icons:github" trailing-icon="i-tabler:arrow-up-right" color="primary" className="mt-4,rounded-full">
