...
Full nodes do not use Block Live Sync. Instead, they transition to **State Live Sync** to synchronize both blocks and complete account state simultaneously.
...
<tbody>
  ...
  <tr>
    ...
    <td>
      Handles network requests for missing blocks
    </td>
  </tr>
</tbody>
</table>
