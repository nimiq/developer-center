...
<tbody>
  <tr>
    ...
    <td>
      Remote staking contract queries
    </td>
    
    <td>
      Merkle proof verification, validator/staker data
    </td>
  </tr>
  ...
  <tr>
    <td>
      <code>
        RemoteEventDispatcher<N>
      </code>
    </td>
    
    <td>
      Address-based event routing
    </td>
    
    <td>
      Client subscriptions, event notifications
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      LRU cache, validator voting key storage
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      Consensus peer analysis
    </td>
    
    <td>
      Head state tracking, missing block detection
    </td>
  </tr>
</tbody>
</table>
