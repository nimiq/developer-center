...
<tbody>
  <tr>
    ...
    <td align="left">
      The amount of NIM at any given time. It can differ from the <code>
        total_amount
      </code>
      
       since it's possible to withdraw partial amounts at a time
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
      The number of times the <code>
       ...
       is hashed so the recipient can withdraw the funds entirely. If the <code>
        hash_count
      </code>
      
       is 2, the recipient can withdraw the funds in 2 portions
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
      The time, in Unix time with millisecond precision, when the contract elapses. The <code>
        timeout
      </code>
      
       is determined once the contract is created. If the time elapses, the sender can withdraw the funds
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
      The initial amount decided in the contract creation
    </td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
    ...
    <td align="left">
      The amount of NIM at any given time. Whenever the funds are spent, the balance changes
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
      The owner's address. The contract owner has a corresponding key to sign and withdraw the funds
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
      The time, in Unix time with millisecond precision, when the vesting schedule starts, decided by the contract owner
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
      The <code>
       ...
       unlocks at each <code>
        time_step
      </code>
      
      . If the owner decides to unlock the funds every 24 hours, the <code>
        step_amount
      </code>
      
       unlocks at every 24 hours
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="left">
      The amount of NIM unlocked in every <code>
        time_step
      </code>
    </td>
  </tr>
