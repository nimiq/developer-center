...
You will need to follow the [Activation Tool](/archive/validator-activation) guide, and we recommend running it before November 19, allowing your node to download the database snapshot early and speeding up the activation process. Click [here](/migration/migration-technical-details#activation-phase) to learn more about the activation phase.
