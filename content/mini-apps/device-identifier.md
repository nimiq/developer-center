...
Place this file anywhere in your project's source directory. TypeScript picks it up automatically. No import needed. If you also use [`window.nimiqPay.language`](/mini-apps/localization#typescript-type-declaration), merge both fields into a single `nimiqPay` interface.
