...
::callout{icon="i-tabler-progress" color="info" title="Phase 1 is live"}
Validators can now apply the security patch and send the signaling transaction. The fork becomes eligible for activation once validators representing at least 80% of the active stake have signaled. Phase 2 starts after activation.
::
...
- Your [validator cold key](/protocol/validators/validator-keys): the private key of the Schnorr keypair your validator address is derived from, generated with `nimiq-address` when you [set up your validator](/nodes/validators/becoming-a-validator#generating-your-validator-address-and-keys). The signaling transaction is signed with it.
