      ...
      <form @submit.prevent="onSubmit">
        <div class="nq-raw" outline="1.5 offset--1.5 solid neutral/8" rounded-8 w-full of-clip>
          ...
          >
            ...
            <span shrink-0>
              <span v-if="field.required" text="9 green" px-4 rounded-2 bg-green-400 nq-label>required</span>
              <span v-else text="9 neutral-700" px-4 rounded-2 bg-neutral-400 nq-label>optional</span>
            </span>
        ...
        <div flex="~ justify-end" f-mt-xs>
          <button :disabled="widget.state === 'loading'" :class="{ 'cursor-not-allowed op-60': widget.state === 'loading' }" mx-0 w-full nq-pill nq-pill-gold lg:w-auto @click="onSubmit">
      ...
      <div v-else class="nq-raw" outline="1.5 offset--1.5 solid neutral/8" rounded-8 w-full of-clip>
        ...
        >
          ...
          <span ml-auto shrink-0>
            <span v-if="required" text="9 green" px-4 rounded-2 bg-green-400 nq-label>required</span>
            <span v-else text="9 neutral-700" px-4 rounded-2 bg-neutral-400 nq-label>optional</span>
          </span>
        </div>
      </div>
