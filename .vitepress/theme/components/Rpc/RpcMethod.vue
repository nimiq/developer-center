      ...
      <form @submit.prevent="onSubmit">
        <div class="nq-raw" outline="1.5 offset--1.5 solid neutral/8" rounded-8 w-full of-clip>
          ...
          >
            ...
            <span shrink-0>
              <span v-if="field.required" text="f-xs green" rounded-2 bg-green-400 nq-label>required</span>
              <span v-else text="f-xs neutral-700" rounded-2 bg-neutral-400 nq-label>optional</span>
            </span>
      ...
      <div v-else class="nq-raw" outline="1.5 offset--1.5 solid neutral/8" rounded-8 w-full of-clip>
        ...
        >
          ...
          <span ml-auto shrink-0>
            <span v-if="required" text="f-xs green" rounded-2 bg-green-400 nq-label>required</span>
            <span v-else text="f-xs neutral-700" rounded-2 bg-neutral-400 nq-label>optional</span>
          </span>
        </div>
      </div>
