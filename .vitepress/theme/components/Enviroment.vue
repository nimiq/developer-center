...
<template>
  <TooltipProvider>
    <TooltipRoot>
      <TooltipTrigger label ml-24 shadow text-11 border="base orange" rounded-full px-8 py-3 bg-orange text-white aria-label="View build information">
        {{ version }}
      </TooltipTrigger>
      <TooltipPortal>
        <TooltipContent z-100 side="bottom" :side-offset="5" :collision-padding="8" align="end" bg-darkblue text-white p-20 pb-12 shadow rounded-8 max-w-350 text-14 border="base white/20">
