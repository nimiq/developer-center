...
<template>
  <label
    text-20 switch :aria-label="`Switch to ${isDark ? 'light' : 'dark'} theme`"
    style="--active-color: rgb(var(--nq-neutral-400))" border-subtle-light after:bg-neutral="white dark:800"
  >
