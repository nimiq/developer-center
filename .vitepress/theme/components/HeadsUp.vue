<template>
  <div my-64 rounded-6 bg-orange-400 bg-op-50 text="[#E07802]" px-24 py-16 ring="1.5 orange-600" relative of-hidden class="raw">
    ...
    <p pr-32 md:pr-64>
      Our documentation is constantly improving, just like our blockchain. For the latest updates, follow us on <a href="https://twitter.com/Nimiq" underline text-inherit>Twitter</a> or <a href="https://t.me/joinchat/AAAAAEJW-ozFwo7Er9jpHw" underline text-inherit>Telegram</a>.
    </p>
